...
class DanmakuAuxiliary {
  ...
  mount() {
    ...
    this.danmakuList = new DanmakuList(this.player, this.template.danmaku_list_wrapper);
    this.advancedDanmakuEditor = new AdvancedDanmakuEditor(this.player, this.template.ade_wrapper)
