...
export class VList {
    ...
    handleScroll() {
        if (!this.throttle) {
            ...
            if (this.viewStart <= this.renderStart || this.viewEnd >= this.renderEnd) {
                ...
                // console.log(`[mfuns-player] ${this.renderStart} - ${this.renderEnd}`)
            }
            // console.log(`[mfuns-player] ${scrollTop} + ${clientH} @ ${this.viewStart} - ${this.viewEnd} # ${this.renderStart} - ${this.renderEnd}`)
        } else {
            // console.log("[mfuns-player] none")
        }
    }
    render(clientH, scrollTop) {
        ...
        // console.log(`[mfuns-player] old ${oldRenderStart}-${oldRenderEnd} new ${this.renderStart}-${this.renderEnd}`)
        // 与列表前段比较
