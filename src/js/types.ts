...
export interface PlayerPlugin<
  ...
  /** 插件接口 */
  E extends PlayerExposed = object,
  /** 其他依赖插件 */
  P extends PlayerPlugin = never
> {
  /** 插件名称 */
  readonly name: N;
  /** 插件创建 */
  readonly create?: (
    player: Player<PlayerPlugin<N, EmptyObject, E> | P>,
    options: PlayerOptions<this>
  ) => E | void;
  /** 插件初始化 */
  readonly init?: (
    player: Player<PlayerPlugin<N, EmptyObject, E> | P>,
  ...
  /** 插件销毁 */
  readonly destroy?: (player: Player<PlayerPlugin<N, EmptyObject, E> | P>) => void;
}
