...
class Template {
  ...
  init(options) {
    ...
    this.skip = $(".mfunsPlayer-controller-next");  // 下一个按钮
    this.squirtleItem = $all(".mfunsPlayer-squirtle-item");
    this.volume = $(".mfunsPlayer-controller-volume");  // 音量按钮
    ...
    this.webFullButton = $(".mfunsPlayer-controller-webfull");  // 网页全屏
    this.browserFullButton = $(".mfunsPlayer-controller-fullscreen"); // 全屏按钮
    this.browserFullButtonIcon = $(".mfunsPlayer-controller-full-icon");
    this.switch_btn = $(".switch");
    this.range = $(".range");
    this.player_btn = $(".mfunsPlayer-controller-play");  // 播放按钮
    ...
    this.troggle = $(".mfunsPlayer-controller-pip");  // 画中画按钮
    ...
    this.danmaku_style = $(".mfunsPlayer-controller-danmaku-style");  // 弹幕样式按钮
