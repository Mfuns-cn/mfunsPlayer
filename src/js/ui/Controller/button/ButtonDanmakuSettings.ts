...
const template = (order?: number) => html`
  <div
    class="${classPrefix}-controller-button ${classPrefix}-controller-danmaku-settings"
...
export default class ButtonDanmakuSettings {
  ...
  constructor(player: Player, container: HTMLElement, order?: number, options?: PlayerOptions) {
    this.player = player;
