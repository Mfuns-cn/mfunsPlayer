(function () {
            ...
            g = function (e, t) {
                ...
                var P = !1,
                    H = function (e, r) {
                        ...
                        return (
                            i.isAndroid && f == '. ' && ((f = '  '), (d = !0)),
                            (f && !u && !a && !l && !c) || S ? t.onTextInput(f) : t.onTextInput(f, { extendLeft: u, extendRight: a, restoreStart: l, restoreEnd: c }),
                            (w = !1),
                            (T = e),
                            (N = s),
                            (C = o),
                ...
                var U = function (e) {
                        ...
                        (r.end.row = r.start.row),
                            ...
                            b.useTextareaForIME ? ((T = n.value = ''), (N = 0), (C = 0)) : (n.msGetInputContext && (b.context = n.msGetInputContext()), n.getInputContext && (b.context = n.getInputContext()));
                    },
                    z = function () {
                ...
                r.addListener(n, 'compositionstart', U, t),
                    ...
                    (this.moveToMouse = function (e, o) {
                        E || (E = n.style.cssText), (n.style.cssText = (o ? 'z-index:100000;' : '') + (i.isIE ? 'opacity:0.1;' : '') + 'text-indent: -' + (N + C) * t.renderer.characterWidth * 0.5 + 'px;');
            ...
            (this.isBidiRow = function (e, t, n) {
                ...
                (this.updateRowLine = function (e, t) {
                    ...
                    if (this.session.$useWrapMode) {
                        ...
                        o &&
                            ...
                            t > 0 && o.length
                                ? ((this.wrapIndent = o.indent), (this.wrapOffset = this.wrapIndent * this.charWidths[r.L]), (this.line = t < o.length ? this.line.substring(o[t - 1], o[t]) : this.line.substring(o[o.length - 1])))
                    ...
                    (this.line = this.line.replace(/\t|[\u1100-\u2029, \u202F-\uFFE6]/g, function (e, t) {
                        ...
                        this.isRtlDir &&
                            ((this.fontMetrics.$main.textContent = this.line.charAt(this.line.length - 1) == r.DOT ? this.line.substr(0, this.line.length - 1) : this.line),
                ...
                (this.setRtlDirection = function (e, t) {
                    ...
                    for (var r = e.selection.getSelectionAnchor().row; r <= n.row; r++)
                        !t && e.session.getLine(r).charAt(0) === e.session.$bidiHandler.RLE
                            ...
                            : t && e.session.getLine(r).charAt(0) !== e.session.$bidiHandler.RLE && e.session.doc.insert({ column: 0, row: r }, e.session.$bidiHandler.RLE);
                }),
                ...
                (this.getSelections = function (e, t) {
                    var n = this.bidiMap,
                        ...
                        c = 0;
                    this.wrapIndent && (o += this.isRtlDir ? -1 * this.wrapOffset : this.wrapOffset);
                    for (var h, p = 0; p < r.length; p++) (h = n.logicalFromVisual[p]), (i = r[p]), (f = h >= u && h < a), f && !l ? (c = o) : !f && l && s.push({ left: c, width: o - c }), (o += this.charWidths[i]), (l = f);
                    ...
                    t === 0 &&
                        (e !== 0 &&
                            (this.session.$bidiHandler.isBidiRow(n.row, this.lead.row)
                                ? ((r = this.session.$bidiHandler.getPosLeft(n.column)), (n.column = Math.round(r / this.session.$bidiHandler.charWidths[0])))
    ...
    define('ace/unicode', ['require', 'exports', 'module'], function (e, t, n) {
        'use strict';
        var r = [
                48, 9, 8, 25, 5, 0, 2, 25, 48, 0, 11, 0, 5, 0, 6, 22, 2, 30, 2, 457, 5, 11, 15, 4, 8, 0, 2, 0, 18, 116, 2, 1, 3, 3, 9, 0, 2, 2, 2, 0, 2, 19, 2, 82, 2, 138, 2, 4, 3, 155, 12, 37, 3, 0, 8, 38, 10, 44, 2, 0, 2, 1, 2, 1,
 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 6, 2, 31, 48, 0, 470, 1, 36, 5, 2, 4, 6, 1, 5, 85, 3, 1, 3, 2, 2, 89, 2, 3, 6, 40, 4, 93, 18, 23, 57, 15, 513, 6581, 75, 20939, 53, 1164, 68, 45, 3, 268, 4, 27, 21, 31, 3,
                13, 13, 1, 2, 24, 9, 69, 11, 1, 38, 8, 3, 102, 3, 1, 111, 44, 25, 51, 13, 68, 12, 9, 7, 23, 4, 0, 5, 45, 3, 35, 13, 28, 4, 64, 15, 10, 39, 54, 10, 13, 3, 9, 7, 22, 4, 1, 5, 66, 25, 2, 227, 42, 2, 1, 3, 9, 7, 11171,
                13, 22, 5, 48, 8453, 301, 3, 61, 3, 105, 39, 6, 13, 4, 6, 11, 2, 12, 2, 4, 2, 0, 2, 1, 2, 1, 2, 107, 34, 362, 19, 63, 3, 53, 41, 11, 5, 15, 17, 6, 13, 1, 25, 2, 33, 4, 2, 134, 20, 9, 8, 25, 5, 0, 2, 25, 12, 88, 4, 5,
                3, 5, 3, 5, 3, 2,
            ],
            i = 0,
            s = [];
    ...
    define(
        'ace/mode/text',
        ['require', 'exports', 'module', 'ace/config', 'ace/tokenizer', 'ace/mode/text_highlight_rules', 'ace/mode/behaviour/cstyle', 'ace/unicode', 'ace/lib/lang', 'ace/token_iterator', 'ace/range'],
        function (e, t, n) {
            'use strict';
            var r = e('../config'),
    ...
    define('ace/apply_delta', ['require', 'exports', 'module'], function (e, t, n) {
        'use strict';
        function r(e, t) {
            throw (console.log('[mfuns-player] Invalid Delta:', e), 'Invalid Delta: ' + t);
        }
        function i(e, t) {
                ...
                function () {
                    ...
                    r.implement(this, u),
                        ...
                        (this.onChange = function (e) {
                            ...
                            !this.$fromUndo &&
                                this.$undoManager &&
                                (t && t.length && (this.$undoManager.add({ action: 'removeFolds', folds: t }, this.mergeUndoDeltas), (this.mergeUndoDeltas = !0)),
                        ...
                        (this.$getUndoSelection = function (e, t) {
                            ...
                            for (var s = 0; s < e.length; s++) {
                                ...
                                n(o)
                                    ? ((i = o.start), r.compare(i.row, i.column) == -1 && r.setStart(i), (i = o.end), r.compare(i.row, i.column) == 1 && r.setEnd(i))
                        ...
                        (this.setWrapLimitRange = function (e, t) {
                            if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t)
                                (this.$wrapLimitRange = { min: e, max: t }), (this.$modified = !0), this.$bidiHandler.markAsDirty(), this.$useWrapMode && this._signal('changeWrapMode');
                        }),
                ...
                r.implement(this, s),
                    ...
                    (this.toggleRecording = function (e) {
                        ...
                        return (
                            ...
                            this.recording
                                ? (this.macro.pop(), this.off('exec', this.$addCommandToMacro), this.macro.length || (this.macro = this.oldMacro), (this.recording = !1))
                            ...
                            (this.$highlightPending = !0),
                                setTimeout(function () {
                                    ...
                                    Array.isArray(n) ? n.length == 1 && (r = 'ace_error_bracket') : (n = [n]),
                                        n.length == 2 &&
                                            (p.comparePoints(n[0].end, n[1].start) == 0 ? (n = [p.fromPoints(n[0].start, n[1].end)]) : p.comparePoints(n[0].start, n[1].end) == 0 && (n = [p.fromPoints(n[1].start, n[0].end)])),
                                        (t.$bracketHighlight = {
                                            ranges: n,
                            ...
                            (this.$highlightTagPending = !0),
                                setTimeout(function () {
                                    ...
                                    var s = i.value,
                                        ...
                                        a = r.stepBackward();
                                    if (a.value === '<') {
                                        do (a = i), (i = r.stepForward()), i && (i.type.indexOf('tag-name') !== -1 ? ((o = i.value), s === o && (a.value === '<' ? u++ : a.value === '</' && u--)) : s === o && i.value === '/>' && u--);
                                        while (i && u >= 0);
                                    } else {
                                        do {
                                    ...
                                    t.$tagHighlight && m != undefined && v.compareRange(m.range) !== 0 && (t.removeMarker(t.$tagHighlight), (t.$tagHighlight = null)),
                        ...
                        (this.autoIndent = function () {
                            ...
                            for (var h = n; h <= r; h++)
                                h > 0 && ((s = e.getState(h - 1)), (o = e.getLine(h - 1)), (u = t.getNextLineIndent(s, o, c))),
                                    (a = e.getLine(h)),
                                    (f = t.$getIndent(a)),
                                    u !== f && (f.length > 0 && ((l = new p(h, 0, h, f.length)), e.remove(l)), u.length > 0 && e.insert({ row: h, column: 0 }, u)),
                                    t.autoOutdent(s, e, h);
                        }),
            ...
            i.implement(this, o),
                ...
                (this.$renderCell = function (e, t, n, i) {
                    ...
                    this.$highlightGutterLine &&
                        ...
                        this.$cursorCell != e && (this.$cursorCell && (this.$cursorCell.element.className = this.$cursorCell.element.className.replace('ace_gutter-active-line ', '')), (this.$cursorCell = e))),
                        l[i] && (v += l[i]),
                        c[i] && (v += c[i]),
                ...
                (this.setShowInvisibles = function (e) {
                    return this.showInvisibles == e
                        ...
                        : ((this.showInvisibles = e),
                          typeof e == 'string' ? ((this.showSpaces = /tab/i.test(e)), (this.showTabs = /space/i.test(e)), (this.showEOL = /eol/i.test(e))) : (this.showSpaces = this.showTabs = this.showEOL = e),
                ...
                (this.update = function (e) {
                    ...
                    for (var n = 0, s = t.length; n < s; n++) {
                        ...
                        this.drawCursor
                            ...
                            ? (r.setStyle(a, 'display', 'block'), r.translate(u, o.left, o.top), r.setStyle(a, 'width', Math.round(e.characterWidth) + 'px'), r.setStyle(a, 'height', e.lineHeight + 'px'))
                    ...
                    (this.scrollCursorIntoView = function (e, t, n) {
                        ...
                        a + o > s
                            ...
                            : a + this.$size.scrollerHeight - u < s + this.lineHeight &&
                              (t && a + this.$size.scrollerHeight - u < s - this.lineHeight && (s += t * this.$size.scrollerHeight), this.session.setScrollTop(s + this.lineHeight + u - this.$size.scrollerHeight));
                    ...
                    (this.showComposition = function (e) {
                        (this.$composition = e),
                            ...
                            this.$useTextareaForIME
                                ? (i.addCssClass(this.textarea, 'ace_composition'), (this.textarea.style.cssText = ''), this.$moveTextAreaToCursor(), (this.$cursorLayer.element.style.display = 'none'))
                ...
                (this.updateSelectionMarkers = function () {
                    ...
                    (this.selectMore = function (e, t, n) {
                        ...
                        var o = r.getTextRange(s),
                            u = h(r, o, e);
                        u && ((u.cursor = e == -1 ? u.start : u.end), this.session.unfold(u), this.multiSelect.addRange(u), this.renderer.scrollCursorIntoView(null, 0.5)), t && this.multiSelect.substractPoint(s.cursor);
                    }),
