...
!(function (e) {
    ...
    e.console ||
        ...
        (e.onerror = function (e, t, n, r, i) {
            postMessage({ type: 'error', data: { message: e, data: i && i.data, file: t, line: n, col: r, stack: i && i.stack } });
        }),
        ...
        (e.require = function (r, i) {
            ...
            if (!e.require.tlns) return console.log('[mfuns-player] unable to load ' + i);
                ...
                e.on('change', function (e) {
                    ...
                    if (r[0].start) t.applyDeltas(r);
                        ...
                        for (var i = 0; i < r.length; i += 2) {
                            ...
                            if ((o.action == 'insert' ? o.start : o.end).row >= t.$lines.length) throw ((u = new Error('Invalid delta')), (u.data = { path: s.$path, linesLength: t.$lines.length, start: o.start, end: o.end }), u);
                            t.applyDelta(o, !0);
                        }
