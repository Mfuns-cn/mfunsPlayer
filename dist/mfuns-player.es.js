...
const j = (i, t) => Array.from({ length: i }, () => t), ue = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, pe = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, me = document.pictureInPictureEnabled, ht = (i) => {
...
}, $e = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), ve = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, it = {
...
), a = "mfuns-player", ge = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", fe = [
...
class ye {
  constructor(t, e) {
    ...
    ), this.loader = new de(this), this.setRatio(e.aspectRatio || null), this.attachEvent(this.$video), this.initKeepRatio();
  }
  /** 加载视频 */
  load(t) {
...
class xe {
  constructor(t, e) {
    this.player = t, this.webfull = new we(this.player), this.fullscreen = new be(this.player), this.pip = new ke(this.player), this.init();
  }
  init() {
...
class R {
  constructor(t) {
    this.event = new ce(), this.hook = new Le(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = H("div", { class: a }), this.$main = this.$el.appendChild(H("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(H("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      H("div", { class: `${a}-content` })
    ), this.pluginManager = new he(this), this.video = new ye(this, t), this.sizing = new xe(this, t), this.state = new Se(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
 ...
 */
var nt;
const tt = window, O = tt.trustedTypes, dt = O ? O.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, rt = "$lit$", M = `lit$${(Math.random() + "").slice(9)}$`, xt = "?" + M, Ee = `<${xt}>`, V = document, K = () => V.createComment(""), Y = (i) => i === null || typeof i != "object" && typeof i != "function", St = Array.isArray, _e = (i) => St(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", at = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ut = /-->/g, pt = />/g, N = RegExp(`>|${at}(?:([^\\s"'>=/]+)(${at}*=${at}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), mt = /'/g, $t = /"/g, Lt = /^(?:script|style|textarea|title)$/i, Ae = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Ae(1), Q = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), vt = /* @__PURE__ */ new WeakMap(), B = V.createTreeWalker(V, 129, null, !1);
function Et(i, t) {
...
const Te = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; y < o.length && (r.lastIndex = y, u = r.exec(o), u !== null); )
      y = r.lastIndex, r === U ? u[1] === "!--" ? r = ut : u[1] !== void 0 ? r = pt : u[2] !== void 0 ? (Lt.test(u[2]) && (n = RegExp("</" + u[2], "g")), r = N) : u[3] !== void 0 && (r = N) : r === N ? u[0] === ">" ? (r = n ?? U, f = -1) : u[1] === void 0 ? f = -2 : (f = r.lastIndex - u[2].length, d = u[1], r = u[3] === void 0 ? N : u[3] === '"' ? $t : mt) : r === $t || r === mt ? r = N : r === ut || r === pt ? r = U : (r = N, n = void 0);
    const E = r === N && i[h + 1].startsWith("/>") ? " " : "";
    l += r === U ? o + Ee : f >= 0 ? (s.push(d), o.slice(0, f) + rt + o.slice(f) + M + E) : o + M + (f === -2 ? (s.push(void 0), h) : E);
  }
...
class Z {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const h = t.length - 1, o = this.parts, [d, u] = Te(t, e);
      ...
      if (n.nodeType === 1) {
          ...
          for (const y of n.getAttributeNames())
            if (y.endsWith(rt) || y.startsWith(M)) {
              ...
              if (f.push(y), E !== void 0) {
                const L = n.getAttribute(E.toLowerCase() + rt).split(M), m = /([.?@])?(.*)/.exec(E);
                o.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? Pe : m[1] === "?" ? He : m[1] === "@" ? qe : et });
              } else
        ...
        if (Lt.test(n.tagName)) {
          ...
          if (y > 0) {
            ...
            for (let E = 0; E < y; E++)
              n.append(f[E], K()), B.nextNode(), o.push({ type: 2, index: ++l });
            n.append(f[y], K());
          }
        }
...
class Fe {
  ...
  u(t) {
    ...
    for (; d !== void 0; ) {
      if (h === d.index) {
        let u;
        d.type === 2 ? u = new G(r, r.nextSibling, this, t) : d.type === 1 ? u = new d.ctor(r, d.name, d.strings, this, t) : d.type === 6 && (u = new Me(r, this, t)), this._$AV.push(u), d = n[++o];
      }
...
class G {
  constructor(t, e, s, n) {
    var l;
    this.type = 2, this._$AH = T, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cp = (l = n == null ? void 0 : n.isConnected) === null || l === void 0 || l;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = W(this, t, e), Y(t) ? t === T || t == null || t === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : t !== this._$AH && t !== Q && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : _e(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== T && Y(this._$AH) ? this._$AA.nextSibling.data = t : this.$(V.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      ...
      const r = new Fe(l, this), h = r.u(this.options);
...
class et {
  constructor(t, e, s, n, l) {
    this.type = 1, this._$AH = T, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = l, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = T;
  }
  get tagName() {
  ...
  _$AI(t, e = this, s, n) {
    ...
    if (l === void 0)
      ...
      for (t = l[0], o = 0; o < l.length - 1; o++)
        d = W(this, h[s + o], e, o), d === Q && (d = this._$AH[o]), r || (r = !Y(d) || d !== this._$AH[o]), d === T ? t = T : t !== T && (t += (d ?? "") + l[o + 1]), this._$AH[o] = d;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
class He extends et {
  ...
  j(t) {
    t && t !== T ? this.element.setAttribute(this.name, De) : this.element.removeAttribute(this.name);
  }
}
class qe extends et {
  constructor(t, e, s, n, l) {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = W(this, t, e, 0)) !== null && s !== void 0 ? s : T) === Q)
      return;
    const n = this._$AH, l = t === T && n !== T || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive, r = t !== T && (n === T || l);
...
gt == null || gt(Z, G), ((nt = tt.litHtmlVersions) !== null && nt !== void 0 ? nt : tt.litHtmlVersions = []).push("2.8.0");
const g = (i, t, e) => {
  var s, n;
  ...
  created() {
    ...
    this.list = new Ne({
      ...
      createItem: (n, l) => Be(n, l, {
        ...
        title: (r) => `${r.content}
${n.date ? wt(new Date(n.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${z(n.time, !1)}`
      }),
      overflow: 5
    });
    const s = kt(() => {
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = h, this.onDragStart = o, this.onDragEnd = d, this.onDrag = u, g(Re({ divider: this.divider }), t), this.$el = this.container.querySelector(`.${a}-slider`), this.$track = this.$el.querySelector(`.${a}-slider-track`), this.$bar = this.$track.querySelector(`.${a}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${a}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${a}-slider-thumb`), this.$el.addEventListener("mousedown", (f) => {
      ...
      const k = (x) => {
        ...
        var b, _;
        x.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (_ = this.onDragEnd) == null || _.call(this, S);
      };
...
class ze {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = r, this.onDragStart = h, this.onDragEnd = o, this.onDrag = d, g(Ve(), t), this.$el = this.container.querySelector(`.${a}-slider`), this.$track = this.$el.querySelector(`.${a}-slider-track`), this.$bar = this.$track.querySelector(`.${a}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${a}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${a}-slider-thumb`), this.$el.addEventListener("mousedown", (u) => {
      ...
      (A = this.onDragStart) == null || A.call(this, v), this.value != v && this.drag(v);
      const S = (w) => {
        var q;
...
class X {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(Oe({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
...
class Ue {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(We({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
class At {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, g(je({ label: this.label }), this.container), this.$el = this.container.querySelector(`.${a}-checkbox`), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class Ke {
  ...
  init(t) {
    ...
    this.pickerFontsize = new X({
      ...
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || Ye).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || Qe).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
      ...
      value: "#FFFFFF",
      list: (((s = t.danmakuBar) == null ? void 0 : s.colorList) || Ze).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = $e(n);
      },
      onChange: (n) => {
...
class Tt extends P {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.player.plugin.controller, this.danmaku = this.player.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      ...
      this.send();
    }, this.setPlaceHolder(((s = e.danmakuBar) == null ? void 0 : s.placeholder) || Je);
  }
  moveToWrap() {
...
`)}`, typeof $.color == "number" ? c.style.color = ve($.color) : c.style.color = $.color, c.style.opacity = this.opacity.toString(), c.style.fontSize = +$.size * this.fontScale + "px", c.addEventListener("animationend", () => {
      ...
      switch (S) {
        case "roll":
        case "reverse":
          if (A = u(c, S, v), k = A % l, k >= 0) {
            const w = this.trackHeights[S].slice(0, l).reduce((_, q) => _ + q, 0), x = this.trackHeights[S].slice(0, k).reduce((_, q) => _ + q, 0) % w;
            ...
            c.dataset.track = A.toString(), c.style.width = v + 1 + "px", c.style.top = x + "px", c.style.fontFamily = this.fontFamily, c.style.fontWeight = this.fontWeight, c.style.setProperty("--duration", `${b / F}s`), c.style.setProperty("--offset", `${s + this.startDistance}px`), c.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = u(c, S, 0) % l, k >= 0) {
            ...
            for (const b of x)
              w.push(...b);
            const F = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, _) => b + _, 0);
            if (F + parseInt(c.style.fontSize) + this.trackPadding > n) {
              (E = this.danmakuTracks[S][m]) == null || E.pop();
              return;
            }
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of r)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), d = this.container.getBoundingClientRect(), u = o.left - d.left, f = o.right - d.left, y = o.top - d.top, E = o.bottom - d.top;
        if (t >= u - s && t <= f + s && e >= y - s && e <= E + s && (l.push(h), n))
          return l;
      }
    return l;
  }
...
class zt extends P {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.parser = new us({ defaultParser: "mfuns" }), this.operate = new ps(this.player), this.api = (s = e.danmaku) == null ? void 0 : s.api, this.allowNewDanmaku = !1, this.$el = H("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      H("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new cs(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
...
const gs = () => p`
  <div class="${a}-about">
    ...
    <div>github: <a href="${ge}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者</div>
...
class Xt extends P {
  constructor(t) {
    ...
    this.container = H("div", { class: `${a}-contextmenu-wrap` }), g(fs(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
...
Ct.pluginName = "side";
const Es = [Jt], _s = [Qt, Ct, Kt, Gt, Yt, Xt], As = [
  Zt,
  Ft,
  Pt,
  Dt,
