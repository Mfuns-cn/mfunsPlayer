...
class yt {
  ...
  pluginInit(t) {
    this.list.forEach((e) => {
      var i;
      (i = e.init) == null || i.call(e, this.player, t);
    });
  }
  /** 销毁所有插件 */
  pluginDestory() {
 ...
 */
var tt;
const J = window, I = J.trustedTypes, rt = I ? I.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, it = "$lit$", D = `lit$${(Math.random() + "").slice(9)}$`, vt = "?" + D, bt = `<${vt}>`, M = document, O = () => M.createComment(""), U = (s) => s === null || typeof s != "object" && typeof s != "function", $t = Array.isArray, wt = (s) => $t(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", et = `[ 	
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, lt = /-->/g, nt = />/g, _ = RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), at = /'/g, ot = /"/g, gt = /^(?:script|style|textarea|title)$/i, kt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), u = kt(1), j = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), ht = /* @__PURE__ */ new WeakMap(), H = M.createTreeWalker(M, 129, null, !1);
function ft(s, t) {
...
const St = (s, t) => {
  ...
  for (let c = 0; c < e; c++) {
    const o = s[c];
    let d, p, g = -1, f = 0;
    for (; f < o.length && (a.lastIndex = f, p = a.exec(o), p !== null); )
      f = a.lastIndex, a === N ? p[1] === "!--" ? a = lt : p[1] !== void 0 ? a = nt : p[2] !== void 0 ? (gt.test(p[2]) && (l = RegExp("</" + p[2], "g")), a = _) : p[3] !== void 0 && (a = _) : a === _ ? p[0] === ">" ? (a = l ?? N, g = -1) : p[1] === void 0 ? g = -2 : (g = a.lastIndex - p[2].length, d = p[1], a = p[3] === void 0 ? _ : p[3] === '"' ? ot : at) : a === ot || a === at ? a = _ : a === lt || a === nt ? a = N : (a = _, l = void 0);
    const A = a === _ && s[c + 1].startsWith("/>") ? " " : "";
    n += a === N ? o + bt : g >= 0 ? (i.push(d), o.slice(0, g) + it + o.slice(g) + D + A) : o + D + (g === -2 ? (i.push(void 0), c) : A);
  }
  return [ft(s, n + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class X {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const c = t.length - 1, o = this.parts, [d, p] = St(t, e);
    if (this.el = X.createElement(d, i), H.currentNode = this.el.content, e === 2) {
      const g = this.el.content, f = g.firstChild;
      f.remove(), g.append(...f.childNodes);
    }
    for (; (l = H.nextNode()) !== null && o.length < c; ) {
      if (l.nodeType === 1) {
        if (l.hasAttributes()) {
          const g = [];
          for (const f of l.getAttributeNames())
            if (f.endsWith(it) || f.startsWith(D)) {
              const A = p[a++];
              if (g.push(f), A !== void 0) {
                const L = l.getAttribute(A.toLowerCase() + it).split(D), m = /([.?@])?(.*)/.exec(A);
                o.push({ type: 1, index: n, name: m[2], strings: L, ctor: m[1] === "." ? Lt : m[1] === "?" ? Pt : m[1] === "@" ? Ft : C });
              } else
        ...
        if (gt.test(l.tagName)) {
          const g = l.textContent.split(D), f = g.length - 1;
          if (f > 0) {
            l.textContent = I ? I.emptyScript : "";
            for (let A = 0; A < f; A++)
              l.append(g[A], O()), H.nextNode(), o.push({ type: 2, index: ++n });
            l.append(g[f], O());
          }
        }
        ...
        if (l.data === vt)
          ...
          let g = -1;
          for (; (g = l.data.indexOf(D, g + 1)) !== -1; )
            o.push({ type: 7, index: n }), g += D.length - 1;
        }
      n++;
    }
  }
...
function B(s, t, e = s, i) {
  ...
  if (t === j)
    return t;
  let o = i !== void 0 ? (l = e._$Co) === null || l === void 0 ? void 0 : l[i] : e._$Cl;
  const d = U(t) ? void 0 : t._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== d && ((n = o == null ? void 0 : o._$AO) === null || n === void 0 || n.call(o, !1), d === void 0 ? o = void 0 : (o = new d(s), o._$AT(s, e, i)), i !== void 0 ? ((a = (c = e)._$Co) !== null && a !== void 0 ? a : c._$Co = [])[i] = o : e._$Cl = o), o !== void 0 && (t = B(s, o._$AS(s, t.values), o, i)), t;
}
class xt {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: i }, parts: l } = this._$AD, n = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : M).importNode(i, !0);
    H.currentNode = n;
    let a = H.nextNode(), c = 0, o = 0, d = l[0];
    for (; d !== void 0; ) {
      if (c === d.index) {
        let p;
        d.type === 2 ? p = new K(a, a.nextSibling, this, t) : d.type === 1 ? p = new d.ctor(a, d.name, d.strings, this, t) : d.type === 6 && (p = new Et(a, this, t)), this._$AV.push(p), d = l[++o];
      }
      c !== (d == null ? void 0 : d.index) && (a = H.nextNode(), c++);
    }
    return H.currentNode = M, n;
  }
  v(t) {
    let e = 0;
...
class K {
  constructor(t, e, i, l) {
    var n;
    this.type = 2, this._$AH = E, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = i, this.options = l, this._$Cp = (n = l == null ? void 0 : l.isConnected) === null || n === void 0 || n;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = B(this, t, e), U(t) ? t === E || t == null || t === "" ? (this._$AH !== E && this._$AR(), this._$AH = E) : t !== this._$AH && t !== j && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : wt(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== E && U(this._$AH) ? this._$AA.nextSibling.data = t : this.$(M.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: i, _$litType$: l } = t, n = typeof l == "number" ? this._$AC(t) : (l.el === void 0 && (l.el = X.createElement(ft(l.h, l.h[0]), this.options)), l);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === n)
      this._$AH.v(i);
    else {
      const a = new xt(n, this), c = a.u(this.options);
  ...
  T(t) {
    ...
    let i, l = 0;
    for (const n of t)
      l === e.length ? e.push(i = new K(this.k(O()), this.k(O()), this, this.options)) : i = e[l], i._$AI(n), l++;
    l < e.length && (this._$AR(i && i._$AB.nextSibling, l), e.length = l);
  }
...
class C {
  constructor(t, e, i, l, n) {
    this.type = 1, this._$AH = E, this._$AN = void 0, this.element = t, this.name = e, this._$AM = l, this.options = n, i.length > 2 || i[0] !== "" || i[1] !== "" ? (this._$AH = Array(i.length - 1).fill(new String()), this.strings = i) : this._$AH = E;
  }
  get tagName() {
  ...
  _$AI(t, e = this, i, l) {
    ...
    let a = !1;
    if (n === void 0)
      t = B(this, t, e, 0), a = !U(t) || t !== this._$AH && t !== j, a && (this._$AH = t);
    else {
      const c = t;
      let o, d;
      for (t = n[0], o = 0; o < n.length - 1; o++)
        d = B(this, c[i + o], e, o), d === j && (d = this._$AH[o]), a || (a = !U(d) || d !== this._$AH[o]), d === E ? t = E : t !== E && (t += (d ?? "") + n[o + 1]), this._$AH[o] = d;
    }
    a && !l && this.j(t);
  }
  j(t) {
...
class Pt extends C {
  ...
  j(t) {
    t && t !== E ? this.element.setAttribute(this.name, At) : this.element.removeAttribute(this.name);
  }
}
class Ft extends C {
  constructor(t, e, i, l, n) {
    super(t, e, i, l, n), this.type = 5;
  }
  _$AI(t, e = this) {
    var i;
    if ((t = (i = B(this, t, e, 0)) !== null && i !== void 0 ? i : E) === j)
      return;
    const l = this._$AH, n = t === E && l !== E || t.capture !== l.capture || t.once !== l.once || t.passive !== l.passive, a = t !== E && (l === E || n);
    n && this.element.removeEventListener(this.name, this, l), a && this.element.addEventListener(this.name, this, t), this._$AH = t;
  }
  handleEvent(t) {
    var e, i;
...
ct == null || ct(X, K), ((tt = J.litHtmlVersions) !== null && tt !== void 0 ? tt : J.litHtmlVersions = []).push("2.8.0");
const y = (s, t, e) => {
  var i, l;
  const n = (i = e == null ? void 0 : e.renderBefore) !== null && i !== void 0 ? i : t;
  let a = n._$litPart$;
  if (a === void 0) {
    const c = (l = e == null ? void 0 : e.renderBefore) !== null && l !== void 0 ? l : null;
    n._$litPart$ = a = new K(t.insertBefore(O(), c), c, void 0, e ?? {});
  }
  return a._$AI(s), a;
}, r = "mfuns-player", Tt = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", qt = [
  { name: "Minteea", id: "Minteea", link: "https://github.com/Minteea" },
  { name: "鲁迪钨丝", id: "Rudiusu", link: "https://github.com/Rudiusu" }
], V = (s, t) => Array.from({ length: s }, () => t), Dt = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, _t = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Wt = document.pictureInPictureEnabled, dt = (s) => {
  const t = s.split(/[:：]/).slice(-3), e = parseInt(t[t.length - 1]) || 0, i = parseInt(t[t.length - 2]) || 0, l = parseInt(t[t.length - 3]) || 0;
  return e + i * 60 + l * 3600;
}, Ht = (s, t, e = !1) => {
  let i = null, l = !1;
  return function(...n) {
    i && clearTimeout(i), e && !l ? (s.apply(this, n), l = !0) : i = setTimeout(() => {
      s.apply(this, n), clearTimeout(i), i = null, l = !1;
    }, t);
  };
}, Z = (s, t = !0) => {
  if (s = s || 0, s === 0 || s === 1 / 0 || s.toString() === "NaN")
    return "00:00";
  const e = (a) => a < 10 ? `0${a}` : `${a}`, i = Math.floor(s / 3600), l = Math.floor((s - i * 3600) / 60), n = Math.floor(s - i * 3600 - l * 60);
  return t ? (i > 0 ? [i, l, n] : [l, n]).map(e).join(":") : [i * 60 + l, n].map(e).join(":");
}, Mt = (s) => (s[0] === "#" && (s = s.substr(1)), s.length === 3 && (s = `${s[0]}${s[0]}${s[1]}${s[1]}${s[2]}${s[2]}`), parseInt(s, 16) + 0 & 16777215), It = (s) => `#${`00000${s.toString(16)}`.slice(-6)}`, Bt = () => u`
  <div class="${r}-progress-bar">
    <div class="${r}-progress-bar-buffered"></div>
    <div class="${r}-progress-bar-played"></div>
    <div class="${r}-progress-bar-thumb-track">
      <div class="${r}-progress-bar-thumb"></div>
    </div>
    <div class="${r}-progress-bar-preview">
      <div class="${r}-progress-bar-thumbnail"></div>
      <div class="${r}-progress-bar-time"></div>
    </div>
    <div class="${r}-progress-bar-tip"></div>
  </div>
`;
class Rt {
  constructor(t, e) {
    this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.controller = t, this.player = t.player, this.container = t.$progress, y(Bt(), this.container), this.el = this.container.querySelector(`.${r}-progress-bar`), this.$buffered = this.el.querySelector(`.${r}-progress-bar-buffered`), this.$played = this.el.querySelector(`.${r}-progress-bar-played`), this.$thumbTrack = this.el.querySelector(`.${r}-progress-bar-thumb-track`), this.$thumb = this.el.querySelector(`.${r}-progress-bar-thumb`), this.$preview = this.el.querySelector(`.${r}-progress-bar-preview`), this.$thumbnail = this.el.querySelector(`.${r}-progress-bar-thumbnail`), this.$time = this.el.querySelector(`.${r}-progress-bar-time`), this.$tip = this.el.querySelector(`.${r}-progress-bar-tip`), this.video = this.player.video, this.container.addEventListener("mousedown", (n) => {
      const { clientX: a } = n;
      this.trackLength = this.el.offsetWidth, this.nMax = this.$thumbTrack.offsetWidth || this.trackLength, this.nLeft = this.container.getBoundingClientRect().left, this.distance = a - this.nLeft, this.setBarPlayed(this.nValue), this.el.classList.add(`${r}-progress-bar-dragging`), this.isDragging = !0, document.addEventListener("mousemove", i), document.addEventListener("mouseup", l);
    });
    const i = (n) => {
      var c;
      const { clientX: a } = n;
      n.preventDefault(), n.stopPropagation(), this.distance = a - this.nLeft, this.setBarPlayed(this.nValue), this.updateTip(), (c = window.getSelection()) == null || c.removeAllRanges();
    }, l = (n) => {
      var a;
      n.stopPropagation(), (a = window.getSelection()) == null || a.removeAllRanges(), document.removeEventListener("mousemove", i), document.removeEventListener("mouseup", l), this.el.classList.remove(`${r}-progress-bar-dragging`), this.isDragging = !1, this.isHover || this.setActive(!1), this.player.seek(this.nValue), this.player.play();
    };
    this.container.addEventListener("mouseenter", () => {
      this.isHover = !0, this.isDragging || this.updateTip();
    }), this.container.addEventListener("mousemove", (n) => {
      if (this.isDragging)
        return;
      const { clientX: a } = n;
      ...
      this.isDragging || this.setBarPlayed(n);
    }), this.player.on("progress", (n) => {
      this.setBarBuffered(n);
    });
  }
  /** 滑动距离 */
  get nLength() {
  ...
  /** 设置进度条活跃状态 */
  setActive(t) {
    this.isActive = t, this.el.classList.toggle(`${r}-progress-bar-active`, t), t ? this.controller.setControl(!0) : this.controller.setControl(!1);
  }
  /** 更新指针位置 */
  updateTip() {
...
const Nt = () => u`
  <div class="${r}-controller-button ${r}-controller-fullscreen">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-fullscreen"></i>
      <i class="${r}-controller-icon mp-icon-fullscreen-exit"></i>
    </div>
    <div class="${r}-tooltip">进入全屏</div>
  </div>
`;
class Vt {
  constructor(t, e) {
    ...
    y(Nt(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
...
const zt = () => u`
  <div class="${r}-controller-button ${r}-controller-pip">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-pip"></i>
      <i class="${r}-controller-icon mp-icon-pip-exit"></i>
    </div>
    <div class="${r}-tooltip">画中画</div>
  </div>
`;
class Ot {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(zt(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
    this.player.on("pip", () => {
...
const Ut = () => u`
  <div class="${r}-controller-button ${r}-controller-play state-paused">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-play"></i>
      <i class="${r}-controller-icon mp-icon-pause"></i>
    </div>
    <div class="${r}-tooltip">播放</div>
  </div>
`;
class jt {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(Ut(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
...
const Xt = () => u`
  <div class="${r}-controller-time">
    <div class="${r}-controller-time-label">
      <span class="${r}-controller-time-current">00:00</span>
      <span>/</span>
      <span class="${r}-controller-time-total">00:00</span>
    </div>
    <input class="${r}-controller-time-input mp-input" />
  </div>
`;
class Kt {
  constructor(t, e) {
    ...
    const i = new DocumentFragment();
    y(Xt(), i), this.el = i.querySelector(`.${r}-controller-time`), this.$label = i.querySelector(`.${r}-controller-time-label`), this.$current = i.querySelector(`.${r}-controller-time-current`), this.$total = i.querySelector(`.${r}-controller-time-total`), this.$input = i.querySelector(`.${r}-controller-time-input`), this.init(), e.appendChild(i);
  }
  init() {
...
const Yt = () => u`
  <div class="${r}-controller-button ${r}-controller-loop">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-loop"></i>
      <i class="${r}-controller-icon mp-icon-loop-off"></i>
    </div>
    <div class="${r}-tooltip">洗脑循环</div>
  </div>
`;
class Qt {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(Yt(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
...
const Zt = ({ divider: s }) => u` <div
  class="${r}-slider ${r}-slider-horizontal"
...
>
  <div
    ...
    "
  >
    <div class="${r}-slider-bar" style="position: absolute; left: 0; height: 100%"></div>
    <div class="${r}-slider-thumb-track" style="height: 0px">
      <div
        class="${r}-slider-thumb"
        style="position: absolute; transform: translate(-50%, -50%)"
      ></div>
      ${s ? u`
            <ul class="${r}-slider-divider">
              ${V(s, u`<li class="${r}-slider-divider-dot"></li>`)}
            </ul>
          ` : ""}
    </div>
  </div>
...
class Y {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = l || 0, this.divider = n ? typeof n == "boolean" ? this.step : n : 0, this.value = isNaN(a) ? a : Number(a), this.onChange = c, this.onDragStart = o, this.onDragEnd = d, this.onDrag = p, y(Zt({ divider: this.divider }), t), this.el = this.container.querySelector(`.${r}-slider`), this.$track = this.el.querySelector(`.${r}-slider-track`), this.$bar = this.$track.querySelector(`.${r}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${r}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${r}-slider-thumb`), this.el.addEventListener("mousedown", (g) => {
      var k;
      const f = g, { clientX: A } = f, L = this.$track.offsetWidth;
      ...
      const w = (S) => {
        ...
        let P = b - h - v;
        P = P >= m ? m : P <= 0 ? 0 : P;
        const q = this.step ? Math.round(P / m * (this.max - this.min) / this.step) * this.step + this.min : P / m * (this.max - this.min) + this.min;
        this.value != q && this.drag(q), (st = window.getSelection()) == null || st.removeAllRanges();
      }, F = (S) => {
        var b, P;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", w), document.removeEventListener("mouseup", F), (P = this.onDragEnd) == null || P.call(this, x);
      };
...
const Gt = () => u`
  <div
    class="${r}-slider ${r}-slider-vertical"
    style="position: relative; width: 100%; height: 100%"
  >
    <div
      class="${r}-slider-track"
    ...
    >
      ...
      ></div>
      <div class="${r}-slider-thumb-track" style="width: 0px">
        <div
          class="${r}-slider-thumb"
          style="position: absolute; transform: translate(-50%, -50%)"
        ></div>
...
class Jt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = l || 0, this.value = isNaN(n) ? n : Number(n), this.onChange = a, this.onDragStart = c, this.onDragEnd = o, this.onDrag = d, y(Gt(), t), this.el = this.container.querySelector(`.${r}-slider`), this.$track = this.el.querySelector(`.${r}-slider-track`), this.$bar = this.$track.querySelector(`.${r}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${r}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${r}-slider-thumb`), this.el.addEventListener("mousedown", (p) => {
      var F;
      const g = p, { clientY: f } = g, A = this.$track.offsetHeight;
      let L = this.$thumbTrack.offsetHeight;
      L = L || A;
      const m = (A - L) / 2, v = this.el.getBoundingClientRect().top;
      let h = L - (f - v - m);
      h = h >= L ? L : h <= 0 ? 0 : h;
      const $ = this.step ? Math.round(h / L * (this.max - this.min) / this.step) * this.step + this.min : h / L * (this.max - this.min) + this.min;
      (F = this.onDragStart) == null || F.call(this, $), this.value != $ && this.drag($);
      const x = (k) => {
        var q;
        ...
        this.value != P && this.drag(P), (q = window.getSelection()) == null || q.removeAllRanges();
      }, w = (k) => {
        var T, b;
...
const Ct = ({
  ...
  <ul class="${r}-picker">
    ${s.map(
  (e, i) => u`
        <li class="${r}-picker-item" data-value="${e.value}">
...
`;
class z {
  constructor({ container: t, value: e, onChange: i, onPick: l, list: n, template: a, condition: c }) {
    this.container = t, this.list = n, this.value = e ?? null, this.onChange = i, this.onPick = l, this.template = a, this.condition = c, this.reload();
  }
  /** 重载，一般用于列表项更改 */
  reload(t) {
    y(Ct({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${r}-picker`), this.$items = this.el.querySelectorAll(`.${r}-picker-item`), this.$items.forEach((e) => {
  ...
  setValue(t) {
    var e;
    this.$items.forEach((i, l) => {
      (this.condition ? this.condition(i.getAttribute("data-value"), t) : i.getAttribute("data-value") == t) ? i.classList.add("state-picked") : i.classList.remove("state-picked");
...
class ee {
  ...
  constructor({ container: t, value: e = [], list: i, onChange: l, onToggle: n }) {
    this.container = t, this.list = i, this.valueSet = new Set(e), this.onChange = l, this.onToggle = n, this.reload();
  }
  /** 重载，一般用于列表项更改 */
  reload(t) {
    y(te({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${r}-picker`), this.$items = this.el.querySelectorAll(`.${r}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
  ...
  setValue(t) {
    var e;
    this.valueSet = new Set(t), this.$items.forEach((i, l) => {
      this.valueSet.has(i.getAttribute("data-value")) ? i.classList.add("state-picked") : i.classList.remove("state-picked");
  ...
  toggle(t, e) {
    ...
    i ? this.valueSet.add(t) : this.valueSet.delete(t), this.$items.forEach((a, c) => {
      a.getAttribute("data-value") == t && a.classList.toggle("state-picked", i);
    }), (l = this.onChange) == null || l.call(this, this.value), (n = this.onToggle) == null || n.call(this, t, i);
  }
}
const ie = ({ label: s }) => u`
  <div class="${r}-checkbox">
    <div class="${r}-checkbox-icon"></div>
    <div class="${r}-checkbox-label">${s}</div>
  </div>
`;
class ut {
  constructor({ container: t, value: e = !1, onChange: i, onToggle: l, label: n }) {
    this.container = t, this.value = e, this.onChange = i, this.onToggle = l, this.label = n, y(ie({ label: this.label }), this.container), this.el = this.container.querySelector(`.${r}-checkbox`), this.el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
const se = () => u`
  <div class="${r}-controller-button ${r}-controller-volume">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-volume"></i>
      <i class="${r}-controller-icon mp-icon-volume-off"></i>
    </div>

    <div class="${r}-controller-panel-wrap">
      <div class="${r}-controller-panel">
        <div class="${r}-controller-volume-text">0</div>
        <div class="${r}-controller-volume-slider"></div>
      </div>
    </div>
  </div>
`;
class re {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(se(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$slider = i.querySelector(`.${r}-controller-volume-slider`), this.$text = i.querySelector(`.${r}-controller-volume-text`), this.init(), e.appendChild(i);
  }
  init() {
    this.slider = new Jt({
...
const le = () => u`
  <div class="${r}-controller-button ${r}-controller-settings">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-settings"></i>
    </div>
    <div class="${r}-controller-panel-wrap">
      <div class="${r}-controller-panel ${r}-controller-panel-settings">
        ...
        <div class="${r}-panel-row">
          ...
          <div class="${r}-settings-scale-picker"></div>
        </div>
        <div class="${r}-panel-row">
          <div class="${r}-row-label">界面设置</div>
        </div>
        <div class="${r}-panel-row">
          <div class="${r}-settings-solid-checkbox"></div>
          <div class="${r}-settings-showPrevButton-checkbox"></div>
        </div>
      </div>
    </div>
  </div>
...
class ne {
  constructor(t, e, i) {
    ...
    y(le(), l), this.el = l.querySelector(`.${r}-controller-button`), this.$iconWrap = this.el.querySelector(`.${r}-controller-icon-wrap`), this.$ratePicker = this.el.querySelector(`.${r}-settings-rate-picker`), this.$scalePicker = this.el.querySelector(`.${r}-settings-scale-picker`), this.$solidCheckbox = this.el.querySelector(`.${r}-settings-solid-checkbox`), this.$showPrevButtonCheckbox = this.el.querySelector(
      `.${r}-settings-showPrevButton-checkbox`
    ), this.init(i), e.appendChild(l);
  }
  init(t) {
    var e;
    this.pickerRate = new z({
      ...
      value: 1,
      onPick: (i) => {
        this.player.setPlaybackRate(Number(i));
      }
    }), this.player.on("ratechange", (i) => {
      this.pickerRate.setValue(i);
    }), this.pickerScale = new z({
      container: this.$scalePicker,
      list: [{ value: "", label: "自动" }, { value: "16:9" }, { value: "4:3" }],
      value: "",
      onPick: (i) => {
        this.player.video.setRatio(
          i ? i.split(":").map((l) => Number(l)) : null
        );
      }
    }), this.player.on("change:aspectRatio", (i) => {
      this.pickerRate.setValue(i ? i.join(":") : "");
    }), (e = t.feature) != null && e.solid && (this.checkboxSolid = new ut({
      container: this.$solidCheckbox,
      label: "固定控制栏",
      onToggle: (i) => {
        this.player.mode.solid(i);
      }
    })), this.checkboxShowPrevButton = new ut({
      container: this.$showPrevButtonCheckbox,
      label: "显示上一P按钮（多P下生效）",
      onToggle: (i) => {
        this.player.controller.buttonPrev.show(i);
      }
    });
  }
}
const ae = () => u`
  <div class="${r}-controller-button ${r}-controller-part">
    <div class="${r}-controller-icon-wrap">
      <div class="${r}-controller-texticon">P0</div>
    </div>
    <div class="${r}-tooltip">分P列表</div>
  </div>
`;
class oe {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(ae(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.$texticon = i.querySelector(`.${r}-controller-texticon`), this.init(), e.appendChild(i);
  }
  init() {
...
const he = () => u`
  <div class="${r}-controller-button ${r}-controller-webfull">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-webfull"></i>
      <i class="${r}-controller-icon mp-icon-webfull-exit"></i>
    </div>
    <div class="${r}-tooltip">网页全屏</div>
  </div>
`;
class ce {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(he(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
...
const de = () => u`
  <div class="${r}-controller-button ${r}-controller-prev">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-prev"></i>
    </div>
    <div class="${r}-tooltip">上一P</div>
  </div>
`;
class ue {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(de(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
    this.player.on("part", (t) => {
...
const pe = () => u`
  <div class="${r}-controller-button ${r}-controller-next">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-next"></i>
    </div>
    <div class="${r}-tooltip">下一P</div>
  </div>
`;
class me {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(pe(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
    this.player.on("part", (t) => {
...
var W = /* @__PURE__ */ ((s) => (s[s.Backspace = 8] = "Backspace", s[s.Tab = 9] = "Tab", s[s.Enter = 13] = "Enter", s[s.Shift = 16] = "Shift", s[s.Ctrl = 17] = "Ctrl", s[s.Alt = 18] = "Alt", s[s.PauseBreak = 19] = "PauseBreak", s[s.CapsLock = 20] = "CapsLock", s[s.Escape = 27] = "Escape", s[s.Space = 32] = "Space", s[s.PageUp = 33] = "PageUp", s[s.PageDown = 34] = "PageDown", s[s.End = 35] = "End", s[s.Home = 36] = "Home", s[s.LeftArrow = 37] = "LeftArrow", s[s.UpArrow = 38] = "UpArrow", s[s.RightArrow = 39] = "RightArrow", s[s.DownArrow = 40] = "DownArrow", s[s.Insert = 45] = "Insert", s[s.Delete = 46] = "Delete", s[s.Zero = 48] = "Zero", s[
  ...
  s.GraveAccent = 192
  /* Tilde */
] = "GraveAccent", s[s.OpenBracket = 219] = "OpenBracket", s[s.ClosedBracket = 221] = "ClosedBracket", s[s.Quote = 222] = "Quote", s))(W || {});
const ve = () => u`
  <div class="${r}-controller-button ${r}-controller-danmaku-switch state-on">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-danmaku"></i>
      <i class="${r}-controller-icon mp-icon-danmaku-off"></i>
    </div>
    <div class="${r}-tooltip">关闭弹幕</div>
  </div>
`;
class $e {
  constructor(t, e) {
    this.player = t;
    const i = new DocumentFragment();
    y(ve(), i), this.el = i.querySelector(`.${r}-controller-button`), this.$iconWrap = i.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = i.querySelector(`.${r}-tooltip`), this.init(), e.appendChild(i);
  }
  init() {
...
const ge = () => u`
  <div class="${r}-controller-button ${r}-controller-danmaku-settings">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-danmaku-settings"></i>
    </div>
    <div class="${r}-controller-panel-wrap">
      <div class="${r}-controller-panel ${r}-controller-panel-danmaku-settings">
        <div class="${r}-panel-row">
          <div class="${r}-row-label">弹幕类型屏蔽</div>
...
class fe {
  constructor(t, e, i) {
    this.player = t;
    const l = new DocumentFragment();
    y(ge(), l), this.el = l.querySelector(`.${r}-controller-button`), this.$iconWrap = this.el.querySelector(`.${r}-controller-icon-wrap`), this.$filterPicker = this.el.querySelector(`.${r}-danmaku-settings-filter-picker`), this.$opacitySlider = this.el.querySelector(`.${r}-danmaku-settings-opacity-slider`), this.$areaSlider = this.el.querySelector(`.${r}-danmaku-settings-area-slider`), this.$sizeSlider = this.el.querySelector(`.${r}-danmaku-settings-size-slider`), this.$speedSlider = this.el.querySelector(`.${r}-danmaku-settings-speed-slider`), this.$opacityValue = this.el.querySelector(`.${r}-danmaku-settings-opacity-value`), this.$areaValue = this.el.querySelector(`.${r}-danmaku-settings-area-value`), this.$sizeValue = this.el.querySelector(`.${r}-danmaku-settings-size-value`), this.$speedValue = this.el.querySelector(`.${r}-danmaku-settings-speed-value`), this.init(), e.appendChild(l);
  }
  init() {
    this.pickerFilter = new ee({
...
const ye = () => u`
  <div class="${r}-controller-button ${r}-controller-danmaku-style">
    <div class="${r}-controller-icon-wrap">
      <i class="${r}-controller-icon mp-icon-text"></i>
    </div>
    <div class="${r}-controller-panel-wrap">
      <div class="${r}-controller-panel ${r}-controller-panel-danmaku-style">
        <div class="${r}-panel-row">
        ...
        <div class="${r}-panel-row">
          ...
          <input class="${r}-danmaku-style-color-input mp-input" type="text" value="#" />
          <div class="${r}-danmaku-style-color-preview"></div>
          ${EyeDropper ? u`<button class="${r}-danmaku-style-color-dropper mp-button">
                拾取
              </button>` : ""}
        </div>
...
class be {
  constructor(t, e, i) {
    ...
    const l = new DocumentFragment();
    y(ye(), l), this.el = l.querySelector(`.${r}-controller-button`), this.$iconWrap = this.el.querySelector(`.${r}-controller-icon-wrap`), this.$tooltip = this.el.querySelector(`.${r}-tooltip`), this.$fontsizePicker = this.el.querySelector(`.${r}-danmaku-style-fontsize-picker`), this.$modePicker = this.el.querySelector(`.${r}-danmaku-style-mode-picker`), this.$colorPicker = this.el.querySelector(`.${r}-danmaku-style-color-picker`), this.$colorInput = this.el.querySelector(`.${r}-danmaku-style-color-input`), this.$colorPreview = this.el.querySelector(`.${r}-danmaku-style-color-preview`), this.$colorDropper = this.el.querySelector(`.${r}-danmaku-style-color-dropper`), this.init(i), e.appendChild(l);
  }
  init(t) {
    var e, i;
    this.pickerFontsize = new z({
      container: this.$fontsizePicker,
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || we).map(([l, n]) => ({
        value: l,
        label: n
      })),
      onChange: (l) => {
        this.danmakuBar.danmakuFontSize = Number(l);
      }
      ...
      list: [
        ...
        (l) => {
          var n;
          return (((n = t.danmakuBar) == null ? void 0 : n.modeList) || ke).indexOf(l.value) > -1;
        }
      ),
      onChange: (l) => {
        this.danmakuBar.danmakuMode = Number(l) || 1;
      }
    }), this.pickerColor = new z({
      container: this.$colorPicker,
      value: "#FFFFFF",
      list: (((i = t.danmakuBar) == null ? void 0 : i.colorList) || Se).map((l) => ({ value: l })),
      onPick: (l) => {
        this.danmakuBar.danmakuColor = Mt(l);
      },
      onChange: (l) => {
        this.$colorInput.value = l, this.$colorPreview.style.backgroundColor = l;
      },
      template: (l) => u` <div style="background-color: ${l.value}"></div> `,
      condition: (l, n) => l.toLowerCase() == n.toLowerCase()
    }), this.$colorInput.addEventListener("input", (l) => {
      ...
      EyeDropper && new EyeDropper().open().then(({ sRGBHex: n }) => {
        this.pickerColor.pick(n);
      });
    });
  }
}
const we = [
  ...
  <div class="${r}-danmakubar">
    ...
    <div class="${r}-danmakubar-input-wrap">
      ...
      <div class="${r}-danmakubar-status-login">需要登录后才能发送弹幕哦~</div>
      -->
...
class Le {
  constructor(t, e) {
    var l;
    this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = t, this.player = t.player;
    const i = this.player.template.$footbar;
    y(xe, i), this.el = i.querySelector(`.${r}-danmakubar`), this.$send = this.el.querySelector(`.${r}-danmakubar-send`), this.$input = this.el.querySelector(`.${r}-danmakubar-input`), this.$slot = this.el.querySelector(`.${r}-danmakubar-slot`), this.$inputSlot = this.el.querySelector(`.${r}-danmakubar-input-slot`), this.buttonDanmakuSwitch = new $e(this.player, this.$slot), this.buttonDanmakuSettings = new fe(this.player, this.$slot), this.buttonDanmakuStyle = new be(this, this.$inputSlot, e), this.player.on("fullscreen", () => {
      ...
      n.keyCode == W.Enter && this.send();
    }), this.$send.onclick = () => {
      this.send();
    }, this.setPlaceHolder(((l = e.danmakuBar) == null ? void 0 : l.placeholder) || Ae);
  }
  moveToFootbar() {
...
const Ae = "发条弹幕吧~", Pe = () => u`
  ...
  <div class="${r}-controller mp-crystal">
    <div class="${r}-controller-progress"></div>
...
class Fe {
  constructor(t, e) {
    ...
    const i = new DocumentFragment();
    y(Pe(), i), this.el = i.querySelector(`.${r}-controller`), this.$progress = this.el.querySelector(`.${r}-controller-progress`), this.$content = this.el.querySelector(`.${r}-controller-content`), this.$left = this.el.querySelector(`.${r}-controller-left`), this.$center = this.el.querySelector(`.${r}-controller-center`), this.$right = this.el.querySelector(`.${r}-controller-right`), this.progressBar = new Rt(this, e), this.danmakuBar = new Le(this, e), this.buttonPrev = new ue(this.player, this.$left), this.buttonPlay = new jt(this.player, this.$left), this.buttonNext = new me(this.player, this.$left), this.labelTime = new Kt(this.player, this.$left), this.buttonLoop = new Qt(this.player, this.$left), this.buttonPart = new oe(this.player, this.$right), this.buttonVolume = new re(this.player, this.$right), this.buttonSettings = new ne(this.player, this.$right, e), Wt && (this.buttonPip = new Ot(this.player, this.$right)), (l = e.feature) != null && l.webfull && (this.buttonWebfull = new ce(this.player, this.$right)), _t && (this.buttonFullScreen = new Vt(this.player, this.$right)), this.init(), this.container.appendChild(i);
  }
  init() {
    this.buttonPrev.show(!1), this.container.addEventListener("mouseenter", () => {
      this.isHover = !0;
    }), this.container.addEventListener("mouseleave", () => {
      this.isHover = !1;
    });
...
const Te = () => u`
  <div class="${r}">
    <div class="${r}-main">
      <div class="${r}-video-area">
        <div class="${r}-video-wrap">
          <video class="${r}-video"></video>
        </div>
        <div class="${r}-danmaku-wrap"></div>
        <div class="${r}-state-wrap"></div>
        <div class="${r}-toast-wrap"></div>
      </div>
      <div class="${r}-side-wrap"></div>
      <div class="${r}-modal-wrap"></div>
      <div class="${r}-contextmenu-wrap"></div>
      <div class="${r}-header-wrap"></div>
      <div class="${r}-controller-wrap"></div>
    </div>
    <div class="${r}-footbar mp-solid"></div>
    <div class="${r}-miniplayer">
      <div class="${r}-miniplayer-content"></div>
    </div>
  </div>
`;
class qe {
  ...
  init() {
    ...
    this.el = t(`.${r}`), this.$main = t(`.${r}-main`), this.$video = t(`.${r}-video`), this.$videoArea = t(`.${r}-video-area`), this.$videoWrap = t(`.${r}-video-wrap`), this.$danmakuWrap = t(`.${r}-danmaku-wrap`), this.$toastWrap = t(`.${r}-toast-wrap`), this.$stateWrap = t(`.${r}-state-wrap`), this.$headerWrap = t(`.${r}-header-wrap`), this.$contextmenuWrap = t(`.${r}-contextmenu-wrap`), this.$modalWrap = t(`.${r}-modal-wrap`), this.$controllerWrap = t(`.${r}-controller-wrap`), this.$sideWrap = t(`.${r}-side-wrap`), this.$footbar = t(`.${r}-footbar`), this.$miniplayer = t(`.${r}-miniplayer`);
  }
}
class De {
  constructor(t) {
...
class _e {
  constructor(t, e) {
    this.quality = "1080P", this.ratio = null, this.player = t, this.el = this.player.template.$video, this.loader = new De(this), this.list = e.video.list, this.currentPart = e.video.part || 1, this.setRatio(e.aspectRatio || null), this.initEvent(), this.initKeepRatio();
  }
  /** 设置视频 */
  async setVideo(t, e = !1) {
    const i = t.part || 1;
    this.list = t.list, this.currentPart = i, this.load(this.findSourceByQuality(this.partInfo.src, this.quality), e), this.player.events.trigger("video"), this.player.events.trigger("part", i), this.seek(0);
  }
  /** 设置分P */
  async setPart(t, e = !1) {
  ...
  async setQuality(t) {
    ...
    let i = e.find((l) => l.quality == t);
    i || (i = this.findSourceByQuality(e, t)), this.load(i, !this.paused, this.duration);
  }
  /** 加载视频 */
  load(t, e, i) {
    this.loader.load(t);
    const l = () => {
      this.player.events.trigger("video:load_end"), i && this.seek(i), e ? this.play() : this.player.template.el.classList.add("state-paused"), this.el.removeEventListener("loadedmetadata", l);
    };
    this.el.addEventListener("loadedmetadata", l);
  }
  /** 根据视频质量选择合适的视频源
   * 返回小于等于该质量的视频源中最大的一个
   */
  findSourceByQuality(t, e) {
    const i = [...t].sort(
      (n, a) => parseInt(a.quality || "") - parseInt(n.quality || "")
    );
    let l = i.find((n) => parseInt(n.quality || "") <= parseInt(e));
    return l || (l = i[i.length - 1]), l;
  }
  /** 视频分P */
  get part() {
  ...
  setRatio(t) {
    if (this.ratio = t, this.el.style.width = "", this.el.style.height = "", t) {
      const [e, i] = t;
      this.el.style.aspectRatio = `${e}/${i}`, this.el.style.objectFit = "fill";
      const { width: l, height: n } = this.el.getBoundingClientRect(), { width: a, height: c } = this.player.template.$videoArea.getBoundingClientRect();
      l == a && n == c && this.rescale(l, n, e, i);
    } else
  ...
  /** 监听视频事件 */
  on(t, e, i) {
    this.el.addEventListener(t, e, i);
  }
  /** 移除视频事件 */
  off(t, e, i) {
    this.el.removeEventListener(t, e, i);
  }
  initEvent() {
    this.on("play", () => {
  ...
  initKeepRatio() {
    this.player.on("resize", ([t, e]) => {
      if (this.ratio) {
        ...
        const [i, l] = this.ratio, { width: n, height: a } = this.el.getBoundingClientRect();
        console.log(`${n} x ${a} -- ${t} x ${e}`), Math.abs(n - t) < 1 && Math.abs(a - e) < 1 && this.rescale(t, e, i, l);
      }
    });
  }
  /** 根据当前视频宽高重新维持视频比例 */
  rescale(t, e, i, l) {
    const n = i * e, a = l * t;
    n < a ? (this.el.style.width = `${n / a * 100}%`, this.el.style.height = "100%") : (this.el.style.width = "100%", this.el.style.height = `${a / n * 100}%`);
  }
}
class We {
  constructor(t) {
...
class Ie {
  constructor(t, e) {
    this.player = t, this.modeWebfull = new Me(this.player), this.modeFullscreen = new We(this.player), this.modePip = new He(this.player), this.init();
  }
  init() {
    this.player.on("webfull", () => {
      ...
      const { width: i, height: l } = e.contentRect;
      this.player.events.trigger("resize", [i, l]);
...
const Re = (s, t) => u`
  <div class="${r}-side-panel ${r}-partlist">
    <div class="${r}-partlist-list">
      ${s.map(
  ({ title: e }, i) => u`
          <div
            class="${r}-partlist-list-item"
            @click=${() => {
    t(i + 1);
  }}
          >
            <div class="${r}-partlist-list-id">P${i + 1}</div>
            <div class="${r}-partlist-list-title">${e}</div>
          </div>
        `
)}
    </div>
...
class Ne {
  constructor(t) {
    ...
    y(
      Re(t.video.list, (i) => {
        this.player.setPart(i, !0), this.player.side.hide();
      }),
      e
    ), this.el = e.querySelector(`.${r}-side-panel`);
  }
}
const Ve = () => u`
  ...
  <div class="${r}-side">
    <div class="${r}-side-head">
      ...
      <div class="${r}-side-close">
        <i class="${r}-controller-icon mp-icon-close"></i>
      </div>
    </div>
...
class ze {
  ...
  mountPanel(t, e) {
    const i = this.list[t];
    i && ((e || this.$content).append(i.el), i.el.classList.remove("state-show"), e ? i.mounted = !0 : i.mounted = !1), t == this.current && this.removeCurrent();
  }
  /** 清除当前面板显示 */
  removeCurrent() {
...
const Oe = (s) => u`
  <div class="${r}-contextmenu">
    <ul class="${r}-contextmenu-danmaku mp-black"></ul>
    <ul class="${r}-contextmenu-menu mp-black">
      ${s.map(
  ({ name: t, onClick: e }) => u`
          <li class="${r}-contextmenu-item" @click=${e}>${t}</li>
        `
)}
    </ul>
  </div>
`, Ue = (s, t) => u`
  ${s.map(
  (e) => u`
      <li class="${r}-contextmenu-danmaku-item">
        <div class="${r}-contextmenu-danmaku-item-content">${e.content}</div>
...
class Xe {
  constructor(t, e) {
    ...
    this.container = this.player.template.$contextmenuWrap, y(Oe(i), this.container), this.el = this.container.querySelector(`.${r}-contextmenu`), this.$danmaku = this.el.querySelector(`.${r}-contextmenu-danmaku`), this.$menu = this.el.querySelector(`.${r}-contextmenu-menu`), this.player.template.$videoArea.addEventListener("contextmenu", (l) => {
      l.preventDefault();
      const n = this.player.template.$videoArea.getBoundingClientRect(), a = l.clientX - n.left, c = l.clientY - n.top;
      this.show(a, c);
      const o = this.player.danmaku.engine.captureDanmaku(a, c, 4);
      this.showDanmaku(o);
    }), this.container.addEventListener("contextmenu", (l) => {
      l.preventDefault();
      const n = this.container.getBoundingClientRect(), a = l.clientX - n.left, c = l.clientY - n.top;
      this.show(a, c);
      const o = this.player.danmaku.engine.captureDanmaku(a, c, 4);
      this.showDanmaku(o);
  ...
  show(t, e) {
    ...
    const i = this.player.template.$videoArea.getBoundingClientRect();
    t + this.el.offsetWidth >= i.width ? (this.el.style.right = i.width - t + "px", this.el.style.left = "initial") : (this.el.style.left = t + "px", this.el.style.right = "initial"), e + this.el.offsetHeight >= i.height ? (this.el.style.bottom = i.height - e + "px", this.el.style.top = "initial") : (this.el.style.top = e + "px", this.el.style.bottom = "initial"), this.isShow = !0;
  }
  showDanmaku(t) {
    const e = this.player.danmaku.api, i = this.player.danmaku.operate;
    t.length ? this.$danmaku.style.display = "" : this.$danmaku.style.display = "none", y(
      Ue(t, (l) => {
        const n = l.user == this.player.userId;
        return [
          [
            "举报",
            (a) => {
            ...
            !n && (e == null ? void 0 : e.report)
          ],
          [
            "屏蔽",
            (a) => {
              i.blockUser(a.user, !0);
            },
            !n && (e == null ? void 0 : e.blockUser)
          ],
          [
            "撤回",
            (a) => {
...
const Ke = () => u`
  <div class="${r}-modal-panel ${r}-about">
    <div class="${r}-about-logo"></div>
    <div class="${r}-about-version">
      version ${R.version}-${R.gitHash}
    </div>
    <div>github: <a href="${Tt}" target="_blank">github</a></div>
    <div>开发者</div>
    <ul class="${r}-about-developers">
      ${qt.map(
  ({ name: s, id: t, link: e }) => u`
          <li>
...
class Ye {
  constructor() {
    ...
    y(Ke(), t), this.el = t.querySelector(`.${r}-modal-panel`);
  }
}
const Qe = (s) => u`
  <div class="${r}-modal-panel ${r}-hotkey">
    <div class="${r}-hotkey-list">
      ${s.map(
  ({ key: t, description: e }) => u`
          <div class="${r}-hotkey-list-item">
            <div class="${r}-hotkey-list-key">${t}</div>
            <div class="${r}-hotkey-list-description">${e}</div>
          </div>
        `
)}
    </div>
...
class Ze {
  constructor() {
    ...
    y(Qe(t), e), this.el = e.querySelector(`.${r}-modal-panel`);
  }
}
const Ge = () => u`
...
class Je {
  ...
  init(t) {
    this.$mask.addEventListener("click", () => {
      ...
      this.hide();
    }), this.add("about", new Ye()), this.add("hotkey", new Ze());
  }
  show(t) {
    if (t != this.current) {
      const e = this.list[t];
...
class Ce {
  ...
  setTheme(t) {
    Object.assign(this, t), this.themeElement.forEach((e) => {
      let i;
      for (i in t)
        e.style.setProperty(Q[i], t[i]);
    });
  }
  /** 设置某个主题属性 */
  setThemeProperty(t, e) {
    this[t] = e, this.themeElement.forEach((i) => {
      i.style.setProperty(Q[t], e);
    });
  }
  /** 为元素绑定主题变量 */
  addThemeElement(t) {
    ...
    for (e in Q) {
      const i = this[e];
      i && t.style.setProperty(Q[e], i);
    }
  }
}
const ti = () => u`
  <div class="${r}-state-loading"></div>
  <div class="${r}-state-volume"></div>
  <div class="${r}-state-paused"></div>
`;
class ei {
  constructor(t, e) {
    this.focused = !1, this.active = !1, this.mousemove = !1, this.player = t, this.container = t.template.$stateWrap, this.$stateLoading = this.container.querySelector(`.${r}-state-loading`), this.$stateVolume = this.container.querySelector(`.${r}-state-volume`), this.$statePaused = this.container.querySelector(`.${r}-state-paused`), y(ti(), this.container), this.init();
  }
  init() {
...
class ii {
  ...
  /** 设置弹幕池 */
  setPool(t) {
    this.danmakuPool = [...t], this.danmakuPool.sort((i, l) => i.time - l.time);
    const e = this.danmakuPool.findIndex((i) => this.time <= i.time);
  ...
  add(t) {
    t.forEach((e) => {
      const i = this.danmakuPool.findIndex((l) => e.time <= l.time);
      this.danmakuPool.splice(i === -1 ? this.danmakuPool.length : i, 0, e), e.time < this.time && (this.currentIndex += 1);
    });
  }
  /** 弹幕池移除符合id的弹幕 */
  remove(t) {
    ...
    t.forEach((i) => {
      const l = this.danmakuPool.findIndex((a) => a.id == i);
      if (l === -1)
        return;
      this.danmakuPool.splice(l, 1), l < this.currentIndex && (this.currentIndex -= 1);
      const n = e.find((a) => a.dataset.id === i.toString());
      n && (n.innerHTML = "");
    });
  }
  /** 弹幕清屏 */
  ...
  setContentFilter(t, e) {
    ...
    if (e) {
      ...
      const l = this.container.querySelectorAll(
        `.${this.classPrefix}-danmaku-item`
      );
      typeof t == "string" ? l.forEach((n) => {
        n.innerText.includes(t) && (n.innerHTML = "");
      }) : l.forEach((n) => {
        t.test(n.innerText) && (n.innerHTML = "");
      });
    } else
  ...
  draw(t) {
    var f, A, L;
    const e = this.baseTrackHeight * this.fontScale, i = this.container.offsetWidth, l = this.container.offsetHeight * this.limitArea, n = Math.floor(l / e);
    this.trackHeights.roll.length !== n && (this.trackHeights.roll = V(n, e)), this.trackHeights.reverse.length !== n && (this.trackHeights.reverse = V(n, e)), this.trackHeights.top.length !== n && (this.trackHeights.top = V(n, e)), this.trackHeights.bottom.length !== n && (this.trackHeights.bottom = V(n, e));
    const a = (m) => {
        ...
        for (let $ = 0; this.overlap || $ < n; $++) {
          ...
          if (this.danmakuTracks[v][$] = x, w && w.length) {
            if (v === "roll") {
              ...
              for (const k of w) {
                const S = a(k) - 10;
                if (this.trackHeights[v][$] = parseInt(k.style.fontSize) + this.trackPadding, S <= i - F * o(k.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const F = i / o(h);
            ...
            return this.danmakuTracks[v][$].push(m), m.addEventListener("animationend", () => {
              var k, S;
              const F = (k = this.danmakuTracks[v][$]) == null ? void 0 : k.indexOf(m);
              F && ((S = this.danmakuTracks[v][$]) == null || S.splice(F, 1));
            }), $;
          } else
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      h.classList.add(`${this.classPrefix}-danmaku-item`), h.classList.add(`${this.classPrefix}-danmaku-${G[v.mode]}`), h.innerHTML = `<span>${v.content.replace(/(\\n)/g, `
`)}</span>`, typeof v.color == "number" ? h.style.color = It(v.color) : h.style.color = v.color, h.style.opacity = this.opacity.toString(), h.style.fontSize = +v.size * this.fontScale + "px", h.addEventListener("animationend", () => {
      ...
      switch (x) {
        case "roll":
        case "reverse":
          if (F = p(h, x, $), w = F % n, w >= 0) {
            const k = this.trackHeights[x].slice(0, n).reduce((P, q) => P + q, 0), S = this.trackHeights[x].slice(0, w).reduce((P, q) => P + q, 0) % k;
            if (S + parseInt(h.style.fontSize) + this.trackPadding > l) {
              (f = this.danmakuTracks[x][m]) == null || f.pop();
              return;
            }
            const T = o($), b = $ + i + this.startDistance * 2;
            h.dataset.track = F.toString(), h.style.width = $ + 1 + "px", h.style.top = S + "px", h.style.fontFamily = this.fontFamily, h.style.fontWeight = this.fontWeight, h.style.setProperty("--duration", `${b / T}s`), h.style.setProperty("--offset", `${i + this.startDistance}px`), h.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (w = p(h, x, 0) % n, w >= 0) {
            ...
            if (T + parseInt(h.style.fontSize) + this.trackPadding > l) {
              (A = this.danmakuTracks[x][m]) == null || A.pop();
              return;
            }
  ...
  /** 根据某一坐标捕获弹幕DOM */
  captureDanmakuDOM(t, e, i, l = !1) {
    const n = [], a = this.container.querySelectorAll(`.${this.classPrefix}-danmaku-item`);
    for (const c of a)
      if (c.innerHTML) {
        const o = c.getBoundingClientRect(), d = this.container.getBoundingClientRect(), p = o.left - d.left, g = o.right - d.left, f = o.top - d.top, A = o.bottom - d.top;
        if (t >= p - i && t <= g + i && e >= f - i && e <= A + i && (n.push(c), l))
          return n;
      }
    return n;
  }
  /** 根据某一坐标捕获弹幕 */
  captureDanmaku(t, e, i, l = !1) {
    const n = this.captureDanmakuDOM(t, e, i, l), a = [];
    for (const c of n) {
...
class ri {
  constructor({ defaultParser: t }) {
    this.defaultParser = t || "bilibili-xml", this.list = {
      ...
      "bilibili-xml": (e) => ((l) => {
        const n = [], c = new DOMParser().parseFromString(l, "text/xml").childNodes, o = (d) => {
          var p;
          for (let g = 0; g < d.length; g++) {
            const f = d[g];
            if ((p = f == null ? void 0 : f.attributes) != null && p.length && g > 0) {
              const A = f.attributes[0].nodeValue.split(","), L = f.innerHTML;
              n.push([L, A]);
            } else
              f.childNodes.length > 0 && o(f.childNodes);
          }
        };
        return o(c), n.map(([d, p]) => ({
          time: +p[0],
          mode: +p[1],
          color: +p[3],
          user: p[6],
...
class li {
  ...
  async send(t) {
    var i, l, n;
    let e = await ((n = (l = (i = this.danmaku) == null ? void 0 : i.api) == null ? void 0 : l.send) == null ? void 0 : n.call(l, {
  ...
  async report(t) {
    var i, l, n;
    let e = await ((n = (l = (i = this.danmaku) == null ? void 0 : i.api) == null ? void 0 : l.report) == null ? void 0 : n.call(l, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
  ...
  async delete(t) {
    var i, l, n;
    let e = await ((n = (l = (i = this.danmaku) == null ? void 0 : i.api) == null ? void 0 : l.delete) == null ? void 0 : n.call(l, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
  ...
  async recall(t) {
    var i, l, n;
    let e = await ((n = (l = (i = this.danmaku) == null ? void 0 : i.api) == null ? void 0 : l.recall) == null ? void 0 : n.call(l, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
    }), e.success && this.danmaku.remove([t.id]), e;
  ...
  async blockUser(t, e) {
    var l, n, a;
    let i = await ((a = (n = (l = this.danmaku) == null ? void 0 : l.api) == null ? void 0 : n.blockUser) == null ? void 0 : a.call(n, { api: this.danmaku.api.url, user: t, flag: e }));
    return i ?? (i = {
      success: !1,
      message: "操作失败"
    }), i.success && (this.danmaku.engine.setUserFilter(t, e), this.player.events.trigger("danmaku:block_user", t, e)), i;
  }
  /**
   * 屏蔽关键词
   * @param content 关键词内容
  ...
  async blockContent(t, e) {
    var l, n, a;
    let i = await ((a = (n = (l = this.danmaku) == null ? void 0 : l.api) == null ? void 0 : n.blockContent) == null ? void 0 : a.call(n, {
      api: this.danmaku.api.url,
      content: t,
      flag: e
    }));
    return i ?? (i = {
      success: !1,
      message: "操作失败"
    }), i.success && (this.danmaku.engine.setContentFilter(t, e), this.player.events.trigger("danmaku:block_content", t, e)), i;
  }
}
const ni = u` <div class="${r}-row-danmaku-container"></div> `;
class ai {
  constructor(t, e) {
    var i;
    this.lastDanmakuId = 0, this.list = [], this.player = t, this.parser = new ri({ defaultParser: "mfuns" }), this.operate = new li(this), this.el = this.player.template.$danmakuWrap, this.api = (i = e.danmaku) == null ? void 0 : i.api, this.allowNewDanmaku = !1, y(ni, this.el), this.$rowDanmakuContainer = this.el.querySelector(`.${r}-row-danmaku-container`), this.engine = new ii(this.$rowDanmakuContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
    ...
    }), this.player.on("part", (l) => {
      const { danmakuId: n, danmakuAddition: a } = this.player.video.list[l - 1];
      console.log(a), this.reload(n, a);
    });
  }
  /** 加载附加弹幕 */
  loadAddition({ url: t, type: e, data: i }) {
    fetch(t).then((l) => /-xml$/.test(e) ? l.text() : l.json()).then((l) => {
      const n = i ? i(l) : l, a = this.parser.parse({ data: n, type: e });
      a && this.add(a), this.player.events.trigger("danmaku:load_addition_end", t, a || []);
    }).catch((l) => {
      this.player.events.trigger("danmaku:load_addition_fail", t, l), console.error(l);
    });
  }
  /** 加载弹幕 */
  load(t) {
    const e = this.api;
    e == null || e.get({ api: e.url, id: t }).then((i) => {
      const l = this.parser.parse({ data: i, type: e.type });
      l && (this.add(l), this.lastDanmakuId = l[l.length - 1].id), this.player.events.trigger("danmaku:load_end", l || []);
    }).catch((i) => {
      this.player.events.trigger("danmaku:load_fail", i);
    });
  }
  /** 加载实时新增弹幕 */
  loadNew(t) {
    ...
    const i = this.api;
    i == null || i.get({ api: i.url, id: t, offset: this.lastDanmakuId }).then((l) => {
      const n = this.parser.parse({ data: l, type: i.type });
      n && (this.add(n), this.lastDanmakuId = n[n.length - 1].id), this.player.events.trigger("danmaku:load_new_end", e, n || []);
    }).catch((l) => {
      this.player.events.trigger("danmaku:load_new_fail", e, l);
    });
  }
  /** 重载弹幕 */
  async reload(t, e) {
    this.player.events.trigger("danmaku:load_start"), this.engine.reset(), t && this.load(t), e == null || e.forEach((i) => {
      this.loadAddition(i);
    });
  }
  /**
  ...
  add(t) {
    const e = [], i = {};
    t.forEach((l) => {
      l.mode < 7 ? e.push(l) : i[l.mode] ? i[l.mode].push(l) : i[l.mode] = [l];
    }), e.length && this.engine.add(e);
    for (const l in i)
      this.player.events.trigger("danmaku:advanced", parseInt(l), i[l]);
  }
  /**
   * 根据id从弹幕池中移除弹幕
   * @param ids 要移除的弹幕id
