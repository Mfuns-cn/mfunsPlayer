...
const Ee = (i, t) => {
  ...
  return s;
}, _t = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), At = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, De = () => {
  let i = 100;
  return function(t) {
  ...
  throttle: Ee,
  timeToSecond: ot
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Me = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", Ne = [
...
class Ie {
  constructor(t, e) {
    ...
    ), this.loader = new Le(this), this.setRatio(e.aspectRatio || null), this.attachEvent(this.$video), this.initKeepRatio(), this.player.on("play", () => {
 ...
 */
var at;
const tt = window, U = tt.trustedTypes, $t = U ? U.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ht = "$lit$", N = `lit$${(Math.random() + "").slice(9)}$`, Ft = "?" + N, Ve = `<${Ft}>`, O = document, Y = () => O.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Pt = Array.isArray, Oe = (i) => Pt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, X = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vt = /-->/g, gt = />/g, I = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ft = /'/g, yt = /"/g, Dt = /^(?:script|style|textarea|title)$/i, ze = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), u = ze(1), Z = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), bt = /* @__PURE__ */ new WeakMap(), R = O.createTreeWalker(O, 129, null, !1);
function Ht(i, t) {
...
const We = (i, t) => {
  ...
  for (let o = 0; o < e; o++) {
    ...
    l += r === X ? h + Ve : f >= 0 ? (s.push(c), h.slice(0, f) + ht + h.slice(f) + N + E) : h + N + (f === -2 ? (s.push(void 0), o) : E);
  }
...
class G {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const o = t.length - 1, h = this.parts, [c, p] = We(t, e);
      ...
      if (n.nodeType === 1) {
          ...
          for (const y of n.getAttributeNames())
            if (y.endsWith(ht) || y.startsWith(N)) {
              ...
              if (f.push(y), E !== void 0) {
                ...
                h.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? je : m[1] === "?" ? Ke : m[1] === "@" ? Ye : et });
              } else
        ...
        if (Dt.test(n.tagName)) {
          ...
          if (y > 0) {
            ...
            for (let E = 0; E < y; E++)
              n.append(f[E], Y()), R.nextNode(), h.push({ type: 2, index: ++l });
            n.append(f[y], Y());
          }
        }
...
class Ue {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (o === c.index) {
        let p;
        c.type === 2 ? p = new J(r, r.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(r, c.name, c.strings, this, t) : c.type === 6 && (p = new Qe(r, this, t)), this._$AV.push(p), c = n[++h];
      }
...
class J {
  ...
  _$AI(t, e = this) {
    t = j(this, t, e), Q(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== Z && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Oe(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      ...
      const r = new Ue(l, this), o = r.u(this.options);
...
const Xe = U ? U.emptyScript : "";
class Ke extends et {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== F ? this.element.setAttribute(this.name, Xe) : this.element.removeAttribute(this.name);
  }
}
class Ye extends et {
  constructor(t, e, s, n, l) {
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = o, this.onDragStart = h, this.onDragEnd = c, this.onDrag = p, $(Ze({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (f) => {
      ...
      const k = (S) => {
        ...
        var b, T;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (T = this.onDragEnd) == null || T.call(this, x);
      };
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = r, this.onDragStart = o, this.onDragEnd = h, this.onDrag = c, $(Ge(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (p) => {
      ...
      const x = (w) => {
        ...
        let b = L - (P - v - m);
        b = b >= L ? L : b <= 0 ? 0 : b;
        const T = this.step ? Math.round(b / L * (this.max - this.min) / this.step) * this.step + this.min : b / L * (this.max - this.min) + this.min;
...
class W {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    $(Je({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Mt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    $(Ce({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
const ts = ({ label: i }) => u` <div class="mpui-switch">${i}</div> `;
class es {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, $(ts({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-switch"), this.$el.addEventListener("click", () => {
...
class ut {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, $(ss({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-checkbox"), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class M {
  constructor(t) {
    this.event = new xe(), this.hook = new Re(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = D("div", { class: `${a} mpui` }), this.$main = this.$el.appendChild(D("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(D("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      D("div", { class: `${a}-content` })
    ), this.pluginManager = new Se(this), this.video = new Ie(this, t), this.state = new Be(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.emit("mounted"), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
...
class os {
  ...
  init(t) {
    ...
    this.pickerFontsize = new W({
      ...
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || hs).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || cs).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
      ...
      value: "#FFFFFF",
      list: (((s = t.danmakuBar) == null ? void 0 : s.colorList) || ds).map((n) => ({ value: n })),
      onPick: (n) => {
...
class It extends _ {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.plugin.controller, this.danmaku = this.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      ...
      this.send();
    }, this.setPlaceHolder(((s = e.danmakuBar) == null ? void 0 : s.placeholder) || ps);
  }
  moveToWrap() {
...
xs.pluginName = "buttonWidescreen";
const Ls = u`
...
class Ts {
  ...
  draw(t) {
    ...
    const r = (m) => {
      ...
      t:
        for (let g = 0; this.overlap || g < l; g++) {
          ...
          if (this.danmakuTracks[v][g] = x, k && k.length) {
            if (v === "roll") {
              const A = s / h(d);
              k.length !== x.length && (k = x);
              for (const w of k) {
                const S = r(w) - 10;
                if (this.trackHeights[v][g] = parseInt(w.style.fontSize) + this.trackPadding, S <= s - A * h(w.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const A = s / h(d);
            ...
            return this.danmakuTracks[v][g].push(m), m.addEventListener("animationend", () => {
              ...
              A && ((S = this.danmakuTracks[v][g]) == null || S.splice(A, 1));
            }), g;
          } else
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      d.classList.add(`${this.classPrefix}-danmaku-item`), d.classList.add(`${this.classPrefix}-danmaku-${C[v.mode]}`), d.innerHTML = `${v.content.replace(/(\\n)/g, `
      ...
      switch (x) {
        ...
        case "reverse":
          if (A = p(d, x, g), k = A % l, k >= 0) {
            const w = this.trackHeights[x].slice(0, l).reduce((T, q) => T + q, 0), S = this.trackHeights[x].slice(0, k).reduce((T, q) => T + q, 0) % w;
        ...
        case "top":
          if (k = p(d, x, 0) % l, k >= 0) {
            ...
            for (const b of S)
              w.push(...b);
            const P = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, T) => b + T, 0);
...
class Qt extends _ {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.format = ((s = e.danmaku) == null ? void 0 : s.format) || "mfuns", this.parser = new As({ defaultParser: this.format }), this.operate = new Fs(this.player), this.api = e.danmakuApi || {}, this.allowNewDanmaku = !1, this.$el = D("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      D("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new Ts(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
...
const qs = () => u`
  <div class="${a}-about">
    ...
    <div>github：<a href="${Me}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者：</div>
...
class te extends _ {
  constructor(t) {
    ...
    this.container = D("div", { class: `${a}-contextmenu-wrap` }), $(Ms(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
...
const Ws = [le, oe, he], Us = [ie, re, ee, ae, se, te], js = [
  ne,
  Bt,
  Rt,
  Vt,
...
ve.pluginName = "buttonDanmakuList";
const Zs = u`
...
class ye extends _ {
  constructor(t, e) {
    super(t), this.$el = D("div", { class: `${a}-videostatus` }), $(Gs, this.$el), this.$paused = this.$el.querySelector(`.${a}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${a}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
ye.pluginName = "videoStatus";
const Js = u`
...
class be extends _ {
  constructor(t, e) {
    var s, n;
    super(t), this.$el = D("div", { class: `${a}-loadingmask` }), $(Js, this.$el), this.$info = this.$el.querySelector(`.${a}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${a}-loadingmask-tips`), this.getTips = (s = e.loadingMask) == null ? void 0 : s.getTips, this.delay = ((n = e.loadingMask) == null ? void 0 : n.delay) || 0, this.player.$main.appendChild(this.$el);
  }
  created() {
