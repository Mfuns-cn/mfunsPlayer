 ...
 */
var tt;
const J = window, W = J.trustedTypes, nt = W ? W.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, it = "$lit$", q = `lit$${(Math.random() + "").slice(9)}$`, $t = "?" + q, kt = `<${$t}>`, B = document, U = () => B.createComment(""), j = (s) => s === null || typeof s != "object" && typeof s != "function", gt = Array.isArray, St = (s) => gt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", et = `[ 	
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, lt = /-->/g, at = />/g, _ = RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ot = /'/g, ct = /"/g, ft = /^(?:script|style|textarea|title)$/i, xt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), d = xt(1), X = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), ht = /* @__PURE__ */ new WeakMap(), M = B.createTreeWalker(B, 129, null, !1);
function yt(s, t) {
...
const Lt = (s, t) => {
  ...
  for (let c = 0; c < e; c++) {
    ...
    for (; y < o.length && (a.lastIndex = y, p = a.exec(o), p !== null); )
      y = a.lastIndex, a === N ? p[1] === "!--" ? a = lt : p[1] !== void 0 ? a = at : p[2] !== void 0 ? (ft.test(p[2]) && (n = RegExp("</" + p[2], "g")), a = _) : p[3] !== void 0 && (a = _) : a === _ ? p[0] === ">" ? (a = n ?? N, g = -1) : p[1] === void 0 ? g = -2 : (g = a.lastIndex - p[2].length, u = p[1], a = p[3] === void 0 ? _ : p[3] === '"' ? ct : ot) : a === ct || a === ot ? a = _ : a === lt || a === at ? a = N : (a = _, n = void 0);
    const E = a === _ && s[c + 1].startsWith("/>") ? " " : "";
    l += a === N ? o + kt : g >= 0 ? (r.push(u), o.slice(0, g) + it + o.slice(g) + q + E) : o + q + (g === -2 ? (r.push(void 0), c) : E);
  }
...
class K {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    if (this.el = K.createElement(u, r), M.currentNode = this.el.content, e === 2) {
      const g = this.el.content, y = g.firstChild;
      y.remove(), g.append(...y.childNodes);
    }
    for (; (n = M.nextNode()) !== null && o.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const g = [];
        ...
        if (ft.test(n.tagName)) {
          const g = n.textContent.split(q), y = g.length - 1;
          if (y > 0) {
            n.textContent = W ? W.emptyScript : "";
            for (let E = 0; E < y; E++)
              n.append(g[E], U()), M.nextNode(), o.push({ type: 2, index: ++l });
            n.append(g[y], U());
          }
        }
        ...
        if (n.data === $t)
          ...
          let g = -1;
          for (; (g = n.data.indexOf(q, g + 1)) !== -1; )
            o.push({ type: 7, index: l }), g += q.length - 1;
        }
      l++;
    }
  }
...
class Et {
  ...
  u(t) {
    var e;
    const { el: { content: r }, parts: n } = this._$AD, l = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : B).importNode(r, !0);
    M.currentNode = l;
    let a = M.nextNode(), c = 0, o = 0, u = n[0];
    for (; u !== void 0; ) {
      if (c === u.index) {
        let p;
      ...
      c !== (u == null ? void 0 : u.index) && (a = M.nextNode(), c++);
    }
    return M.currentNode = B, l;
  }
  v(t) {
    let e = 0;
...
class Y {
  ...
  _(t) {
    this._$AH !== F && j(this._$AH) ? this._$AA.nextSibling.data = t : this.$(B.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
...
dt == null || dt(K, Y), ((tt = J.litHtmlVersions) !== null && tt !== void 0 ? tt : J.litHtmlVersions = []).push("2.8.0");
const f = (s, t, e) => {
  var r, n;
...
], V = (s, t) => Array.from({ length: s }, () => t), Ht = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, Mt = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Bt = document.pictureInPictureEnabled, ut = (s) => {
...
}, It = (s) => (s[0] === "#" && (s = s.substr(1)), s.length === 3 && (s = `${s[0]}${s[0]}${s[1]}${s[1]}${s[2]}${s[2]}`), parseInt(s, 16) + 0 & 16777215), Wt = (s) => `#${`00000${s.toString(16)}`.slice(-6)}`, st = {
...
const ie = () => d`
  <div class="${i}-modal-panel ${i}-about">
    ...
    <div class="${i}-about-version">version ${I.version}-${I.gitHash}</div>
...
class re {
  constructor() {
    ...
    f(ie(), t), this.el = t.querySelector(`.${i}-modal-panel`);
  }
}
const ne = (s) => d`
...
class le {
  constructor() {
    ...
    f(ne(t), e), this.el = e.querySelector(`.${i}-modal-panel`);
  }
}
const ae = () => d`
...
class de {
  constructor(t, e) {
    this.focused = !1, this.active = !1, this.mousemove = !1, this.player = t, this.container = t.template.$stateWrap, this.$stateLoading = this.container.querySelector(`.${i}-state-loading`), this.$stateVolume = this.container.querySelector(`.${i}-state-volume`), this.$statePaused = this.container.querySelector(`.${i}-state-paused`), f(he(), this.container), this.init();
  }
  init() {
...
`)}`, typeof v.color == "number" ? h.style.color = Wt(v.color) : h.style.color = v.color, h.style.opacity = this.opacity.toString(), h.style.fontSize = +v.size * this.fontScale + "px", h.addEventListener("animationend", () => {
  ...
  captureDanmakuDOM(t, e, r, n = !1) {
    ...
    for (const c of a)
      if (c.innerHTML) {
        const o = c.getBoundingClientRect(), u = this.container.getBoundingClientRect(), p = o.left - u.left, g = o.right - u.left, y = o.top - u.top, E = o.bottom - u.top;
        if (t >= p - r && t <= g + r && e >= y - r && e <= E + r && (l.push(c), n))
          return l;
      }
    return l;
  }
...
function pe() {
  const s = [], t = mt.length;
  for (let e = 0; e < 8; e++)
    s.push(mt[Math.floor(Math.random() * t)]);
  return pt++, s.join("") + `${pt}`;
}
class me {
...
class xe {
  ...
  showDanmaku(t) {
    ...
    t.length ? this.$danmaku.style.display = "" : this.$danmaku.style.display = "none", f(
      ke(t, (n) => {
...
`, Fe = (s, t, e) => {
  ...
  return f(r, n), n.firstElementChild;
};
class Te {
  constructor(t) {
...
const De = "danmakuList", qe = () => {
  let s;
  return {
    name: De,
    create: (t) => (s = new Te(t), s),
    init: () => {
      s.init();
    }
  };
...
class He {
  constructor(t, e, r) {
    ...
    f(_e(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = r, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(a) ? a : Number(a), this.onChange = c, this.onDragStart = o, this.onDragEnd = u, this.onDrag = p, f(Me({ divider: this.divider }), t), this.el = this.container.querySelector(`.${i}-slider`), this.$track = this.el.querySelector(`.${i}-slider-track`), this.$bar = this.$track.querySelector(`.${i}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${i}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${i}-slider-thumb`), this.el.addEventListener("mousedown", (g) => {
      ...
      const w = (S) => {
        ...
        this.value != D && this.drag(D), (rt = window.getSelection()) == null || rt.removeAllRanges();
      }, A = (S) => {
        var b, P;
...
class O {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    f(We({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${i}-picker`), this.$items = this.el.querySelectorAll(`.${i}-picker-item`), this.$items.forEach((e) => {
...
class Ne {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    f(Re({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${i}-picker`), this.$items = this.el.querySelectorAll(`.${i}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
class vt {
  constructor({ container: t, value: e = !1, onChange: r, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = r, this.onToggle = n, this.label = l, f(Ve({ label: this.label }), this.container), this.el = this.container.querySelector(`.${i}-checkbox`), this.el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class je {
  ...
  init(t) {
    ...
    this.pickerFontsize = new O({
      ...
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || Xe).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || Ke).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
      ...
      value: "#FFFFFF",
      list: (((r = t.danmakuBar) == null ? void 0 : r.colorList) || Ye).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = It(n);
      },
      onChange: (n) => {
...
class Ze {
  constructor(t, e) {
    ...
    f(Qe, r), this.el = r.querySelector(`.${i}-danmakubar`), this.$send = this.el.querySelector(`.${i}-danmakubar-send`), this.$input = this.el.querySelector(`.${i}-danmakubar-input`), this.$slot = this.el.querySelector(`.${i}-danmakubar-slot`), this.$inputSlot = this.el.querySelector(`.${i}-danmakubar-input-slot`), this.buttonDanmakuSwitch = new He(this.player, this.$slot), this.buttonDanmakuSettings = new Oe(this.player, this.$slot), this.buttonDanmakuStyle = new je(this, this.$inputSlot, e), this.player.on("fullscreen", () => {
      ...
      this.send();
    }, this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || Ge);
  }
  moveToFootbar() {
...
const Ge = "发条弹幕吧~", Je = "danmakuBar", Ce = () => {
  let s;
  return {
    name: Je,
    create: (t, e) => (s = new Ze(t, e), s)
  };
}, ts = (s) => d`
  <div
...
class es {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(ts(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("pause", () => {
...
class is {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(ss(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
...
class ns {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(rs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("part", (t) => {
...
class as {
  constructor(t, e, r) {
    ...
    const n = new DocumentFragment();
    f(ls(r), n), this.el = n.querySelector(`.${i}-controller-time`), this.$label = n.querySelector(`.${i}-controller-time-label`), this.$current = n.querySelector(`.${i}-controller-time-current`), this.$total = n.querySelector(`.${i}-controller-time-total`), this.$input = n.querySelector(`.${i}-controller-time-input`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("timeupdate", (t) => {
      ...
      t != this.valueBeforeEdited && (this.player.seek(ut(t)), this.player.play()), this.exitInput();
    }), this.$input.addEventListener("keydown", (t) => {
      const e = t || window.event;
      e.keyCode == 13 && (this.player.seek(ut(this.$input.value)), this.player.play(), this.exitInput()), e.keyCode == 27 && this.exitInput();
    });
  }
  /** 退出输入模式 */
  exitInput() {
...
class cs {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(os(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
...
class ds {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(hs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.$texticon = n.querySelector(`.${i}-controller-texticon`), this.init(), e.appendChild(n);
  }
  init() {
...
class ps {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(us(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$slider = n.querySelector(`.${i}-controller-volume-slider`), this.$text = n.querySelector(`.${i}-controller-volume-text`), this.init(), e.appendChild(n);
  }
  init() {
    this.slider = new Ie({
...
class vs {
  ...
  init(t) {
    ...
    }), (e = t.feature) != null && e.solid && (this.checkboxSolid = new vt({
      container: this.$solidCheckbox,
      label: "固定控制栏",
      onToggle: (r) => {
        this.player.mode.solid(r);
      }
    })), this.checkboxShowPrevButton = new vt({
...
class gs {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f($s(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("pip", () => {
...
class ys {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(fs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("webfull", () => {
...
class ws {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    f(bs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("fullscreen", () => {
...
const ks = () => ({
  ...
  name: "buttonPip",
  create: (s) => Bt ? new gs(s, s.controller.$right, 7) : {}
}), Ds = () => ({
  name: "buttonWebfull",
  create: (s, t) => {
    var e;
  ...
  create: (s) => Mt ? new ws(s, s.controller.$right, 10) : {}
}), _s = () => [
  Ss(),
  ks(),
  xs(),
