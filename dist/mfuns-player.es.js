...
const it = /mobile/i.test(window.navigator.userAgent), z = (i, t) => Array.from({ length: i }, () => t), Lt = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, Et = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Tt = document.pictureInPictureEnabled, ot = (i) => {
...
const Te = (i, t) => {
  ...
  dragStart: it ? "touchstart" : "mousedown",
  dragMove: it ? "touchmove" : "mousemove",
  dragEnd: it ? "touchend" : "mouseup"
}, Fe = (i, t) => {
  ...
  return s;
}, _t = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), At = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, He = () => {
  let i = 100;
  return function(t) {
  ...
  (e) => {
    var s;
    return (s = nt[e]) == null ? void 0 : s.call(nt, i);
  }
  ...
  throttle: Te,
  timeToSecond: ot
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Ne = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", Ie = [
...
class Re {
  constructor(t, e) {
    this.ratio = null, this.player = t, this.$video = this.player.$content.appendChild(
      D("video", { class: `${a}-video` })
    ), this.loader = new Ee(this), this.setRatio(e.aspectRatio || null), this.attachEvent(this.$video), this.initKeepRatio(), this.player.on("play", () => {
 ...
 */
var at;
const tt = window, U = tt.trustedTypes, $t = U ? U.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ht = "$lit$", N = `lit$${(Math.random() + "").slice(9)}$`, Ft = "?" + N, Oe = `<${Ft}>`, O = document, Y = () => O.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", Pt = Array.isArray, ze = (i) => Pt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, X = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vt = /-->/g, gt = />/g, I = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ft = /'/g, yt = /"/g, Dt = /^(?:script|style|textarea|title)$/i, We = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), u = We(1), Z = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), bt = /* @__PURE__ */ new WeakMap(), B = O.createTreeWalker(O, 129, null, !1);
function Ht(i, t) {
...
const Ue = (i, t) => {
  ...
  for (let o = 0; o < e; o++) {
    ...
    for (; y < h.length && (r.lastIndex = y, p = r.exec(h), p !== null); )
      y = r.lastIndex, r === X ? p[1] === "!--" ? r = vt : p[1] !== void 0 ? r = gt : p[2] !== void 0 ? (Dt.test(p[2]) && (n = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = n ?? X, f = -1) : p[1] === void 0 ? f = -2 : (f = r.lastIndex - p[2].length, c = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? yt : ft) : r === yt || r === ft ? r = I : r === vt || r === gt ? r = X : (r = I, n = void 0);
    const E = r === I && i[o + 1].startsWith("/>") ? " " : "";
    l += r === X ? h + Oe : f >= 0 ? (s.push(c), h.slice(0, f) + ht + h.slice(f) + N + E) : h + N + (f === -2 ? (s.push(void 0), o) : E);
  }
...
class G {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const o = t.length - 1, h = this.parts, [c, p] = Ue(t, e);
    if (this.el = G.createElement(c, s), B.currentNode = this.el.content, e === 2) {
      const f = this.el.content, y = f.firstChild;
      y.remove(), f.append(...y.childNodes);
    }
    for (; (n = B.nextNode()) !== null && h.length < o; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const f = [];
          for (const y of n.getAttributeNames())
            if (y.endsWith(ht) || y.startsWith(N)) {
              const E = p[r++];
              if (f.push(y), E !== void 0) {
                const L = n.getAttribute(E.toLowerCase() + ht).split(N), m = /([.?@])?(.*)/.exec(E);
                h.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? Xe : m[1] === "?" ? Ye : m[1] === "@" ? Qe : et });
              } else
        ...
        if (Dt.test(n.tagName)) {
          const f = n.textContent.split(N), y = f.length - 1;
          if (y > 0) {
            n.textContent = U ? U.emptyScript : "";
            for (let E = 0; E < y; E++)
              n.append(f[E], Y()), B.nextNode(), h.push({ type: 2, index: ++l });
            n.append(f[y], Y());
          }
        }
        ...
        if (n.data === Ft)
          ...
          let f = -1;
          for (; (f = n.data.indexOf(N, f + 1)) !== -1; )
            h.push({ type: 7, index: l }), f += N.length - 1;
        }
      l++;
    }
  }
...
function j(i, t, e = i, s) {
  ...
  return (h == null ? void 0 : h.constructor) !== c && ((l = h == null ? void 0 : h._$AO) === null || l === void 0 || l.call(h, !1), c === void 0 ? h = void 0 : (h = new c(i), h._$AT(i, e, s)), s !== void 0 ? ((r = (o = e)._$Co) !== null && r !== void 0 ? r : o._$Co = [])[s] = h : e._$Cl = h), h !== void 0 && (t = j(i, h._$AS(i, t.values), h, s)), t;
}
class je {
  constructor(t, e) {
  ...
  u(t) {
    ...
    B.currentNode = l;
    let r = B.nextNode(), o = 0, h = 0, c = n[0];
    for (; c !== void 0; ) {
      if (o === c.index) {
        let p;
        c.type === 2 ? p = new J(r, r.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(r, c.name, c.strings, this, t) : c.type === 6 && (p = new Ze(r, this, t)), this._$AV.push(p), c = n[++h];
      }
      o !== (c == null ? void 0 : c.index) && (r = B.nextNode(), o++);
    }
    return B.currentNode = O, l;
  }
  v(t) {
    let e = 0;
...
class J {
  ...
  _$AI(t, e = this) {
    t = j(this, t, e), Q(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== Z && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : ze(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== F && Q(this._$AH) ? this._$AA.nextSibling.data = t : this.$(O.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, l = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = G.createElement(Ht(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      this._$AH.v(s);
    else {
      const r = new je(l, this), o = r.u(this.options);
  ...
  T(t) {
    ...
    let s, n = 0;
    for (const l of t)
      n === e.length ? e.push(s = new J(this.k(Y()), this.k(Y()), this, this.options)) : s = e[n], s._$AI(l), n++;
...
class et {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let r = !1;
    if (l === void 0)
      t = j(this, t, e, 0), r = !Q(t) || t !== this._$AH && t !== Z, r && (this._$AH = t);
    else {
      const o = t;
      let h, c;
      for (t = l[0], h = 0; h < l.length - 1; h++)
        c = j(this, o[s + h], e, h), c === Z && (c = this._$AH[h]), r || (r = !Q(c) || c !== this._$AH[h]), c === F ? t = F : t !== F && (t += (c ?? "") + l[h + 1]), this._$AH[h] = c;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Ke = U ? U.emptyScript : "";
class Ye extends et {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== F ? this.element.setAttribute(this.name, Ke) : this.element.removeAttribute(this.name);
  }
}
class Qe extends et {
  constructor(t, e, s, n, l) {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = j(this, t, e, 0)) !== null && s !== void 0 ? s : F) === Z)
      return;
...
kt == null || kt(G, J), ((at = tt.litHtmlVersions) !== null && at !== void 0 ? at : tt.litHtmlVersions = []).push("2.8.0");
const v = (i, t, e) => {
  var s, n;
  ...
  if (r === void 0) {
    ...
    l._$litPart$ = r = new J(t.insertBefore(Y(), o), o, void 0, e ?? {});
  }
  return r._$AI(i), r;
}, Ge = ({ divider: i }) => u` <div
    ...
    <div class="mpui-slider-thumb-track" style="height: 0px">
      ...
      ${i ? u`
            <div class="mpui-slider-divider">
              ${z(i, u`<div class="mpui-slider-divider-dot"></div>`)}
            </div>
          ` : ""}
    </div>
  </div>
...
class qt {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = r, this.onDragStart = o, this.onDragEnd = h, this.onDrag = c, v(Je(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (p) => {
      ...
      const x = (w) => {
        var q;
        const S = w, { clientY: P } = S;
        S.preventDefault(), S.stopPropagation();
        let b = L - (P - $ - m);
        b = b >= L ? L : b <= 0 ? 0 : b;
        const _ = this.step ? Math.round(b / L * (this.max - this.min) / this.step) * this.step + this.min : b / L * (this.max - this.min) + this.min;
        this.value != _ && this.drag(_), (q = window.getSelection()) == null || q.removeAllRanges();
      }, k = (w) => {
        var P, b;
        w.stopPropagation(), (P = window.getSelection()) == null || P.removeAllRanges(), document.removeEventListener("mousemove", x), document.removeEventListener("mouseup", k), (b = this.onDragEnd) == null || b.call(this, g);
      };
...
class W {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    v(Ce({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Mt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    v(ts({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
const es = ({ label: i }) => u` <div class="mpui-switch">${i}</div> `;
class ss {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, v(es({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-switch"), this.$el.addEventListener("click", () => {
...
class ut {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, v(is({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-checkbox"), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class M {
  constructor(t) {
    this.event = new Le(), this.hook = new Ve(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = D("div", { class: `${a} mpui` }), this.$main = this.$el.appendChild(D("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(D("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      D("div", { class: `${a}-content` })
    ), this.pluginManager = new xe(this), this.video = new Re(this, t), this.state = new Be(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.emit("mounted"), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
...
`, rs = (i, t, {
  ...
  const h = u`
    ...
    >
      ...
      <div class="list-cell col-date">
        ${i.date ? dt(new Date(i.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
  ...
  return v(h, c), c.firstElementChild;
};
class Nt extends st {
  constructor(t, e) {
  ...
  created() {
    ...
    this.list = new as({
      ...
      createItem: (l, r) => rs(l, r, {
        ...
        title: (o) => `${o.content}
${l.date ? dt(new Date(l.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${V(l.time, !1)}`
      }),
      overflow: 5
    });
    const s = ct(() => {
...
var R = /* @__PURE__ */ ((i) => (i[i.Backspace = 8] = "Backspace", i[i.Tab = 9] = "Tab", i[i.Enter = 13] = "Enter", i[i.Shift = 16] = "Shift", i[i.Ctrl = 17] = "Ctrl", i[i.Alt = 18] = "Alt", i[i.PauseBreak = 19] = "PauseBreak", i[i.CapsLock = 20] = "CapsLock", i[i.Escape = 27] = "Escape", i[i.Space = 32] = "Space", i[i.PageUp = 33] = "PageUp", i[i.PageDown = 34] = "PageDown", i[i.End = 35] = "End", i[i.Home = 36] = "Home", i[i.LeftArrow = 37] = "LeftArrow", i[i.UpArrow = 38] = "UpArrow", i[i.RightArrow = 39] = "RightArrow", i[i.DownArrow = 40] = "DownArrow", i[i.Insert = 45] = "Insert", i[i.Delete = 46] = "Delete", i[i.Zero = 48] = "Zero", i[
  ...
  i.GraveAccent = 192
  /* Tilde */
] = "GraveAccent", i[i.OpenBracket = 219] = "OpenBracket", i[i.ClosedBracket = 221] = "ClosedBracket", i[i.Quote = 222] = "Quote", i))(R || {});
const os = () => u`
...
class hs {
  ...
  init(t) {
    var e, s;
    this.pickerFontsize = new W({
      container: this.$fontsizePicker,
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || cs).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || ds).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
        this.danmakuBar.danmakuMode = Number(n) || 1;
      }
    }), this.pickerColor = new W({
      container: this.$colorPicker,
      value: "#FFFFFF",
      list: (((s = t.danmakuBar) == null ? void 0 : s.colorList) || us).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = _t(n);
      },
      onChange: (n) => {
...
class It extends T {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.plugin.controller, this.danmaku = this.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      D("div", { class: `${a}-danmakubar-wrap mpui-background` })
    ), this.loginRequired = ((s = e.danmakuBar) == null ? void 0 : s.loginRequired) || !1, v(ps, this.$wrap), this.$el = this.$wrap.querySelector(`.${a}-danmakubar`), this.$send = this.$el.querySelector(`.${a}-danmakubar-send`), this.$input = this.$el.querySelector(`.${a}-danmakubar-input`), this.$slot = this.$el.querySelector(`.${a}-danmakubar-slot`), this.$inputSlot = this.$el.querySelector(`.${a}-danmakubar-input-slot`), this.$logina = this.$el.querySelector(`.${a}-danmakubar-status-login a`), this.$logina.onclick = () => this.plugin.user.login(), this.buttonDanmakuStyle = new hs(this, this.$inputSlot, e), this.loginRequired && !e.userId && this.setLoginLimit(!0), this.player.on("video_change", () => {
      this.setLoading(!0);
      ...
      l.keyCode == R.Enter && this.send();
    }), this.$send.onclick = () => {
      this.send();
    }, this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || ms);
  }
  moveToWrap() {
...
Ls.pluginName = "buttonWidescreen";
const Es = u`
...
Yt.pluginName = "buttonFullscreen";
...
class _s {
  ...
  draw(t) {
    ...
    this.trackHeights.roll.length !== l && (this.trackHeights.roll = z(l, e)), this.trackHeights.reverse.length !== l && (this.trackHeights.reverse = z(l, e)), this.trackHeights.top.length !== l && (this.trackHeights.top = z(l, e)), this.trackHeights.bottom.length !== l && (this.trackHeights.bottom = z(l, e));
    const r = (m) => {
      ...
      t:
        for (let g = 0; this.overlap || g < l; g++) {
          ...
          if (this.danmakuTracks[$][g] = x, k && k.length) {
            if ($ === "roll") {
              const A = s / h(d);
              k.length !== x.length && (k = x);
              for (const w of k) {
                const S = r(w) - 10;
                if (this.trackHeights[$][g] = parseInt(w.style.fontSize) + this.trackPadding, S <= s - A * h(w.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if ($ === "reverse") {
              const A = s / h(d);
            ...
            return this.danmakuTracks[$][g].push(m), m.addEventListener("animationend", () => {
              var w, S;
              const A = (w = this.danmakuTracks[$][g]) == null ? void 0 : w.indexOf(m);
              A && ((S = this.danmakuTracks[$][g]) == null || S.splice(A, 1));
            }), g;
          } else
...
`)}`, typeof $.color == "number" ? d.style.color = At($.color) : d.style.color = $.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +$.size * this.fontScale + "px", $.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (x) {
        case "roll":
        case "reverse":
          if (A = p(d, x, g), k = A % l, k >= 0) {
            const w = this.trackHeights[x].slice(0, l).reduce((_, q) => _ + q, 0), S = this.trackHeights[x].slice(0, k).reduce((_, q) => _ + q, 0) % w;
            if (S + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (y = this.danmakuTracks[x][m]) == null || y.pop();
              return;
            }
            const P = h(g), b = g + s + this.startDistance * 2;
            d.dataset.track = A.toString(), d.style.width = g + 1 + "px", d.style.top = S + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${b / P}s`), d.style.setProperty("--offset", `${s + this.startDistance}px`), d.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = p(d, x, 0) % l, k >= 0) {
            const w = [], S = this.danmakuTracks.top;
            for (const b of S)
              w.push(...b);
            const P = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, _) => b + _, 0);
            if (P + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (E = this.danmakuTracks[x][m]) == null || E.pop();
              return;
            }
          ...
          break;
        case "bottom":
          if (x = "bottom", k = p(d, x, 0) % l, k >= 0) {
            const w = [], S = this.danmakuTracks.bottom;
            for (const b of S)
              w.push(...b);
            const P = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, _) => b + _, 0);
            if (P + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (L = this.danmakuTracks[x][m]) == null || L.pop();
              return;
            }
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const o of r)
      if (o.innerHTML) {
        const h = o.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = h.left - c.left, f = h.right - c.left, y = h.top - c.top, E = h.bottom - c.top;
        if (t >= p - s && t <= f + s && e >= y - s && e <= E + s && (l.push(o), n))
          return l;
      }
    return l;
  }
...
function As() {
  const i = [], t = St.length;
  for (let e = 0; e < 8; e++)
    i.push(St[Math.floor(Math.random() * t)]);
  return wt++, i.join("") + `${wt}`;
}
class Fs {
      ...
      "bilibili-xml": (e) => ((n) => {
        const l = [], o = new DOMParser().parseFromString(n, "text/xml").childNodes, h = (c) => {
          ...
          for (let f = 0; f < c.length; f++) {
            const y = c[f];
            if ((p = y == null ? void 0 : y.attributes) != null && p.length && f > 0) {
              const E = y.attributes[0].nodeValue.split(","), L = y.innerHTML;
              l.push([L, E]);
            } else
...
class Qt extends T {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.format = ((s = e.danmaku) == null ? void 0 : s.format) || "mfuns", this.parser = new Fs({ defaultParser: this.format }), this.operate = new Ps(this.player, this), this.api = e.danmakuApi || {}, this.allowNewDanmaku = !1, this.$el = D("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      D("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new _s(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
...
Zt.pluginName = "buttonDanmakuToggle";
const Hs = u`
...
Gt.pluginName = "buttonDanmakuSettings";
const qs = (i) => u`
  <div class="${a}-hotkeys">
...
class te extends T {
  constructor(t) {
    ...
    this.container = D("div", { class: `${a}-contextmenu-wrap` }), v(Ns(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
...
ce.pluginName = "user";
const Us = [le, oe, he], js = [ie, re, ee, ae, se, te, ce], Xs = [
  ne,
  Rt,
  Bt,
  Vt,
...
ge.pluginName = "buttonDanmakuList";
const Gs = u`
...
class fe extends H {
  ...
  _update(t) {
    ...
    }), e.length ? (console.log("mmmmmmmm"), v(
      xt(e, (s) => {
        var n;
...
class be extends T {
  constructor(t, e) {
    super(t), this.$el = D("div", { class: `${a}-videostatus` }), v(Js, this.$el), this.$paused = this.$el.querySelector(`.${a}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${a}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
be.pluginName = "videoStatus";
const Cs = u`
...
class ke extends T {
  constructor(t, e) {
    var s, n;
    super(t), this.$el = D("div", { class: `${a}-loadingmask` }), v(Cs, this.$el), this.$info = this.$el.querySelector(`.${a}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${a}-loadingmask-tips`), this.getTips = (s = e.loadingMask) == null ? void 0 : s.getTips, this.delay = ((n = e.loadingMask) == null ? void 0 : n.delay) || 0, this.player.$main.appendChild(this.$el);
  }
  created() {
  ...
  _add(t, e) {
    const s = D("div", { class: `${a}-loadingmask-info-item` });
