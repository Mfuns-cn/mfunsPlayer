...
class wt {
  ...
  pluginCreate(t) {
    this.list.forEach((e) => {
      var r;
      this.player.plugin[e.name] = ((r = e.create) == null ? void 0 : r.call(e, this.player, t)) || {};
    });
  }
  /** 初始化所有插件 */
  pluginInit(t) {
    this.list.forEach((e) => {
      var r;
      (r = e.init) == null || r.call(e, this.player, t);
    });
  }
  /** 销毁所有插件 */
  pluginDestory() {
    this.list.forEach((t) => {
      var e;
      (e = t.destroy) == null || e.call(t, this.player);
    });
  }
}
/**
 ...
 */
var tt;
const J = window, I = J.trustedTypes, lt = I ? I.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, it = "$lit$", q = `lit$${(Math.random() + "").slice(9)}$`, $t = "?" + q, kt = `<${$t}>`, M = document, U = () => M.createComment(""), j = (s) => s === null || typeof s != "object" && typeof s != "function", gt = Array.isArray, St = (s) => gt(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", et = `[ 	
\f\r]`, N = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, at = /-->/g, ot = />/g, _ = RegExp(`>|${et}(?:([^\\s"'>=/]+)(${et}*=${et}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ct = /'/g, ht = /"/g, ft = /^(?:script|style|textarea|title)$/i, xt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), d = xt(1), X = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), dt = /* @__PURE__ */ new WeakMap(), B = M.createTreeWalker(M, 129, null, !1);
function yt(s, t) {
...
const Lt = (s, t) => {
  ...
  for (let c = 0; c < e; c++) {
    const o = s[c];
    let u, p, f = -1, y = 0;
    for (; y < o.length && (a.lastIndex = y, p = a.exec(o), p !== null); )
      y = a.lastIndex, a === N ? p[1] === "!--" ? a = at : p[1] !== void 0 ? a = ot : p[2] !== void 0 ? (ft.test(p[2]) && (n = RegExp("</" + p[2], "g")), a = _) : p[3] !== void 0 && (a = _) : a === _ ? p[0] === ">" ? (a = n ?? N, f = -1) : p[1] === void 0 ? f = -2 : (f = a.lastIndex - p[2].length, u = p[1], a = p[3] === void 0 ? _ : p[3] === '"' ? ht : ct) : a === ht || a === ct ? a = _ : a === at || a === ot ? a = N : (a = _, n = void 0);
    const E = a === _ && s[c + 1].startsWith("/>") ? " " : "";
    l += a === N ? o + kt : f >= 0 ? (r.push(u), o.slice(0, f) + it + o.slice(f) + q + E) : o + q + (f === -2 ? (r.push(void 0), c) : E);
  }
  return [yt(s, l + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), r];
};
class K {
  constructor({ strings: t, _$litType$: e }, r) {
    ...
    this.parts = [];
    let l = 0, a = 0;
    const c = t.length - 1, o = this.parts, [u, p] = Lt(t, e);
    if (this.el = K.createElement(u, r), B.currentNode = this.el.content, e === 2) {
      const f = this.el.content, y = f.firstChild;
      y.remove(), f.append(...y.childNodes);
    }
    for (; (n = B.nextNode()) !== null && o.length < c; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const f = [];
          for (const y of n.getAttributeNames())
            if (y.endsWith(it) || y.startsWith(q)) {
              const E = p[a++];
              if (f.push(y), E !== void 0) {
                const L = n.getAttribute(E.toLowerCase() + it).split(q), m = /([.?@])?(.*)/.exec(E);
                o.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? Pt : m[1] === "?" ? Ft : m[1] === "@" ? Tt : C });
              } else
        ...
        if (ft.test(n.tagName)) {
          const f = n.textContent.split(q), y = f.length - 1;
          if (y > 0) {
            n.textContent = I ? I.emptyScript : "";
            for (let E = 0; E < y; E++)
              n.append(f[E], U()), B.nextNode(), o.push({ type: 2, index: ++l });
            n.append(f[y], U());
          }
        }
        ...
        if (n.data === $t)
          ...
          let f = -1;
          for (; (f = n.data.indexOf(q, f + 1)) !== -1; )
            o.push({ type: 7, index: l }), f += q.length - 1;
        }
      l++;
    }
  }
...
function R(s, t, e = s, r) {
  var n, l, a, c;
  if (t === X)
    return t;
  let o = r !== void 0 ? (n = e._$Co) === null || n === void 0 ? void 0 : n[r] : e._$Cl;
  const u = j(t) ? void 0 : t._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== u && ((l = o == null ? void 0 : o._$AO) === null || l === void 0 || l.call(o, !1), u === void 0 ? o = void 0 : (o = new u(s), o._$AT(s, e, r)), r !== void 0 ? ((a = (c = e)._$Co) !== null && a !== void 0 ? a : c._$Co = [])[r] = o : e._$Cl = o), o !== void 0 && (t = R(s, o._$AS(s, t.values), o, r)), t;
}
class Et {
  constructor(t, e) {
  ...
  u(t) {
    var e;
    const { el: { content: r }, parts: n } = this._$AD, l = ((e = t == null ? void 0 : t.creationScope) !== null && e !== void 0 ? e : M).importNode(r, !0);
    B.currentNode = l;
    let a = B.nextNode(), c = 0, o = 0, u = n[0];
    for (; u !== void 0; ) {
      if (c === u.index) {
        let p;
        u.type === 2 ? p = new Y(a, a.nextSibling, this, t) : u.type === 1 ? p = new u.ctor(a, u.name, u.strings, this, t) : u.type === 6 && (p = new Dt(a, this, t)), this._$AV.push(p), u = n[++o];
      }
      c !== (u == null ? void 0 : u.index) && (a = B.nextNode(), c++);
    }
    return B.currentNode = M, l;
  }
  v(t) {
    let e = 0;
...
class Y {
  constructor(t, e, r, n) {
    var l;
    this.type = 2, this._$AH = F, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = r, this.options = n, this._$Cp = (l = n == null ? void 0 : n.isConnected) === null || l === void 0 || l;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = R(this, t, e), j(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== X && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : St(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== F && j(this._$AH) ? this._$AA.nextSibling.data = t : this.$(M.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: r, _$litType$: n } = t, l = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = K.createElement(yt(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      this._$AH.v(r);
    else {
      const a = new Et(l, this), c = a.u(this.options);
  ...
  T(t) {
    ...
    let r, n = 0;
    for (const l of t)
      n === e.length ? e.push(r = new Y(this.k(U()), this.k(U()), this, this.options)) : r = e[n], r._$AI(l), n++;
...
class C {
  constructor(t, e, r, n, l) {
    this.type = 1, this._$AH = F, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = l, r.length > 2 || r[0] !== "" || r[1] !== "" ? (this._$AH = Array(r.length - 1).fill(new String()), this.strings = r) : this._$AH = F;
  }
  get tagName() {
  ...
  _$AI(t, e = this, r, n) {
    ...
    let a = !1;
    if (l === void 0)
      t = R(this, t, e, 0), a = !j(t) || t !== this._$AH && t !== X, a && (this._$AH = t);
    else {
      const c = t;
      let o, u;
      for (t = l[0], o = 0; o < l.length - 1; o++)
        u = R(this, c[r + o], e, o), u === X && (u = this._$AH[o]), a || (a = !j(u) || u !== this._$AH[o]), u === F ? t = F : t !== F && (t += (u ?? "") + l[o + 1]), this._$AH[o] = u;
    }
    a && !n && this.j(t);
  }
  j(t) {
...
class Ft extends C {
  ...
  j(t) {
    t && t !== F ? this.element.setAttribute(this.name, At) : this.element.removeAttribute(this.name);
  }
}
class Tt extends C {
  constructor(t, e, r, n, l) {
    super(t, e, r, n, l), this.type = 5;
  }
  _$AI(t, e = this) {
    var r;
    if ((t = (r = R(this, t, e, 0)) !== null && r !== void 0 ? r : F) === X)
      return;
    const n = this._$AH, l = t === F && n !== F || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive, a = t !== F && (n === F || l);
    l && this.element.removeEventListener(this.name, this, n), a && this.element.addEventListener(this.name, this, t), this._$AH = t;
  }
  handleEvent(t) {
    var e, r;
...
ut == null || ut(K, Y), ((tt = J.litHtmlVersions) !== null && tt !== void 0 ? tt : J.litHtmlVersions = []).push("2.8.0");
const g = (s, t, e) => {
  var r, n;
  const l = (r = e == null ? void 0 : e.renderBefore) !== null && r !== void 0 ? r : t;
  let a = l._$litPart$;
  if (a === void 0) {
    const c = (n = e == null ? void 0 : e.renderBefore) !== null && n !== void 0 ? n : null;
    l._$litPart$ = a = new Y(t.insertBefore(U(), c), c, void 0, e ?? {});
  }
  return a._$AI(s), a;
}, i = "mfuns-player", qt = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", _t = [
  { name: "Minteea", id: "Minteea", link: "https://github.com/Minteea" },
  { name: "鲁迪钨丝", id: "Rudiusu", link: "https://github.com/Rudiusu" }
], V = (s, t) => Array.from({ length: s }, () => t), Ht = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, Bt = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, Mt = document.pictureInPictureEnabled, pt = (s) => {
  const t = s.split(/[:：]/).slice(-3), e = parseInt(t[t.length - 1]) || 0, r = parseInt(t[t.length - 2]) || 0, n = parseInt(t[t.length - 3]) || 0;
  return e + r * 60 + n * 3600;
}, bt = (s, t, e = !1) => {
  let r = null, n = !1;
  return function(...l) {
    r && clearTimeout(r), e && !n ? (s.apply(this, l), n = !0) : r = setTimeout(() => {
      s.apply(this, l), clearTimeout(r), r = null, n = !1;
    }, t);
  };
}, z = (s, t = !0) => {
  if (s = s || 0, s === 0 || s === 1 / 0 || s.toString() === "NaN")
    return "00:00";
  const e = (a) => a < 10 ? `0${a}` : `${a}`, r = Math.floor(s / 3600), n = Math.floor((s - r * 3600) / 60), l = Math.floor(s - r * 3600 - n * 60);
  return t ? (r > 0 ? [r, n, l] : [n, l]).map(e).join(":") : [r * 60 + n, l].map(e).join(":");
}, Wt = (s) => (s[0] === "#" && (s = s.substr(1)), s.length === 3 && (s = `${s[0]}${s[0]}${s[1]}${s[1]}${s[2]}${s[2]}`), parseInt(s, 16) + 0 & 16777215), It = (s) => `#${`00000${s.toString(16)}`.slice(-6)}`, st = {
  ...
  (e) => {
    var r;
    return (r = st[e]) == null ? void 0 : r.call(st, s);
  }
), Nt = () => d`
  <div class="${i}-progress-bar">
    <div class="${i}-progress-bar-buffered"></div>
    <div class="${i}-progress-bar-played"></div>
    <div class="${i}-progress-bar-thumb-track">
      <div class="${i}-progress-bar-thumb"></div>
    </div>
    <div class="${i}-progress-bar-preview">
      <div class="${i}-progress-bar-thumbnail"></div>
      <div class="${i}-progress-bar-time"></div>
    </div>
    <div class="${i}-progress-bar-tip"></div>
  </div>
`;
class Vt {
  constructor(t, e) {
    this.trackLength = 0, this.distance = 0, this.nMax = 0, this.nLeft = 0, this.isDragging = !1, this.isHover = !1, this.isActive = !1, this.controller = t, this.player = t.player, this.container = t.$progress, g(Nt(), this.container), this.el = this.container.querySelector(`.${i}-progress-bar`), this.$buffered = this.el.querySelector(`.${i}-progress-bar-buffered`), this.$played = this.el.querySelector(`.${i}-progress-bar-played`), this.$thumbTrack = this.el.querySelector(`.${i}-progress-bar-thumb-track`), this.$thumb = this.el.querySelector(`.${i}-progress-bar-thumb`), this.$preview = this.el.querySelector(`.${i}-progress-bar-preview`), this.$thumbnail = this.el.querySelector(`.${i}-progress-bar-thumbnail`), this.$time = this.el.querySelector(`.${i}-progress-bar-time`), this.$tip = this.el.querySelector(`.${i}-progress-bar-tip`), this.video = this.player.video, this.container.addEventListener("mousedown", (l) => {
      const { clientX: a } = l;
      this.trackLength = this.el.offsetWidth, this.nMax = this.$thumbTrack.offsetWidth || this.trackLength, this.nLeft = this.container.getBoundingClientRect().left, this.distance = a - this.nLeft, this.setBarPlayed(this.nValue), this.el.classList.add(`${i}-progress-bar-dragging`), this.isDragging = !0, document.addEventListener("mousemove", r), document.addEventListener("mouseup", n);
    });
    const r = (l) => {
      var c;
      const { clientX: a } = l;
      l.preventDefault(), l.stopPropagation(), this.distance = a - this.nLeft, this.setBarPlayed(this.nValue), this.updateTip(), (c = window.getSelection()) == null || c.removeAllRanges();
    }, n = (l) => {
      var a;
      l.stopPropagation(), (a = window.getSelection()) == null || a.removeAllRanges(), document.removeEventListener("mousemove", r), document.removeEventListener("mouseup", n), this.el.classList.remove(`${i}-progress-bar-dragging`), this.isDragging = !1, this.isHover || this.setActive(!1), this.player.seek(this.nValue), this.player.play();
    };
    this.container.addEventListener("mouseenter", () => {
      ...
      if (this.isDragging)
        return;
      const { clientX: a } = l;
      this.trackLength = this.el.offsetWidth, this.nMax = this.$thumbTrack.offsetWidth || this.trackLength, this.nLeft = this.container.getBoundingClientRect().left, this.distance = a - this.nLeft, this.updateTip();
    }), this.container.addEventListener("mouseleave", () => {
      this.isHover = !1, this.isDragging || this.setActive(!1);
    }), this.player.on("timeupdate", (l) => {
      this.isDragging || this.setBarPlayed(l);
    }), this.player.on("progress", (l) => {
      this.setBarBuffered(l);
    });
  }
  /** 滑动距离 */
  get nLength() {
  ...
  /** 设置已播放进度条位置 */
  setBarPlayed(t) {
    const e = t / this.video.duration || 0;
  ...
  /** 设置进度条活跃状态 */
  setActive(t) {
    this.isActive = t, this.el.classList.toggle(`${i}-progress-bar-active`, t), t ? this.controller.setControl(!0) : this.controller.setControl(!1);
  }
  /** 更新指针位置 */
  updateTip() {
...
const zt = () => d`
  <div class="${i}-controller-mask"></div>
  <div class="${i}-controller mp-crystal">
    <div class="${i}-controller-progress"></div>
    <div class="${i}-controller-content">
      <div class="${i}-controller-left"></div>
      <div class="${i}-controller-center"></div>
      <div class="${i}-controller-right"></div>
    </div>
  </div>
`;
class Ot {
  constructor(t, e) {
    this.isHover = !1, this.isControl = !1, this.player = t, this.container = t.template.$controllerWrap;
    const r = new DocumentFragment();
    g(zt(), r), this.el = r.querySelector(`.${i}-controller`), this.$progress = this.el.querySelector(`.${i}-controller-progress`), this.$content = this.el.querySelector(`.${i}-controller-content`), this.$left = this.el.querySelector(`.${i}-controller-left`), this.$center = this.el.querySelector(`.${i}-controller-center`), this.$right = this.el.querySelector(`.${i}-controller-right`), this.progressBar = new Vt(this, e), this.init(), this.container.appendChild(r);
  }
  init() {
    this.container.addEventListener("mouseenter", () => {
      this.isHover = !0;
  ...
  /** 设置播放器控制状态 */
  setControl(t) {
    this.isControl = t, t || this.player.state.removeActive();
  }
}
class Ut {
  constructor() {
  ...
  trigger(t, ...e) {
    if (this.events[t] && this.events[t].length)
      for (let r = 0; r < this.events[t].length; r++)
        this.events[t][r](...e);
  }
}
const jt = () => d`
  <div class="${i}">
    <div class="${i}-main">
      <div class="${i}-video-area">
        <div class="${i}-video-wrap">
          <video class="${i}-video"></video>
        </div>
        <div class="${i}-danmaku-wrap"></div>
        <div class="${i}-state-wrap"></div>
        <div class="${i}-toast-wrap"></div>
      </div>
      <div class="${i}-side-wrap"></div>
      <div class="${i}-modal-wrap"></div>
      <div class="${i}-header-wrap"></div>
      <div class="${i}-controller-wrap"></div>
    </div>
    <div class="${i}-footbar mp-solid"></div>
  </div>
`;
class Xt {
  constructor(t, e) {
    this.player = t, this.container = this.player.container, this.init();
  }
  /** 初始化模板绑定 */
  init() {
    g(jt(), this.container);
    const t = this.container.querySelector.bind(this.container);
    this.el = t(`.${i}`), this.$main = t(`.${i}-main`), this.$video = t(`.${i}-video`), this.$videoArea = t(`.${i}-video-area`), this.$videoWrap = t(`.${i}-video-wrap`), this.$danmakuWrap = t(`.${i}-danmaku-wrap`), this.$toastWrap = t(`.${i}-toast-wrap`), this.$stateWrap = t(`.${i}-state-wrap`), this.$headerWrap = t(`.${i}-header-wrap`), this.$modalWrap = t(`.${i}-modal-wrap`), this.$controllerWrap = t(`.${i}-controller-wrap`), this.$sideWrap = t(`.${i}-side-wrap`), this.$footbar = t(`.${i}-footbar`);
  }
}
class Kt {
  constructor(t) {
  ...
  /** 一般加载方式 */
  loadNormal(t) {
    this.video.el.src = t.url, this.current = {
      ...t,
      destroy: () => {
        this.video.el.src = "";
      }
  ...
  loadFlv(t) {
    if (flvjs != null && flvjs.isSupported()) {
      ...
      e.attachMediaElement(this.video.el), e.load(), this.current = {
        ...t,
        destroy: () => {
          e.destroy();
        }
  ...
  loadHls(t) {
    if (Hls != null && Hls.isSupported()) {
      const e = new Hls();
      e.attachMedia(this.video.el), e.loadSource(t.url), this.current = {
        ...t,
        destroy: () => {
          e.destroy();
        }
  ...
  loadDash(t) {
    if (dashjs) {
      ...
      e.initialize(this.video.el, t.url, !0), this.current = {
        ...t,
        destroy: () => {
          e.destroy();
        }
...
class Yt {
  constructor(t, e) {
    this.quality = "1080P", this.ratio = null, this.player = t, this.el = this.player.template.$video, this.loader = new Kt(this), this.list = e.video.list, this.currentPart = e.video.part || 1, this.setRatio(e.aspectRatio || null), this.initEvent(), this.initKeepRatio();
  }
  /** 设置视频 */
  async setVideo(t, e = !1) {
    const r = t.part || 1;
    this.list = t.list, this.currentPart = r, this.load(this.findSourceByQuality(this.partInfo.src, this.quality), e), this.player.events.trigger("video"), this.player.events.trigger("part", r), this.seek(0);
  }
  /** 设置分P */
  async setPart(t, e = !1) {
    this.currentPart = t, this.load(this.findSourceByQuality(this.partInfo.src, this.quality), e), this.player.events.trigger("part", t), this.seek(0);
  }
  /** 切换视频质量 */
  async setQuality(t) {
    const e = this.partInfo.src;
    let r = e.find((n) => n.quality == t);
    r || (r = this.findSourceByQuality(e, t)), this.load(r, !this.paused, this.duration);
  }
  /** 加载视频 */
  load(t, e, r) {
    this.loader.load(t);
    const n = () => {
      this.player.events.trigger("video:load_end"), r && this.seek(r), e ? this.play() : this.player.template.el.classList.add("state-paused"), this.el.removeEventListener("loadedmetadata", n);
    };
    this.el.addEventListener("loadedmetadata", n);
  }
  /** 根据视频质量选择合适的视频源
   * 返回小于等于该质量的视频源中最大的一个
   */
  findSourceByQuality(t, e) {
    const r = [...t].sort(
      (l, a) => parseInt(a.quality || "") - parseInt(l.quality || "")
    );
    let n = r.find((l) => parseInt(l.quality || "") <= parseInt(e));
  ...
  /** 上一P */
  prev() {
    this.currentPart > 1 && this.setPart(this.currentPart - 1, !0);
  }
  /** 下一P */
  next() {
    this.currentPart < this.list.length && this.setPart(this.currentPart + 1, !0), this.play();
  }
  // 同步视频方法
  /** 播放 */
  play() {
  ...
  /** 跳转 */
  seek(t) {
    this.el.currentTime = t > 0 ? t < this.el.duration ? t : this.el.duration : 0;
  }
  // 同步设置视频属性
  /** 设置音量 */
  setVolume(t) {
    this.el.volume = t > 0 ? t < 1 ? t : 1 : 0;
  }
  /** 设置倍速 */
  setPlaybackRate(t) {
  ...
  /** 设置循环播放 */
  setLoop(t) {
    this.el.loop = t, this.player.events.trigger("change:loop", t);
  }
  /** 设置视频比例 */
  setRatio(t) {
    if (this.ratio = t, this.el.style.width = "", this.el.style.height = "", t) {
      const [e, r] = t;
      this.el.style.aspectRatio = `${e}/${r}`, this.el.style.objectFit = "fill";
      const { width: n, height: l } = this.el.getBoundingClientRect(), { width: a, height: c } = this.player.template.$videoArea.getBoundingClientRect();
      n == a && l == c && this.rescale(n, l, e, r);
    } else
      this.el.style.aspectRatio = "", this.el.style.objectFit = "";
    this.player.events.trigger("change:aspectRatio", t);
  }
  /** 静音 */
  mute(t = !0) {
    this.el.muted = t;
  ...
  /** 监听视频事件 */
  on(t, e, r) {
    this.el.addEventListener(t, e, r);
  }
  /** 移除视频事件 */
  off(t, e, r) {
    this.el.removeEventListener(t, e, r);
  }
  initEvent() {
    this.on("play", () => {
      this.player.events.trigger("play"), this.player.template.el.classList.remove("state-paused");
    }), this.on("pause", () => {
      this.player.events.trigger("pause"), this.player.template.el.classList.add("state-paused");
    }), this.on("ended", () => {
      this.player.events.trigger("ended");
    }), this.on("waiting", () => {
      this.player.events.trigger("waiting"), this.player.template.el.classList.add("state-loading");
    }), this.on("playing", () => {
      this.player.events.trigger("playing"), this.player.template.el.classList.remove("state-loading");
    }), this.on("seeking", () => {
      this.player.events.trigger("seeking", this.currentTime), this.player.template.el.classList.add("state-seeking");
    }), this.on("seeked", () => {
      this.player.events.trigger("seeked", this.currentTime), this.player.template.el.classList.remove("state-seeking");
    }), this.on("timeupdate", () => {
      this.player.events.trigger("timeupdate", this.currentTime);
    }), this.on("progress", () => {
      const t = this.el.buffered;
      this.player.events.trigger(
        "progress",
        t.length ? t.end(t.length - 1) : 0
      );
  ...
  initKeepRatio() {
    this.player.on("resize", ([t, e]) => {
      if (this.ratio) {
        ...
        const [r, n] = this.ratio, { width: l, height: a } = this.el.getBoundingClientRect();
        console.log(`${l} x ${a} -- ${t} x ${e}`), Math.abs(l - t) < 1 && Math.abs(a - e) < 1 && this.rescale(t, e, r, n);
      }
    });
  }
  /** 根据当前视频宽高重新维持视频比例 */
  rescale(t, e, r, n) {
    const l = r * e, a = n * t;
    l < a ? (this.el.style.width = `${l / a * 100}%`, this.el.style.height = "100%") : (this.el.style.width = "100%", this.el.style.height = `${a / l * 100}%`);
  }
}
class Qt {
  constructor(t) {
    this.player = t, this.el = this.player.template.$main;
    const e = () => {
      this.value ? (this.player.template.el.classList.add("mode-fullscreen"), this.player.events.trigger("fullscreen")) : (this.player.template.el.classList.remove("mode-fullscreen"), this.player.events.trigger("fullscreen_exit"));
    };
...
class Zt {
  constructor(t) {
    this.player = t, this.video = this.player.video.el, this.video.addEventListener("enterpictureinpicture", () => {
      this.player.template.el.classList.add("mode-pip"), this.player.events.trigger("pip");
    }), this.video.addEventListener("leavepictureinpicture", () => {
      this.player.template.el.classList.remove("mode-pip"), this.player.events.trigger("pip_exit");
    });
  }
  /** 进入画中画模式 */
  enter() {
    this.value || this.video.requestPictureInPicture();
  }
  /** 退出画中画模式 */
  exit() {
    this.value && document.exitPictureInPicture();
  }
  /** 是否已进入画中画模式 */
  get value() {
...
class Gt {
  constructor(t) {
    this.player = t, this.el = this.player.template.el;
  }
  /** 进入网页全屏 */
  enter() {
    this.el.classList.add("mode-webfull"), this.player.events.trigger("webfull");
  }
  /** 退出网页全屏 */
  exit() {
    this.el.classList.remove("mode-webfull"), this.player.events.trigger("webfull_exit");
  }
  /** 是否处于网页全屏模式 */
  get value() {
...
class Jt {
  constructor(t, e) {
    this.player = t, this.modeWebfull = new Gt(this.player), this.modeFullscreen = new Qt(this.player), this.modePip = new Zt(this.player), this.init();
  }
  init() {
    this.player.on("webfull", () => {
      ...
      const { width: r, height: n } = e.contentRect;
      this.player.events.trigger("resize", [r, n]);
    }).observe(this.player.template.$videoWrap);
  }
  fullscreen() {
  ...
  /** 设置控制栏固定 */
  solid(t) {
    this.player.template.el.classList.toggle("mode-solid", t), this.player.events.trigger(t ? "solid" : "solid_off");
  }
}
const Ct = (s, t) => d`
  <div class="${i}-side-panel ${i}-partlist">
    <div class="${i}-partlist-list">
      ${s.map(
  ({ title: e }, r) => d`
          <div
            class="${i}-partlist-list-item"
            @click=${() => {
    t(r + 1);
  }}
          >
            <div class="${i}-partlist-list-id">P${r + 1}</div>
            <div class="${i}-partlist-list-title">${e}</div>
          </div>
        `
)}
    </div>
...
class te {
  constructor(t) {
    this.title = "分P列表", this.mounted = !1, this.player = t;
    const e = new DocumentFragment();
    g(
      Ct(t.video.list, (r) => {
        this.player.setPart(r, !0), this.player.side.hide();
      }),
      e
    ), this.el = e.querySelector(`.${i}-side-panel`);
  }
}
const ee = () => d`
  <div class="${i}-side-mask"></div>
  <div class="${i}-side">
    <div class="${i}-side-head">
      <div class="${i}-side-title"></div>
      <div class="${i}-side-close">
        <i class="${i}-controller-icon mp-icon-close"></i>
      </div>
    </div>
    <div class="${i}-side-content"></div>
  </div>
`;
class se {
  constructor(t, e) {
    this.list = {}, this.current = "", this.player = t, this.container = t.template.$sideWrap, g(ee(), this.container), this.el = this.container.querySelector(`.${i}-side`), this.$mask = this.container.querySelector(`.${i}-side-mask`), this.$content = this.el.querySelector(`.${i}-side-content`), this.$title = this.el.querySelector(`.${i}-side-title`), this.$close = this.el.querySelector(`.${i}-side-close`), this.$mask.addEventListener("click", () => {
      this.hide();
    }), this.$close.addEventListener("click", () => {
      this.hide();
    }), this.add("partlist", new te(this.player));
  }
  get isShow() {
  ...
  show(t) {
    const e = this.list[t];
    e && !e.mounted ? (t != this.current && (this.removeCurrent(), this.current = t, this.$title.innerText = e.title, e.el.classList.add("state-show"), this.player.events.trigger("side:show", t)), this.container.classList.add("state-show")) : this.hide(), e.mounted && this.player.events.trigger("side:show_mounted", t);
  }
  /** 切换面板状态 */
  toggle(t) {
    t == this.current && this.isShow ? this.hide() : this.show(t);
  }
  /** 隐藏侧边面板 */
  hide() {
  ...
  /** 添加面板 */
  add(t, e) {
    this.list[t] = e, this.$content.append(e.el);
  }
  mount(t) {
    (t || this.el).append(this.$content);
  }
  /** 侧边面板挂载到其他元素 */
  mountPanel(t, e) {
    const r = this.list[t];
    r && ((e || this.$content).append(r.el), r.el.classList.remove("state-show"), e ? r.mounted = !0 : r.mounted = !1), t == this.current && this.removeCurrent();
  }
  /** 清除当前面板显示 */
  removeCurrent() {
    const t = this.list[this.current];
    t && t.el.classList.remove("state-show"), this.player.events.trigger("side:hide", this.current), this.$title.innerText = "", this.current = "";
  }
}
const ie = () => d`
  <div class="${i}-modal-panel ${i}-about">
    <div class="${i}-about-logo"></div>
    <div class="${i}-about-version">version ${W.version}-${W.gitHash}</div>
    <div>github: <a href="${qt}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者</div>
    <ul class="${i}-about-developers">
      ${_t.map(
  ({ name: s, id: t, link: e }) => d`
          <li>
...
class re {
  constructor() {
    ...
    g(ie(), t), this.el = t.querySelector(`.${i}-modal-panel`);
  }
}
const ne = (s) => d`
  <div class="${i}-modal-panel ${i}-hotkey">
    <div class="${i}-hotkey-list">
      ${s.map(
  ({ key: t, description: e }) => d`
          <div class="${i}-hotkey-list-item">
            <div class="${i}-hotkey-list-key">${t}</div>
            <div class="${i}-hotkey-list-description">${e}</div>
          </div>
        `
)}
    </div>
...
class le {
  constructor() {
    ...
    g(ne(t), e), this.el = e.querySelector(`.${i}-modal-panel`);
  }
}
const ae = () => d`
  <div class="${i}-modal-mask"></div>
  <div class="${i}-modal">
    <div class="${i}-modal-head">
      <div class="${i}-modal-title"></div>
      <div class="${i}-modal-close">
        <i class="${i}-controller-icon mp-icon-close"></i>
      </div>
    </div>
    <div class="${i}-modal-content"></div>
  </div>
`;
class oe {
  constructor(t, e) {
    this.list = {}, this.current = "", this.player = t, this.container = t.template.$modalWrap, g(ae(), this.container), this.el = this.container.querySelector(`.${i}-modal`), this.$mask = this.container.querySelector(`.${i}-modal-mask`), this.$content = this.el.querySelector(`.${i}-modal-content`), this.$title = this.el.querySelector(`.${i}-modal-title`), this.$close = this.el.querySelector(`.${i}-modal-close`), this.init(e);
  }
  get isShow() {
    return this.container.classList.contains("state-show");
  }
  init(t) {
    this.$mask.addEventListener("click", () => {
      ...
      this.hide();
    }), this.add("about", new re()), this.add("hotkey", new le());
  }
  show(t) {
    if (t != this.current) {
      const e = this.list[t];
      e && (this.removeCurrent(), this.current = t, this.$title.innerText = e.title, e.el.classList.add("state-show"));
    }
  ...
  removeCurrent() {
    const t = this.list[this.current];
    t && t.el.classList.remove("state-show"), this.$title.innerText = "", this.current = "";
  }
}
const Q = {
...
class ce {
  constructor(t, e) {
    this.player = t, this.themeElement = [this.player.container], this.setTheme(e.theme || {});
  }
  /** 设置主题 */
  setTheme(t) {
    Object.assign(this, t), this.themeElement.forEach((e) => {
      let r;
      for (r in t)
        e.style.setProperty(Q[r], t[r]);
    });
  }
  /** 设置某个主题属性 */
  setThemeProperty(t, e) {
    this[t] = e, this.themeElement.forEach((r) => {
      r.style.setProperty(Q[t], e);
    });
  }
  /** 为元素绑定主题变量 */
  addThemeElement(t) {
    ...
    for (e in Q) {
      const r = this[e];
      r && t.style.setProperty(Q[e], r);
    }
  }
}
const he = () => d`
  <div class="${i}-state-loading"></div>
  <div class="${i}-state-volume"></div>
  <div class="${i}-state-paused"></div>
`;
class de {
  constructor(t, e) {
    this.focused = !1, this.active = !1, this.mousemove = !1, this.player = t, this.container = t.template.$stateWrap, this.$stateLoading = this.container.querySelector(`.${i}-state-loading`), this.$stateVolume = this.container.querySelector(`.${i}-state-volume`), this.$statePaused = this.container.querySelector(`.${i}-state-paused`), g(he(), this.container), this.init();
  }
  init() {
  ...
  /** 设置播放器活跃状态 */
  setActive() {
    this.active || (this.player.template.el.classList.add("state-active"), this.active = !0);
  }
  /** 试图移除播放器活跃状态 */
  removeActive() {
    !this.active || this.player.controller.isHover || this.player.controller.isControl || this.mousemove || (this.player.template.el.classList.remove("state-active"), this.active = !1);
  }
}
var G = /* @__PURE__ */ ((s) => (s[s.roll = 1] = "roll", s[s.bottom = 4] = "bottom", s[s.top = 5] = "top", s[s.reverse = 6] = "reverse", s[s.special = 7] = "special", s[s.advanced = 9] = "advanced", s))(G || {});
class ue {
  constructor(t, e) {
  ...
  /** 设置弹幕池 */
  setPool(t) {
    this.danmakuPool = [...t], this.danmakuPool.sort((r, n) => r.time - n.time);
    const e = this.danmakuPool.findIndex((r) => this.time <= r.time);
  ...
  add(t) {
    t.forEach((e) => {
      const r = this.danmakuPool.findIndex((n) => e.time <= n.time);
      this.danmakuPool.splice(r === -1 ? this.danmakuPool.length : r, 0, e), e.time < this.time && (this.currentIndex += 1);
    });
  }
  /** 弹幕池移除符合id的弹幕 */
  remove(t) {
    ...
    t.forEach((r) => {
      const n = this.danmakuPool.findIndex((a) => a.id == r);
      if (n === -1)
        return;
      this.danmakuPool.splice(n, 1), n < this.currentIndex && (this.currentIndex -= 1);
      const l = e.find((a) => a.dataset.id === r.toString());
      l && (l.innerHTML = "");
    });
  }
  /** 弹幕清屏 */
  ...
  /** 设置弹幕类型过滤 */
  setTrackFilter(t, e) {
    this.trackFilter[t] = e, e && this.container.querySelectorAll(`.${this.classPrefix}-danmaku-${t}`).forEach((r) => {
      r.innerHTML = "";
    });
  }
  /** 检查弹幕类型过滤 */
  checkTrackFilter(t) {
    return !this.trackFilter[G[t.mode]];
  }
  /** 设置弹幕颜色过滤 */
  setColorFilter(t) {
    this.colorFilter = t, t && this.container.querySelectorAll(
      ...
      r.style.color !== "rgb(255, 255, 255)" && (r.innerHTML = "");
    });
  }
  /** 检查弹幕颜色过滤 */
  checkColorFilter(t) {
  ...
  setContentFilter(t, e) {
    const r = this.contentFilter.indexOf(t);
    if (e) {
      if (r > -1)
        return;
      ...
      r > -1 && this.contentFilter.splice(r, 1);
  }
  /** 检查弹幕内容过滤 */
  ...
  /** 设置用户过滤 */
  setUserFilter(t, e) {
    const r = this.userFilter.indexOf(t);
    if (e) {
      if (r > -1)
        return;
      ...
      r > -1 && this.userFilter.splice(r, 1);
  }
  /** 检查用户过滤 */
  checkUserFilter(t) {
  ...
  draw(t) {
    var y, E, L;
    const e = this.baseTrackHeight * this.fontScale, r = this.container.offsetWidth, n = this.container.offsetHeight * this.limitArea, l = Math.floor(n / e);
    this.trackHeights.roll.length !== l && (this.trackHeights.roll = V(l, e)), this.trackHeights.reverse.length !== l && (this.trackHeights.reverse = V(l, e)), this.trackHeights.top.length !== l && (this.trackHeights.top = V(l, e)), this.trackHeights.bottom.length !== l && (this.trackHeights.bottom = V(l, e));
    const a = (m) => {
      const v = this.container.getBoundingClientRect().right, h = m.getBoundingClientRect().right;
      return v - h;
    }, c = (m) => {
      const v = this.container.getBoundingClientRect().left;
      return m.getBoundingClientRect().left - v;
    }, o = (m) => this.baseSpeed * (1 + this.deltaSpeed * m) * this.speed, u = (m, v) => [
      ...this.container.querySelectorAll(`.${this.classPrefix}-danmaku-${m}`)
    ].filter((h) => h.dataset.track === `${v}`), p = (m, v, h) => {
      t:
        for (let $ = 0; this.overlap || $ < l; $++) {
          const x = u(v, $);
          let w = this.danmakuTracks[v][$];
          if (this.danmakuTracks[v][$] = x, w && w.length) {
            if (v === "roll") {
              const A = r / o(h);
              w.length !== x.length && (w = x);
              for (const k of w) {
                const S = a(k) - 10;
                if (this.trackHeights[v][$] = parseInt(k.style.fontSize) + this.trackPadding, S <= r - A * o(k.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const A = r / o(h);
            ...
            return this.danmakuTracks[v][$].push(m), m.addEventListener("animationend", () => {
              ...
              A && ((S = this.danmakuTracks[v][$]) == null || S.splice(A, 1));
            }), $;
          } else
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      h.classList.add(`${this.classPrefix}-danmaku-item`), h.classList.add(`${this.classPrefix}-danmaku-${G[v.mode]}`), h.innerHTML = `${v.content.replace(/(\\n)/g, `
`)}`, typeof v.color == "number" ? h.style.color = It(v.color) : h.style.color = v.color, h.style.opacity = this.opacity.toString(), h.style.fontSize = +v.size * this.fontScale + "px", h.addEventListener("animationend", () => {
        [...this.container.children].indexOf(h) > -1 && this.container.removeChild(h);
      });
      ...
      switch (x) {
        case "roll":
        case "reverse":
          if (A = p(h, x, $), w = A % l, w >= 0) {
            const k = this.trackHeights[x].slice(0, l).reduce((P, D) => P + D, 0), S = this.trackHeights[x].slice(0, w).reduce((P, D) => P + D, 0) % k;
            if (S + parseInt(h.style.fontSize) + this.trackPadding > n) {
              (y = this.danmakuTracks[x][m]) == null || y.pop();
              return;
            }
            const T = o($), b = $ + r + this.startDistance * 2;
            h.dataset.track = A.toString(), h.style.width = $ + 1 + "px", h.style.top = S + "px", h.style.fontFamily = this.fontFamily, h.style.fontWeight = this.fontWeight, h.style.setProperty("--duration", `${b / T}s`), h.style.setProperty("--offset", `${r + this.startDistance}px`), h.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (w = p(h, x, 0) % l, w >= 0) {
            ...
            for (const b of S)
              k.push(...b);
            const T = k.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, w).reduce((b, P) => b + P, 0);
            if (T + parseInt(h.style.fontSize) + this.trackPadding > n) {
              (E = this.danmakuTracks[x][m]) == null || E.pop();
              return;
            }
            h.dataset.track = w.toString(), h.style.width = $ + 1 + "px", h.style.marginLeft = `-${($ + 1) * 0.5}px`, h.style.top = T + "px", h.style.fontFamily = this.fontFamily, h.style.fontWeight = this.fontWeight, h.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (x = "bottom", w = p(h, x, 0) % l, w >= 0) {
            ...
            h.dataset.track = w.toString(), h.style.width = $ + 1 + "px", h.style.marginLeft = `-${($ + 1) * 0.5}px`, h.style.bottom = T + "px", h.style.fontFamily = this.fontFamily, h.style.fontWeight = this.fontWeight, h.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
          w = -1, console.error(`无法处理的弹幕模式: ${v.mode}`);
      }
      w >= 0 && (h.dataset.id = v.id.toString(), h.dataset.user = v.user.toString(), this.container.appendChild(h));
    }
    return f;
  }
  /** 测量字体宽度 */
  ...
  /** 根据某一坐标捕获弹幕DOM */
  captureDanmakuDOM(t, e, r, n = !1) {
    const l = [], a = this.container.querySelectorAll(`.${this.classPrefix}-danmaku-item`);
    for (const c of a)
      if (c.innerHTML) {
        const o = c.getBoundingClientRect(), u = this.container.getBoundingClientRect(), p = o.left - u.left, f = o.right - u.left, y = o.top - u.top, E = o.bottom - u.top;
        if (t >= p - r && t <= f + r && e >= y - r && e <= E + r && (l.push(c), n))
          return l;
      }
    return l;
  }
  /** 根据某一坐标捕获弹幕 */
  captureDanmaku(t, e, r, n = !1) {
    const l = this.captureDanmakuDOM(t, e, r, n), a = [];
    for (const c of l) {
      const o = this.getDanmakuById(c.dataset.id);
      o && a.push(o);
    }
    return a;
  }
...
function pe() {
  const s = [], t = vt.length;
  for (let e = 0; e < 8; e++)
    s.push(vt[Math.floor(Math.random() * t)]);
  return mt++, s.join("") + `${mt}`;
}
class me {
  constructor({ defaultParser: t }) {
    this.defaultParser = t || "bilibili-xml", this.list = {
      ...
      "bilibili-xml": (e) => ((n) => {
        const l = [], c = new DOMParser().parseFromString(n, "text/xml").childNodes, o = (u) => {
          var p;
...
class ve {
  constructor(t) {
    this.danmaku = t, this.player = t.player;
  }
  /**
   * 发送弹幕
  ...
  async send(t) {
    var r, n, l;
    let e = await ((l = (n = (r = this.danmaku) == null ? void 0 : r.api) == null ? void 0 : n.send) == null ? void 0 : l.call(n, {
  ...
  async report(t) {
    var r, n, l;
    let e = await ((l = (n = (r = this.danmaku) == null ? void 0 : r.api) == null ? void 0 : n.report) == null ? void 0 : l.call(n, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
    }), e.success && this.danmaku.remove([t.id]), e;
  }
  /**
   * 删除弹幕
  ...
  async delete(t) {
    var r, n, l;
    let e = await ((l = (n = (r = this.danmaku) == null ? void 0 : r.api) == null ? void 0 : n.delete) == null ? void 0 : l.call(n, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
    }), e.success && this.danmaku.remove(t.map((a) => a.id)), e;
  }
  /**
   * 删除自己发送的弹幕
   * @param danmaku 要删除的弹幕
  ...
  async recall(t) {
    var r, n, l;
    let e = await ((l = (n = (r = this.danmaku) == null ? void 0 : r.api) == null ? void 0 : n.recall) == null ? void 0 : l.call(n, { api: this.danmaku.api.url, danmaku: t }));
    return e ?? (e = {
      success: !1,
      message: "操作失败"
    }), e.success && this.danmaku.remove([t.id]), e;
  ...
  async blockUser(t, e) {
    var n, l, a;
    let r = await ((a = (l = (n = this.danmaku) == null ? void 0 : n.api) == null ? void 0 : l.blockUser) == null ? void 0 : a.call(l, { api: this.danmaku.api.url, user: t, flag: e }));
    return r ?? (r = {
      success: !1,
      message: "操作失败"
    }), r.success && (this.danmaku.engine.setUserFilter(t, e), this.player.events.trigger("danmaku:block_user", t, e)), r;
  }
  /**
   * 屏蔽关键词
   * @param content 关键词内容
  ...
  async blockContent(t, e) {
    var n, l, a;
    let r = await ((a = (l = (n = this.danmaku) == null ? void 0 : n.api) == null ? void 0 : l.blockContent) == null ? void 0 : a.call(l, {
      api: this.danmaku.api.url,
      content: t,
      flag: e
    }));
    return r ?? (r = {
      success: !1,
      message: "操作失败"
    }), r.success && (this.danmaku.engine.setContentFilter(t, e), this.player.events.trigger("danmaku:block_content", t, e)), r;
  }
}
const $e = d` <div class="${i}-row-danmaku-container"></div> `;
class ge {
  constructor(t, e) {
    var r;
    this.lastDanmakuId = 0, this.list = [], this.player = t, this.parser = new me({ defaultParser: "mfuns" }), this.operate = new ve(this), this.el = this.player.template.$danmakuWrap, this.api = (r = e.danmaku) == null ? void 0 : r.api, this.allowNewDanmaku = !1, g($e, this.el), this.$rowDanmakuContainer = this.el.querySelector(`.${i}-row-danmaku-container`), this.engine = new ue(this.$rowDanmakuContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
    ...
    }), this.player.on("part", (n) => {
      const { danmakuId: l, danmakuAddition: a } = this.player.video.list[n - 1];
      console.log(a), this.reload(l, a);
    });
  }
  /** 加载附加弹幕 */
  loadAddition({ url: t, type: e, data: r }) {
    fetch(t).then((n) => /-xml$/.test(e) ? n.text() : n.json()).then((n) => {
      const l = r ? r(n) : n, a = this.parser.parse({ data: l, type: e });
      a && this.add(a), this.player.events.trigger("danmaku:load_addition_end", t, a || []);
    }).catch((n) => {
      this.player.events.trigger("danmaku:load_addition_fail", t, n), console.error(n);
    });
  }
  /** 加载弹幕 */
  load(t) {
    const e = this.api;
    e == null || e.get({ api: e.url, id: t }).then((r) => {
      const n = this.parser.parse({ data: r, type: e.type });
      n && (this.add(n), this.lastDanmakuId = n[n.length - 1].id), this.player.events.trigger("danmaku:load_end", n || []);
    }).catch((r) => {
      this.player.events.trigger("danmaku:load_fail", r);
    });
  }
  /** 加载实时新增弹幕 */
  loadNew(t) {
    const e = this.lastDanmakuId;
    this.player.events.trigger("danmaku:load_new_start", e);
    const r = this.api;
    r == null || r.get({ api: r.url, id: t, offset: this.lastDanmakuId }).then((n) => {
      const l = this.parser.parse({ data: n, type: r.type });
      l && (this.add(l), this.lastDanmakuId = l[l.length - 1].id), this.player.events.trigger("danmaku:load_new_end", e, l || []);
    }).catch((n) => {
      this.player.events.trigger("danmaku:load_new_fail", e, n);
    });
  }
  /** 重载弹幕 */
  async reload(t, e) {
    this.player.events.trigger("danmaku:load_start"), this.engine.reset(), t && this.load(t), e == null || e.forEach((r) => {
      this.loadAddition(r);
    });
  }
  /**
  ...
  add(t) {
    const e = [], r = {};
    t.forEach((n) => {
      n.mode < 7 ? e.push(n) : r[n.mode] ? r[n.mode].push(n) : r[n.mode] = [n];
    }), e.length && this.engine.add(e);
    for (const n in r)
      this.player.events.trigger("danmaku:advanced", parseInt(n), r[n]);
  }
  /**
   * 根据id从弹幕池中移除弹幕
   * @param ids 要移除的弹幕id
  ...
  /** 显示弹幕 */
  show() {
    this.engine.show(), this.player.events.trigger("danmaku:on");
  }
  /** 隐藏弹幕 */
  hide() {
    this.engine.hide(), this.player.events.trigger("danmaku:off");
  }
  /** 切换弹幕显示 */
  toggle() {
  ...
  filter(t, e) {
    ...
    this.player.events.trigger("danmaku:filter", t, e);
  }
  // 弹幕播放属性设置
  /** 设置弹幕不透明度 */
  setOpacity(t, e) {
    this.engine.opacity = t, this.player.events.trigger("change:danmaku_opacity", t);
  }
  /** 设置弹幕速度 */
  setSpeed(t, e) {
    this.engine.speed = t, this.player.events.trigger("change:danmaku_speed", t);
  }
  /** 设置弹幕区域 */
  setArea(t, e) {
    this.engine.limitArea = t || 1 / 0, this.player.events.trigger("change:danmaku_area", t);
  }
  /** 设置弹幕大小 */
  setScale(t, e) {
    this.engine.fontScale = t, this.player.events.trigger("change:danmaku_scale", t);
  }
  /** 设置弹幕字体 */
  setFont(t, e) {
    this.engine.fontFamily = t, this.player.events.trigger("change:danmaku_font", t);
  }
  /** 设置弹幕加粗 */
  setBold(t, e) {
    this.engine.fontWeight = t ? "bold" : "", this.player.events.trigger("change:danmaku_bold", t);
  }
}
class W {
  constructor(t, e) {
    this.plugin = {}, this.userId = 0, this.authorId = null, this.events = new Ut(), this.container = t.container, this.template = new Xt(this, t), this.video = new Yt(this, t), this.pluginManager = new wt(this, e), this.theme = new ce(this, t), this.mode = new Jt(this, t), this.state = new de(this, t), this.danmaku = new ge(this, t), this.controller = new Ot(this, t), this.side = new se(this, t), this.modal = new oe(this, t), this.pluginManager.pluginCreate(t), this.pluginManager.pluginInit(t), this.setPart(1), this.on("part", (r) => {
      console.log(`当前分P - ${r}`);
    });
  }
  /** 播放相关 */
...
var H = /* @__PURE__ */ ((s) => (s[s.Backspace = 8] = "Backspace", s[s.Tab = 9] = "Tab", s[s.Enter = 13] = "Enter", s[s.Shift = 16] = "Shift", s[s.Ctrl = 17] = "Ctrl", s[s.Alt = 18] = "Alt", s[s.PauseBreak = 19] = "PauseBreak", s[s.CapsLock = 20] = "CapsLock", s[s.Escape = 27] = "Escape", s[s.Space = 32] = "Space", s[s.PageUp = 33] = "PageUp", s[s.PageDown = 34] = "PageDown", s[s.End = 35] = "End", s[s.Home = 36] = "Home", s[s.LeftArrow = 37] = "LeftArrow", s[s.UpArrow = 38] = "UpArrow", s[s.RightArrow = 39] = "RightArrow", s[s.DownArrow = 40] = "DownArrow", s[s.Insert = 45] = "Insert", s[s.Delete = 46] = "Delete", s[s.Zero = 48] = "Zero", s[
  ...
  s.GraveAccent = 192
  /* Tilde */
] = "GraveAccent", s[s.OpenBracket = 219] = "OpenBracket", s[s.ClosedBracket = 221] = "ClosedBracket", s[s.Quote = 222] = "Quote", s))(H || {});
class fe {
  constructor(t, e) {
    this.player = t, this.controlMask = this.player.template.$videoArea, this.initKey(), this.initMask();
  }
  initKey() {
...
const ye = "hotkey", be = () => {
  ...
  return {
    name: ye,
    create: (t, e) => (s = new fe(t, e), s)
  };
}, we = (s) => d`
  <div class="${i}-contextmenu">
    <ul class="${i}-contextmenu-danmaku mp-black"></ul>
    <ul class="${i}-contextmenu-menu mp-black">
      ${s.map(
  ({ name: t, onClick: e }) => d`
          <li class="${i}-contextmenu-item" @click=${e}>${t}</li>
        `
)}
    </ul>
  </div>
`, ke = (s, t) => d`
  ${s.map(
  (e) => d`
      <li class="${i}-contextmenu-danmaku-item">
        <div class="${i}-contextmenu-danmaku-item-content">${e.content}</div>
        <div class="${i}-contextmenu-danmaku-item-operate">
          ${t(e).map(
    ([r, n]) => d`<div
              class="${i}-contextmenu-danmaku-item-operate-btn"
              @click=${() => {
      n(e);
    }}
            >
...
class xe {
  constructor(t) {
    ...
    const e = [
      ...
      {
        name: `Mfuns Player v${W.version}-${W.gitHash}`,
        onClick: () => {
          this.player.modal.show("about");
        }
      }
    ];
    this.container = document.createElement("div"), this.container.className = `${i}-contextmenu-wrap`, g(we(e), this.container), this.el = this.container.querySelector(`.${i}-contextmenu`), this.$danmaku = this.el.querySelector(`.${i}-contextmenu-danmaku`), this.$menu = this.el.querySelector(`.${i}-contextmenu-menu`), this.player.template.$main.appendChild(this.container), this.player.template.$videoArea.addEventListener("contextmenu", (r) => {
      r.preventDefault();
      const n = this.player.template.$videoArea.getBoundingClientRect(), l = r.clientX - n.left, a = r.clientY - n.top;
      this.show(l, a);
      const c = this.player.danmaku.engine.captureDanmaku(l, a, 4);
      this.showDanmaku(c);
    }), this.container.addEventListener("contextmenu", (r) => {
      r.preventDefault();
      const n = this.container.getBoundingClientRect(), l = r.clientX - n.left, a = r.clientY - n.top;
      this.show(l, a);
      const c = this.player.danmaku.engine.captureDanmaku(l, a, 4);
      this.showDanmaku(c);
  ...
  show(t, e) {
    this.container.classList.add("state-show");
    const r = this.player.template.$videoArea.getBoundingClientRect();
    t + this.el.offsetWidth >= r.width ? (this.el.style.right = r.width - t + "px", this.el.style.left = "initial") : (this.el.style.left = t + "px", this.el.style.right = "initial"), e + this.el.offsetHeight >= r.height ? (this.el.style.bottom = r.height - e + "px", this.el.style.top = "initial") : (this.el.style.top = e + "px", this.el.style.bottom = "initial"), this.isShow = !0;
  }
  showDanmaku(t) {
    const e = this.player.danmaku.api, r = this.player.danmaku.operate;
    t.length ? this.$danmaku.style.display = "" : this.$danmaku.style.display = "none", g(
      ke(t, (n) => {
        const l = n.user == this.player.userId;
        return [
          [
            "举报",
            (a) => {
...
const Le = "contextMenu", Ee = () => {
  let s;
  return {
    name: Le,
    create: (t, e) => (s = new xe(t), s)
  };
}, Pe = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-danmaku-switch state-on"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-danmaku"></i>
      <i class="${i}-controller-icon mp-icon-danmaku-off"></i>
    </div>
    <div class="${i}-tooltip">关闭弹幕</div>
  </div>
`;
class Ae {
  constructor(t, e, r) {
    ...
    g(Pe(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("danmaku:off", () => {
      this.el.classList.remove("state-on"), this.$tooltip.innerText = "开启弹幕";
    }), this.player.on("danmaku:on", () => {
      this.el.classList.add("state-on"), this.$tooltip.innerText = "关闭弹幕";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.danmaku.toggle();
    });
  }
}
const Fe = ({ divider: s }) => d` <div
  class="${i}-slider ${i}-slider-horizontal"
  style="position: relative; width: 100%; height: 100%"
>
  <div
    class="${i}-slider-track"
    style="
      position: absolute;
      width: 100%;
      top: 50%;
    ...
    "
  >
    <div class="${i}-slider-bar" style="position: absolute; left: 0; height: 100%"></div>
    <div class="${i}-slider-thumb-track" style="height: 0px">
      <div
        class="${i}-slider-thumb"
        style="position: absolute; transform: translate(-50%, -50%)"
      ></div>
      ${s ? d`
            <ul class="${i}-slider-divider">
              ${V(s, d`<li class="${i}-slider-divider-dot"></li>`)}
            </ul>
          ` : ""}
    </div>
  </div>
...
class Z {
  constructor({
    ...
    this.container = t, this.min = e, this.max = r, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(a) ? a : Number(a), this.onChange = c, this.onDragStart = o, this.onDragEnd = u, this.onDrag = p, g(Fe({ divider: this.divider }), t), this.el = this.container.querySelector(`.${i}-slider`), this.$track = this.el.querySelector(`.${i}-slider-track`), this.$bar = this.$track.querySelector(`.${i}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${i}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${i}-slider-thumb`), this.el.addEventListener("mousedown", (f) => {
      var k;
      const y = f, { clientX: E } = y, L = this.$track.offsetWidth;
      let m = this.$thumbTrack.offsetWidth;
      m = m || L;
      const v = (L - m) / 2, h = this.el.getBoundingClientRect().left;
      let $ = E - h - v;
      $ = $ >= m ? m : $ <= 0 ? 0 : $;
      const x = this.step ? Math.round($ / m * (this.max - this.min) / this.step) * this.step + this.min : $ / m * (this.max - this.min) + this.min;
      (k = this.onDragStart) == null || k.call(this, x), this.value != x && this.drag(x);
      const w = (S) => {
        var nt;
        const T = S, { clientX: b } = T;
        T.preventDefault(), T.stopPropagation();
        let P = b - h - v;
        P = P >= m ? m : P <= 0 ? 0 : P;
        const D = this.step ? Math.round(P / m * (this.max - this.min) / this.step) * this.step + this.min : P / m * (this.max - this.min) + this.min;
        this.value != D && this.drag(D), (nt = window.getSelection()) == null || nt.removeAllRanges();
      }, A = (S) => {
        var b, P;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", w), document.removeEventListener("mouseup", A), (P = this.onDragEnd) == null || P.call(this, x);
      };
  ...
  setValue(t) {
    ...
    this.$thumb.style.left = `${e * 100}%`, this.$bar.style.width = `${e * 100}%`, (r = this.onChange) == null || r.call(this, this.value);
  }
  /** 拖动滑动条到特定的值 */
  drag(t) {
    var e;
...
const Te = () => d`
  <div
    class="${i}-slider ${i}-slider-vertical"
    style="position: relative; width: 100%; height: 100%"
  >
    <div
      class="${i}-slider-track"
    ...
    >
      ...
      ></div>
      <div class="${i}-slider-thumb-track" style="width: 0px">
        <div
          class="${i}-slider-thumb"
          style="position: absolute; transform: translate(-50%, -50%)"
        ></div>
...
class De {
  constructor({
    ...
    this.container = t, this.min = e, this.max = r, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = a, this.onDragStart = c, this.onDragEnd = o, this.onDrag = u, g(Te(), t), this.el = this.container.querySelector(`.${i}-slider`), this.$track = this.el.querySelector(`.${i}-slider-track`), this.$bar = this.$track.querySelector(`.${i}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${i}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${i}-slider-thumb`), this.el.addEventListener("mousedown", (p) => {
      var A;
      ...
      let h = L - (y - v - m);
      h = h >= L ? L : h <= 0 ? 0 : h;
      const $ = this.step ? Math.round(h / L * (this.max - this.min) / this.step) * this.step + this.min : h / L * (this.max - this.min) + this.min;
      (A = this.onDragStart) == null || A.call(this, $), this.value != $ && this.drag($);
      const x = (k) => {
        var D;
        const S = k, { clientY: T } = S;
        S.preventDefault(), S.stopPropagation();
        let b = L - (T - v - m);
        b = b >= L ? L : b <= 0 ? 0 : b;
        const P = this.step ? Math.round(b / L * (this.max - this.min) / this.step) * this.step + this.min : b / L * (this.max - this.min) + this.min;
        this.value != P && this.drag(P), (D = window.getSelection()) == null || D.removeAllRanges();
      }, w = (k) => {
        var T, b;
        k.stopPropagation(), (T = window.getSelection()) == null || T.removeAllRanges(), document.removeEventListener("mousemove", x), document.removeEventListener("mouseup", w), (b = this.onDragEnd) == null || b.call(this, $);
      };
  ...
  setValue(t) {
    ...
    const e = (this.value - this.min) / (this.max - this.min);
    this.$thumb.style.top = `${(1 - e) * 100}%`, this.$bar.style.height = `${Math.max(Math.min(e, 1), 0) * 100}%`, (r = this.onChange) == null || r.call(this, t);
  }
  /** 拖动滑动条到特定的值 */
  drag(t) {
    var e;
...
const qe = ({
  ...
  <ul class="${i}-picker">
    ${s.map(
  (e, r) => d`
        <li class="${i}-picker-item" data-value="${e.value}">
          ${(t == null ? void 0 : t(e, r)) || e.label || e.value}
        </li>
      `
)}
  </ul>
`;
class O {
  constructor({ container: t, value: e, onChange: r, onPick: n, list: l, template: a, condition: c }) {
    this.container = t, this.list = l, this.value = e ?? null, this.onChange = r, this.onPick = n, this.template = a, this.condition = c, this.reload();
  }
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(qe({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${i}-picker`), this.$items = this.el.querySelectorAll(`.${i}-picker-item`), this.$items.forEach((e) => {
  ...
  setValue(t) {
    ...
    this.$items.forEach((r, n) => {
      (this.condition ? this.condition(r.getAttribute("data-value"), t) : r.getAttribute("data-value") == t) ? r.classList.add("state-picked") : r.classList.remove("state-picked");
...
class He {
  ...
  constructor({ container: t, value: e = [], list: r, onChange: n, onToggle: l }) {
    this.container = t, this.list = r, this.valueSet = new Set(e), this.onChange = n, this.onToggle = l, this.reload();
  }
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(_e({ list: this.list, template: this.template }), this.container), this.el = this.container.querySelector(`.${i}-picker`), this.$items = this.el.querySelectorAll(`.${i}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
  ...
  setValue(t) {
    var e;
    this.valueSet = new Set(t), this.$items.forEach((r, n) => {
      this.valueSet.has(r.getAttribute("data-value")) ? r.classList.add("state-picked") : r.classList.remove("state-picked");
    }), (e = this.onChange) == null || e.call(this, t);
  }
  /** 切换一个选项的选择状态 */
  toggle(t, e) {
    var n, l;
    const r = e ?? !this.valueSet.has(t);
    r ? this.valueSet.add(t) : this.valueSet.delete(t), this.$items.forEach((a, c) => {
      a.getAttribute("data-value") == t && a.classList.toggle("state-picked", r);
    }), (n = this.onChange) == null || n.call(this, this.value), (l = this.onToggle) == null || l.call(this, t, r);
  }
}
const Be = ({ label: s }) => d`
  <div class="${i}-checkbox">
    <div class="${i}-checkbox-icon"></div>
    <div class="${i}-checkbox-label">${s}</div>
  </div>
`;
class rt {
  constructor({ container: t, value: e = !1, onChange: r, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = r, this.onToggle = n, this.label = l, g(Be({ label: this.label }), this.container), this.el = this.container.querySelector(`.${i}-checkbox`), this.el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
const Me = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-danmaku-settings"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-danmaku-settings"></i>
    </div>
    <div class="${i}-controller-panel-wrap">
      <div class="${i}-controller-panel ${i}-controller-panel-danmaku-settings">
        <div class="${i}-panel-row">
          <div class="${i}-row-label">弹幕类型屏蔽</div>
          <div class="${i}-danmaku-settings-filter-picker"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">不透明度</div>
          <div
            class="${i}-danmaku-settings-opacity-slider ${i}-slider-wrap"
          ></div>
          <div class="${i}-danmaku-settings-opacity-value ${i}-row-value"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">显示区域</div>
          <div class="${i}-danmaku-settings-area-slider ${i}-slider-wrap"></div>
          <div class="${i}-danmaku-settings-area-value ${i}-row-value"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">文字大小</div>
          <div class="${i}-danmaku-settings-size-slider ${i}-slider-wrap"></div>
          <div class="${i}-danmaku-settings-size-value ${i}-row-value"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">弹幕速度</div>
          <div
            class="${i}-danmaku-settings-speed-slider  ${i}-slider-wrap"
          ></div>
          <div class="${i}-danmaku-settings-speed-value ${i}-row-value"></div>
        </div>
      </div>
    </div>
  </div>
...
class We {
  constructor(t, e, r, n) {
    ...
    g(Me(r), l), this.el = l.querySelector(`.${i}-controller-button`), this.$iconWrap = this.el.querySelector(`.${i}-controller-icon-wrap`), this.$filterPicker = this.el.querySelector(`.${i}-danmaku-settings-filter-picker`), this.$opacitySlider = this.el.querySelector(`.${i}-danmaku-settings-opacity-slider`), this.$areaSlider = this.el.querySelector(`.${i}-danmaku-settings-area-slider`), this.$sizeSlider = this.el.querySelector(`.${i}-danmaku-settings-size-slider`), this.$speedSlider = this.el.querySelector(`.${i}-danmaku-settings-speed-slider`), this.$opacityValue = this.el.querySelector(`.${i}-danmaku-settings-opacity-value`), this.$areaValue = this.el.querySelector(`.${i}-danmaku-settings-area-value`), this.$sizeValue = this.el.querySelector(`.${i}-danmaku-settings-size-value`), this.$speedValue = this.el.querySelector(`.${i}-danmaku-settings-speed-value`), this.init(), e.appendChild(l);
  }
  init() {
    this.pickerFilter = new He({
      ...
      onToggle: (t, e) => {
        this.player.danmaku.filter(t, e);
      }
    }), this.sliderOpacity = new Z({
      ...
      value: 100,
      onDrag: (t) => {
        this.player.danmaku.setOpacity(t / 100);
      },
      onChange: (t) => {
        this.$opacityValue.innerText = `${t}%`;
      }
    }), this.sliderArea = new Z({
      ...
      onDrag: (t) => {
        const e = t / 8;
        this.player.danmaku.setArea(e == 9 ? 0 : e);
      },
      onChange: (t) => {
        this.$areaValue.innerText = t < 8 ? `${t / 8}` : t == 8 ? "不重叠" : "无限";
      }
    }), this.sliderSize = new Z({
      ...
      value: 100,
      onDrag: (t) => {
        this.player.danmaku.setScale(t / 100);
      },
      onChange: (t) => {
        this.$sizeValue.innerText = `${t}%`;
      }
    }), this.sliderSpeed = new Z({
      ...
      divider: 5,
      onDrag: (t) => {
        this.player.danmaku.setSpeed(t / 100);
      },
      onChange: (t) => {
...
const Ie = () => d`
  <div class="${i}-controller-button ${i}-controller-danmaku-style">
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-text"></i>
    </div>
    <div class="${i}-controller-panel-wrap">
      <div class="${i}-controller-panel ${i}-controller-panel-danmaku-style">
        <div class="${i}-panel-row">
          <div class="${i}-row-label">字号</div>
          <div class="${i}-danmaku-style-fontsize-picker"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">模式</div>
          <div class="${i}-danmaku-style-mode-picker"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">颜色</div>
          <input class="${i}-danmaku-style-color-input mp-input" type="text" value="#" />
          <div class="${i}-danmaku-style-color-preview"></div>
          ${EyeDropper ? d`<button class="${i}-danmaku-style-color-dropper mp-button">
                拾取
              </button>` : ""}
        </div>
        <div class="${i}-danmaku-style-color-picker"></div>
      </div>
    </div>
  </div>
`;
class Re {
  constructor(t, e, r) {
    this.danmakuBar = t, this.player = t.player;
    const n = new DocumentFragment();
    g(Ie(), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = this.el.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = this.el.querySelector(`.${i}-tooltip`), this.$fontsizePicker = this.el.querySelector(`.${i}-danmaku-style-fontsize-picker`), this.$modePicker = this.el.querySelector(`.${i}-danmaku-style-mode-picker`), this.$colorPicker = this.el.querySelector(`.${i}-danmaku-style-color-picker`), this.$colorInput = this.el.querySelector(`.${i}-danmaku-style-color-input`), this.$colorPreview = this.el.querySelector(`.${i}-danmaku-style-color-preview`), this.$colorDropper = this.el.querySelector(`.${i}-danmaku-style-color-dropper`), this.init(r), e.appendChild(n);
  }
  init(t) {
    var e, r;
    this.pickerFontsize = new O({
      container: this.$fontsizePicker,
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || Ne).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || Ve).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
        this.danmakuBar.danmakuMode = Number(n) || 1;
      }
    }), this.pickerColor = new O({
      container: this.$colorPicker,
      value: "#FFFFFF",
      list: (((r = t.danmakuBar) == null ? void 0 : r.colorList) || ze).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = Wt(n);
      },
      onChange: (n) => {
        this.$colorInput.value = n, this.$colorPreview.style.backgroundColor = n;
      },
      template: (n) => d` <div style="background-color: ${n.value}"></div> `,
      ...
      EyeDropper && new EyeDropper().open().then(({ sRGBHex: l }) => {
...
const Ne = [
  ...
  <div class="${i}-danmakubar">
    <div class="${i}-danmakubar-slot"></div>
    <div class="${i}-danmakubar-input-wrap">
      <div class="${i}-danmakubar-input-slot"></div>
      <input type="text" autocompleted="new-password" class="${i}-danmakubar-input" />
      <!-- 
      <div class="${i}-danmakubar-status-loading">弹幕功能加载中...</div>
      <div class="${i}-danmakubar-status-login">需要登录后才能发送弹幕哦~</div>
      -->
      <div class="${i}-danmakubar-send">发送</div>
    </div>
  </div>
`;
class Ue {
  constructor(t, e) {
    var n;
    this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.player = t, this.controller = t.controller;
    const r = this.player.template.$footbar;
    g(Oe, r), this.el = r.querySelector(`.${i}-danmakubar`), this.$send = this.el.querySelector(`.${i}-danmakubar-send`), this.$input = this.el.querySelector(`.${i}-danmakubar-input`), this.$slot = this.el.querySelector(`.${i}-danmakubar-slot`), this.$inputSlot = this.el.querySelector(`.${i}-danmakubar-input-slot`), this.buttonDanmakuSwitch = new Ae(this.player, this.$slot), this.buttonDanmakuSettings = new We(this.player, this.$slot), this.buttonDanmakuStyle = new Re(this, this.$inputSlot, e), this.player.on("fullscreen", () => {
      ...
      l.keyCode == H.Enter && this.send();
    }), this.$send.onclick = () => {
      this.send();
    }, this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || je);
  }
  moveToFootbar() {
    this.player.template.$footbar.appendChild(this.el), this.controller.$center.classList.remove("state-bar");
  }
  moveToController() {
  ...
  /** 执行弹幕发送操作 */
  send() {
    !this.$input.value.trim() || this.coolDownTimer || (this.player.danmaku.operate.send(this.generateDanmaku()), this.$input.value = "");
  }
  /** 设置弹幕发送冷却 */
  setCoolDown(t) {
...
const je = "发条弹幕吧~", Xe = "danmakuBar", Ke = () => {
  let s;
  return {
    name: Xe,
    create: (t, e) => (s = new Ue(t, e), s)
  };
};
class Ye {
  constructor({
  ...
  render(t, e) {
    const r = this.renderStart, n = this.renderEnd;
    if (this.renderStart = this.getViewStart(e) - this.overflow, this.renderEnd = this.getViewEnd(e, t) + this.overflow, this.renderStart < r) {
      const l = document.createDocumentFragment(), a = Math.max(this.renderStart, 0), c = Math.min(r - 1, this.renderEnd, this.data.length - 1);
      for (let o = a; o <= c; o++)
        l.appendChild(this.createItem(this.data[o], o, this.data));
      this.$content.insertBefore(l, this.$content.firstElementChild);
    } else {
      const l = Math.max(r, 0), a = Math.min(this.renderStart - 1, n);
      for (let c = l; c <= a; c++) {
    ...
    if (this.renderEnd > n) {
      const l = document.createDocumentFragment(), a = Math.max(n + 1, this.renderStart), c = Math.min(this.renderEnd, this.data.length - 1);
      for (let o = a; o <= c; o++)
        l.appendChild(this.createItem(this.data[o], o, this.data));
      this.$content.appendChild(l);
    } else {
      const l = Math.min(n, this.data.length - 1), a = Math.max(this.renderEnd + 1, r);
      for (let c = l; c >= a; c--) {
...
const Qe = (s) => d`
  <div class="${i}-side-panel ${i}-danmaku-list">
    <div class="${i}-danmaku-list-main">
      <div class="${i}-danmaku-list-head">
        <div class="list-column col-time" @click=${s.time}>时间</div>
        <div class="list-column col-content" @click=${s.content}>弹幕内容</div>
        <div class="list-column col-date" @click=${s.date}>发送时间</div>
      </div>
      <div class="${i}-danmaku-list-container">
        <div class="${i}-danmaku-list-list"></div>
      </div>
      <div class="${i}-danmaku-list-status">
    ...
    <div class="${i}-danmaku-list-foot">
      <div class="${i}-danmaku-list-foot-left">
        <span class="${i}-danmaku-list-autoscroll">列表滚动[关]</span>
      </div>
      <div class="${i}-danmaku-list-foot-right"></div>
    </div>
  </div>
`, Ze = (s, t, e) => {
  const r = d`
    <div class="list-row" data-index="${t}" data-mode="${s.mode}">
      <div class="list-cell col-time">${z(s.time)}</div>
      <div class="list-cell col-content">${s.content}</div>
      <div class="list-cell col-date">
        ${s.date ? Rt(new Date(s.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
      ${e.length ? d` <div class="list-operate">
            ${e(s).map(
    ([l, a]) => d`<div
  ...
  return g(r, n), n.firstElementChild;
};
class Ge {
  constructor(t) {
    this.data = [], this.sortedBy = "time", this.sortOrder = -1, this.autoScroll = !0, this.frozen = !0, this.mounted = !1, this.player = t;
    const e = new DocumentFragment();
    g(Qe({ time: () => {
    }, content: () => {
    }, date: () => {
    } }), e), this.el = e.querySelector(`.${i}-danmaku-list`), this.$container = e.querySelector(`.${i}-danmaku-list-container`), this.$status = e.querySelector(`.${i}-danmaku-list-status`), this.$colTime = e.querySelector(".col-time"), this.$colDate = e.querySelector(".col-date"), this.$colContent = e.querySelector(".col-content"), this.$autoScroll = e.querySelector(`.${i}-danmaku-list-autoscroll`), this.$colTime.onclick = () => {
    ...
    }, this.player.on("change:danmaku_list_auto_scroll", (r) => {
      r ? this.$autoScroll.innerText = "列表滚动[开]" : this.$autoScroll.innerText = "列表滚动[关]";
    }), this.autoScroll && this.player.events.trigger("change:danmaku_list_auto_scroll", !0);
  }
  init() {
    ...
    this.list = new Ye({
      ...
      getData: () => this.data,
      itemHeight: 24,
      createItem: (n, l) => Ze(n, l, (a) => {
        const c = a.user == this.player.userId;
        return [
          [
            "举报",
            (o) => {
  ...
  /** 弹幕列表排序 */
  sort(t, e = 1) {
    this.sortedBy = t, this.sortOrder = e, this.data.sort((r, n) => {
      const l = r[this.sortedBy], a = n[this.sortedBy];
      return l > a ? e : l == a ? 0 : -e;
    }), this.list.reload();
  }
  /** 装填弹幕(重载列表) */
  fill(t) {
  ...
  locateByTime(t) {
    ...
    for (((r = this.data[e]) == null ? void 0 : r.time) > t && (e = 0); ((n = this.data[e + 1]) == null ? void 0 : n.time) <= t; )
      e++;
    this.list.locateEnd(e);
  }
  setAutoScroll(t) {
    this.player.events.trigger("change:danmaku_list_auto_scroll", t), this.autoScroll = t, t && (this.sort("time"), this.locateByTime(this.player.time), this.list.handleScroll());
  }
}
const Je = "danmakuList", Ce = () => {
  let s;
  return {
    name: Je,
    create: (t) => (s = new Ge(t), s),
    init: () => {
      s.init();
    }
  };
  ...
  <div
    class="${i}-controller-button ${i}-controller-play state-paused"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-play"></i>
      <i class="${i}-controller-icon mp-icon-pause"></i>
    </div>
    <div class="${i}-tooltip">播放</div>
  </div>
`;
class es {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(ts(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("pause", () => {
      this.el.classList.add("state-paused"), this.$tooltip.innerText = "播放";
    }), this.player.on("play", () => {
      this.el.classList.remove("state-paused"), this.$tooltip.innerText = "暂停";
    }), this.player.on("part", () => {
      this.el.classList.add("state-paused"), this.$tooltip.innerText = "播放";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.toggle();
...
const ss = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-prev"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-prev"></i>
    </div>
    <div class="${i}-tooltip">上一P</div>
  </div>
`;
class is {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(ss(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("part", (t) => {
      t > 1 ? this.el.classList.remove("state-firstpart") : this.el.classList.add("state-firstpart");
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.prev();
    });
  }
...
const rs = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-next"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-next"></i>
    </div>
    <div class="${i}-tooltip">下一P</div>
  </div>
`;
class ns {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(rs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("part", (t) => {
      t < this.player.video.list.length ? this.el.classList.remove("state-lastpart") : this.el.classList.add("state-lastpart");
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.next();
    });
  }
...
const ls = (s) => d`
  <div class="${i}-controller-time" style="${s ? `order: ${s}` : ""}">
    <div class="${i}-controller-time-label">
      <span class="${i}-controller-time-current">00:00</span>
      <span>/</span>
      <span class="${i}-controller-time-total">00:00</span>
    </div>
    <input class="${i}-controller-time-input mp-input" />
  </div>
`;
class as {
  constructor(t, e, r) {
    this.valueBeforeEdited = "", this.player = t;
    const n = new DocumentFragment();
    g(ls(r), n), this.el = n.querySelector(`.${i}-controller-time`), this.$label = n.querySelector(`.${i}-controller-time-label`), this.$current = n.querySelector(`.${i}-controller-time-current`), this.$total = n.querySelector(`.${i}-controller-time-total`), this.$input = n.querySelector(`.${i}-controller-time-input`), this.init(), e.appendChild(n);
  }
  init() {
...
const os = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-loop"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-loop"></i>
      <i class="${i}-controller-icon mp-icon-loop-off"></i>
    </div>
    <div class="${i}-tooltip">洗脑循环</div>
  </div>
`;
class cs {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(os(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("change:loop", (t) => {
      this.el.classList.toggle("state-loop", t), this.$tooltip.innerText = t ? "关闭洗脑循环" : "洗脑循环";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.video.loop ? this.player.video.setLoop(!1) : this.player.video.setLoop(!0);
    });
  }
}
const hs = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-part"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <div class="${i}-controller-texticon">P0</div>
    </div>
    <div class="${i}-tooltip">分P列表</div>
  </div>
`;
class ds {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(hs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.$texticon = n.querySelector(`.${i}-controller-texticon`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.video.list.length < 2 && this.el.classList.add("state-singlepart"), this.$iconWrap.addEventListener("click", () => {
      this.player.side.toggle("partlist");
    }), this.player.on("part", (t) => {
      this.$texticon.innerText = `P${t}`;
    });
  }
}
const us = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-volume"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-volume"></i>
      <i class="${i}-controller-icon mp-icon-volume-off"></i>
    </div>

    <div class="${i}-controller-panel-wrap">
      <div class="${i}-controller-panel">
        <div class="${i}-controller-volume-text">0</div>
        <div class="${i}-controller-volume-slider"></div>
      </div>
    </div>
  </div>
`;
class ps {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(us(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$slider = n.querySelector(`.${i}-controller-volume-slider`), this.$text = n.querySelector(`.${i}-controller-volume-text`), this.init(), e.appendChild(n);
  }
  init() {
    this.slider = new De({
      ...
      onChange: (t) => {
        this.$text.innerText = t.toString();
      },
      onDrag: (t) => {
        this.player.setVolume(t / 100);
      },
      onDragStart: (t) => {
        this.player.video.el.muted && t != 0 && this.player.mute(!1), this.el.classList.add("state-control"), this.player.controller.setControl(!0);
      },
      onDragEnd: () => {
        this.el.classList.remove("state-control"), this.player.controller.setControl(!1);
      }
      ...
      this.player.video.el.muted || this.player.video.el.volume == 0 ? (this.player.video.el.volume == 0 && (this.player.video.el.volume = 0.1), this.player.mute(!1)) : this.player.mute(!0);
    });
  }
}
const ms = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-settings"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-settings"></i>
    </div>
    <div class="${i}-controller-panel-wrap">
      <div class="${i}-controller-panel ${i}-controller-panel-settings">
        <div class="${i}-panel-row">
          <div class="${i}-row-label">播放倍速</div>
          <div class="${i}-settings-rate-picker"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">视频比例</div>
          <div class="${i}-settings-scale-picker"></div>
        </div>
        <div class="${i}-panel-row">
          <div class="${i}-row-label">其他设置</div>
        </div>
        <div class="${i}-panel-row ${i}-settings-others">
          <div class="${i}-settings-solid-checkbox"></div>
          <div class="${i}-settings-showPrevButton-checkbox"></div>
        </div>
      </div>
    </div>
  </div>
...
class vs {
  constructor(t, e, r, n) {
    this.player = t;
    const l = new DocumentFragment();
    g(ms(r), l), this.el = l.querySelector(`.${i}-controller-button`), this.$iconWrap = this.el.querySelector(`.${i}-controller-icon-wrap`), this.$ratePicker = this.el.querySelector(`.${i}-settings-rate-picker`), this.$scalePicker = this.el.querySelector(`.${i}-settings-scale-picker`), this.$solidCheckbox = this.el.querySelector(`.${i}-settings-solid-checkbox`), this.$showPrevButtonCheckbox = this.el.querySelector(
      `.${i}-settings-showPrevButton-checkbox`
    ), this.$others = this.el.querySelector(`.${i}-settings-others`), this.init(n), e.appendChild(l);
  }
  init(t) {
    var e;
    this.pickerRate = new O({
      ...
      value: 1,
      onPick: (r) => {
        this.player.setPlaybackRate(Number(r));
      }
    }), this.player.on("ratechange", (r) => {
      this.pickerRate.setValue(r);
    }), this.pickerScale = new O({
      container: this.$scalePicker,
      list: [{ value: "", label: "自动" }, { value: "16:9" }, { value: "4:3" }],
      value: "",
      onPick: (r) => {
        this.player.video.setRatio(
          r ? r.split(":").map((n) => Number(n)) : null
        );
      }
    }), this.player.on("change:aspectRatio", (r) => {
      this.pickerRate.setValue(r ? r.join(":") : "");
    }), (e = t.feature) != null && e.solid && (this.checkboxSolid = new rt({
      container: this.$solidCheckbox,
      label: "固定控制栏",
      onToggle: (r) => {
        this.player.mode.solid(r);
      }
    })), this.checkboxShowPrevButton = new rt({
      container: this.$showPrevButtonCheckbox,
      label: "显示上一P按钮（多P下生效）",
      onToggle: (r) => {
        var n;
        (n = this.player.plugin.buttonPrev) == null || n.show(r);
      }
    });
  }
}
const $s = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-pip"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-pip"></i>
      <i class="${i}-controller-icon mp-icon-pip-exit"></i>
    </div>
    <div class="${i}-tooltip">画中画</div>
  </div>
`;
class gs {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g($s(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("pip", () => {
      this.el.classList.add("state-pip"), this.$tooltip.innerText = "退出画中画";
    }), this.player.on("pip_exit", () => {
      this.el.classList.remove("state-pip"), this.$tooltip.innerText = "画中画";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.isPip ? this.player.exitPip() : this.player.pip();
    });
  }
}
const fs = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-webfull"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-webfull"></i>
      <i class="${i}-controller-icon mp-icon-webfull-exit"></i>
    </div>
    <div class="${i}-tooltip">网页全屏</div>
  </div>
`;
class ys {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(fs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("webfull", () => {
      this.el.classList.add("state-webfull"), this.$tooltip.innerText = "退出网页全屏";
    }), this.player.on("webfull_exit", () => {
      this.el.classList.remove("state-webfull"), this.$tooltip.innerText = "网页全屏";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.isWebfull ? this.player.exitWebfull() : this.player.webfull();
    });
  }
}
const bs = (s) => d`
  <div
    class="${i}-controller-button ${i}-controller-fullscreen"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-fullscreen"></i>
      <i class="${i}-controller-icon mp-icon-fullscreen-exit"></i>
    </div>
    <div class="${i}-tooltip">进入全屏</div>
  </div>
`;
class ws {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(bs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("fullscreen", () => {
      this.el.classList.add("state-fullscreen"), this.$tooltip.innerText = "退出全屏";
    }), this.player.on("fullscreen_exit", () => {
      this.el.classList.remove("state-fullscreen"), this.$tooltip.innerText = "进入全屏";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.isFullscreen ? this.player.exitFullscreen() : this.player.fullscreen();
    });
  }
}
const ks = () => ({
  name: "buttonPlay",
  create: (s) => new es(s, s.controller.$left, 1)
}), Ss = () => ({
  name: "buttonPrev",
  create: (s) => new is(s, s.controller.$left, 0),
  init: (s) => {
    s.plugin.buttonPrev.show(!1);
  }
}), xs = () => ({
  name: "buttonNext",
  create: (s) => new ns(s, s.controller.$left, 2)
}), Ls = () => ({
  name: "labelTime",
  create: (s) => new as(s, s.controller.$left, 3)
}), Es = () => ({
  name: "buttonLoop",
  create: (s) => new cs(s, s.controller.$left, 4)
}), Ps = () => ({
  name: "buttonPart",
  create: (s) => new ds(s, s.controller.$right, 0)
}), As = () => ({
  name: "buttonVolume",
  create: (s) => new ps(s, s.controller.$right, 1)
}), Fs = () => ({
  name: "buttonSettings",
  create: (s, t) => new vs(s, s.controller.$right, 2, t)
}), Ts = () => ({
  name: "buttonPip",
  create: (s) => Mt ? new gs(s, s.controller.$right, 7) : {}
}), Ds = () => ({
  name: "buttonWebfull",
  create: (s, t) => {
    var e;
    return (e = t.feature) != null && e.webfull ? new ys(s, s.controller.$right, 9) : {};
  }
}), qs = () => ({
  name: "buttonFullscreen",
  create: (s) => Bt ? new ws(s, s.controller.$right, 10) : {}
}), _s = () => [
  Ss(),
  ks(),
  xs(),
  ...
  <div
    class="${i}-controller-button ${i}-controller-wide"
    style="${s ? `order: ${s}` : ""}"
  >
    <div class="${i}-controller-icon-wrap">
      <i class="${i}-controller-icon mp-icon-wide"></i>
      <i class="${i}-controller-icon mp-icon-wide-exit"></i>
    </div>
    <div class="${i}-tooltip">宽屏模式</div>
  </div>
`;
class Bs {
  constructor(t, e, r) {
    this.player = t;
    const n = new DocumentFragment();
    g(Hs(r), n), this.el = n.querySelector(`.${i}-controller-button`), this.$iconWrap = n.querySelector(`.${i}-controller-icon-wrap`), this.$tooltip = n.querySelector(`.${i}-tooltip`), this.init(), e.appendChild(n);
  }
  init() {
    this.player.on("wide", () => {
      this.el.classList.add("state-wide"), this.$tooltip.innerText = "退出宽屏模式";
    }), this.player.on("wide_exit", () => {
      this.el.classList.remove("state-wide"), this.$tooltip.innerText = "宽屏模式";
    }), this.$iconWrap.addEventListener("click", () => {
      this.player.plugin.wide.status ? this.player.plugin.wide.exit() : this.player.plugin.wide.enter();
    });
  }
}
const Ms = "wide", Ws = () => {
  ...
  return {
    ...
    create: (e, r) => {
      var l;
      s = new Bs(e, e.controller.$right, 8);
      const n = {
        button: s,
        enter: () => {
          e.template.el.classList.add("mode-wide"), e.events.trigger("wide"), t = !0;
        },
        exit: () => {
          e.template.el.classList.remove("mode-wide"), e.events.trigger("wide_exit"), t = !1;
        },
        get status() {
          return t;
        }
      };
      return (l = r.mode) != null && l.wide && n.enter(), n;
    }
  };
};
const Is = "blackBorder", Rs = ({ padding: s }) => ({
  name: Is,
  create: (t) => {
    ...
    const r = {
      toggle: (n) => {
        e = n, n ? t.template.$videoWrap.style.setProperty("--padding", s) : t.template.$videoWrap.style.setProperty("--padding", ""), t.events.trigger("change:black_border", n), t.events.trigger("setting", "blackBorder", n);
      },
      get value() {
        return e;
      }
    };
    if (t.plugin.buttonSettings) {
      ...
      new rt({
        ...
        label: "隐藏黑边"
      }), t.plugin.buttonSettings.$others.appendChild(n);
    }
    return r;
  }
}), Ns = () => [
