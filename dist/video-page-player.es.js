...
const j = (i, t) => Array.from({ length: i }, () => t), ge = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, fe = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, ye = document.pictureInPictureEnabled, ct = (i) => {
...
}, be = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), ke = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, nt = {
...
), a = "mfuns-player", we = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", xe = [
...
class Se {
  constructor(t, e) {
    ...
    ), this.loader = new ve(this), this.setRatio(e.aspectRatio || null), this.attachEvent(this.$video), this.initKeepRatio(), this.player.on("play", () => {
...
class Te {
  constructor(t, e) {
    this.player = t, this.webfull = new Ee(this.player), this.fullscreen = new Le(this.player), this.pip = new _e(this.player), this.init();
  }
  init() {
...
class R {
  constructor(t) {
    this.event = new $e(), this.hook = new Pe(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = H("div", { class: a }), this.$main = this.$el.appendChild(H("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(H("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      H("div", { class: `${a}-content` })
    ), this.pluginManager = new me(this), this.video = new Se(this, t), this.sizing = new Te(this, t), this.state = new Ae(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
 ...
 */
var at;
const tt = window, O = tt.trustedTypes, ut = O ? O.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ot = "$lit$", M = `lit$${(Math.random() + "").slice(9)}$`, St = "?" + M, Fe = `<${St}>`, V = document, K = () => V.createComment(""), Y = (i) => i === null || typeof i != "object" && typeof i != "function", Lt = Array.isArray, De = (i) => Lt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pt = /-->/g, mt = />/g, N = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), $t = /'/g, vt = /"/g, _t = /^(?:script|style|textarea|title)$/i, He = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), u = He(1), Q = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), gt = /* @__PURE__ */ new WeakMap(), I = V.createTreeWalker(V, 129, null, !1);
function Et(i, t) {
...
const qe = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const o = i[h];
    let c, p, f = -1, y = 0;
    for (; y < o.length && (r.lastIndex = y, p = r.exec(o), p !== null); )
      y = r.lastIndex, r === U ? p[1] === "!--" ? r = pt : p[1] !== void 0 ? r = mt : p[2] !== void 0 ? (_t.test(p[2]) && (n = RegExp("</" + p[2], "g")), r = N) : p[3] !== void 0 && (r = N) : r === N ? p[0] === ">" ? (r = n ?? U, f = -1) : p[1] === void 0 ? f = -2 : (f = r.lastIndex - p[2].length, c = p[1], r = p[3] === void 0 ? N : p[3] === '"' ? vt : $t) : r === vt || r === $t ? r = N : r === pt || r === mt ? r = U : (r = N, n = void 0);
    const _ = r === N && i[h + 1].startsWith("/>") ? " " : "";
    l += r === U ? o + Fe : f >= 0 ? (s.push(c), o.slice(0, f) + ot + o.slice(f) + M + _) : o + M + (f === -2 ? (s.push(void 0), h) : _);
  }
...
class G {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const h = t.length - 1, o = this.parts, [c, p] = qe(t, e);
    if (this.el = G.createElement(c, s), I.currentNode = this.el.content, e === 2) {
      const f = this.el.content, y = f.firstChild;
      y.remove(), f.append(...y.childNodes);
    }
    for (; (n = I.nextNode()) !== null && o.length < h; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const f = [];
          for (const y of n.getAttributeNames())
            if (y.endsWith(ot) || y.startsWith(M)) {
              ...
              if (f.push(y), _ !== void 0) {
                ...
                o.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? Ne : m[1] === "?" ? Ie : m[1] === "@" ? Re : et });
              } else
        ...
        if (_t.test(n.tagName)) {
          ...
          if (y > 0) {
            ...
            for (let _ = 0; _ < y; _++)
              n.append(f[_], K()), I.nextNode(), o.push({ type: 2, index: ++l });
            n.append(f[y], K());
          }
        }
...
class Me {
  ...
  u(t) {
    ...
    I.currentNode = l;
    let r = I.nextNode(), h = 0, o = 0, c = n[0];
    for (; c !== void 0; ) {
      if (h === c.index) {
        let p;
        c.type === 2 ? p = new Z(r, r.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(r, c.name, c.strings, this, t) : c.type === 6 && (p = new Ve(r, this, t)), this._$AV.push(p), c = n[++o];
      }
      h !== (c == null ? void 0 : c.index) && (r = I.nextNode(), h++);
    }
    return I.currentNode = V, l;
  }
  v(t) {
    let e = 0;
...
class Z {
  ...
  _$AI(t, e = this) {
    t = W(this, t, e), Y(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== Q && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : De(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, l = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = G.createElement(Et(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      this._$AH.v(s);
    else {
      const r = new Me(l, this), h = r.u(this.options);
      r.v(s), this.$(h), this._$AH = r;
    }
  }
  _$AC(t) {
    let e = gt.get(t.strings);
    return e === void 0 && gt.set(t.strings, e = new G(t)), e;
  }
  T(t) {
  ...
  _$AI(t, e = this, s, n) {
    ...
    if (l === void 0)
      ...
      for (t = l[0], o = 0; o < l.length - 1; o++)
        c = W(this, h[s + o], e, o), c === Q && (c = this._$AH[o]), r || (r = !Y(c) || c !== this._$AH[o]), c === P ? t = P : t !== P && (t += (c ?? "") + l[o + 1]), this._$AH[o] = c;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Be = O ? O.emptyScript : "";
class Ie extends et {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== P ? this.element.setAttribute(this.name, Be) : this.element.removeAttribute(this.name);
  }
}
class Re extends et {
  constructor(t, e, s, n, l) {
...
ft == null || ft(G, Z), ((at = tt.litHtmlVersions) !== null && at !== void 0 ? at : tt.litHtmlVersions = []).push("2.8.0");
const v = (i, t, e) => {
  var s, n;
...
class D extends E {
  constructor(t, e, {
    ...
    this.container = (c = (h == null ? void 0 : h.container) || n.container) == null ? void 0 : c(t), this.order = (h == null ? void 0 : h.order) || n.order, this.$el = l, this.$el.style.order = (this.order || "").toString(), !r && ((p = this.container) == null || p.append(this.$el));
  }
  $(t) {
  ...
  created() {
    ...
    this.list = new ze({
      ...
      createItem: (l, r) => We(l, r, {
        ...
        title: (h) => `${h.content}
${l.date ? xt(new Date(l.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${z(l.time, !1)}`
      }),
      overflow: 5
    });
    const s = wt(() => {
    ...
    <div class="${a}-slider-thumb-track" style="height: 0px">
      ...
      ${i ? u`
            <div class="${a}-slider-divider">
              ${j(i, u`<div class="${a}-slider-divider-dot"></div>`)}
            </div>
          ` : ""}
    </div>
  </div>
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = h, this.onDragStart = o, this.onDragEnd = c, this.onDrag = p, v(Ue({ divider: this.divider }), t), this.$el = this.container.querySelector(`.${a}-slider`), this.$track = this.$el.querySelector(`.${a}-slider-track`), this.$bar = this.$track.querySelector(`.${a}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${a}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${a}-slider-thumb`), this.$el.addEventListener("mousedown", (f) => {
      ...
      const k = (x) => {
        ...
        var b, T;
        x.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (T = this.onDragEnd) == null || T.call(this, S);
      };
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = r, this.onDragStart = h, this.onDragEnd = o, this.onDrag = c, v(je(), t), this.$el = this.container.querySelector(`.${a}-slider`), this.$track = this.$el.querySelector(`.${a}-slider-track`), this.$bar = this.$track.querySelector(`.${a}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${a}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${a}-slider-thumb`), this.$el.addEventListener("mousedown", (p) => {
      ...
      const S = (w) => {
        ...
        var F, b;
        w.stopPropagation(), (F = window.getSelection()) == null || F.removeAllRanges(), document.removeEventListener("mousemove", S), document.removeEventListener("mouseup", k), (b = this.onDragEnd) == null || b.call(this, g);
      };
...
class X {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    v(Ke({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
...
class Qe {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    v(Ye({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
class it {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, v(Ge({ label: this.label }), this.container), this.$el = this.container.querySelector(`.${a}-checkbox`), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class Je {
  ...
  init(t) {
    ...
    this.pickerFontsize = new X({
      ...
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || Ce).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || ts).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
      ...
      value: "#FFFFFF",
      list: (((s = t.danmakuBar) == null ? void 0 : s.colorList) || es).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = be(n);
      },
      onChange: (n) => {
...
class At extends E {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.player.plugin.controller, this.danmaku = this.player.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      ...
      this.send();
    }, this.setPlaceHolder(((s = e.danmakuBar) == null ? void 0 : s.placeholder) || is);
  }
  moveToWrap() {
        ...
        for (let g = 0; this.overlap || g < l; g++) {
          ...
          if (this.danmakuTracks[$][g] = S, k && k.length) {
            if ($ === "roll") {
              ...
              for (const w of k) {
                const x = r(w) - 10;
                if (this.trackHeights[$][g] = parseInt(w.style.fontSize) + this.trackPadding, x <= s - A * o(w.getBoundingClientRect().width) || x <= 0)
                  continue t;
              }
            } else if ($ === "reverse") {
              const A = s / o(d);
            ...
            return this.danmakuTracks[$][g].push(m), m.addEventListener("animationend", () => {
              ...
              A && ((x = this.danmakuTracks[$][g]) == null || x.splice(A, 1));
            }), g;
          } else
...
`)}`, typeof $.color == "number" ? d.style.color = ke($.color) : d.style.color = $.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +$.size * this.fontScale + "px", d.addEventListener("animationend", () => {
      ...
      switch (S) {
        case "roll":
        case "reverse":
          if (A = p(d, S, g), k = A % l, k >= 0) {
            const w = this.trackHeights[S].slice(0, l).reduce((T, q) => T + q, 0), x = this.trackHeights[S].slice(0, k).reduce((T, q) => T + q, 0) % w;
            if (x + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (y = this.danmakuTracks[S][m]) == null || y.pop();
              return;
            }
            const F = o(g), b = g + s + this.startDistance * 2;
            d.dataset.track = A.toString(), d.style.width = g + 1 + "px", d.style.top = x + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${b / F}s`), d.style.setProperty("--offset", `${s + this.startDistance}px`), d.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = p(d, S, 0) % l, k >= 0) {
            ...
            for (const b of x)
              w.push(...b);
            const F = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, T) => b + T, 0);
            if (F + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (_ = this.danmakuTracks[S][m]) == null || _.pop();
              return;
            }
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.top = F + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (S = "bottom", k = p(d, S, 0) % l, k >= 0) {
            ...
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.bottom = F + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of r)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = o.left - c.left, f = o.right - c.left, y = o.top - c.top, _ = o.bottom - c.top;
        if (t >= p - s && t <= f + s && e >= y - s && e <= _ + s && (l.push(h), n))
          return l;
      }
    return l;
  }
...
class Pt extends E {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.format = ((s = e.danmaku) == null ? void 0 : s.format) || "mfuns", this.parser = new rs({ defaultParser: this.format }), this.operate = new os(this.player), this.api = e.apis || {}, this.allowNewDanmaku = !1, this.$el = H("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      H("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new as(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
...
const ws = () => u`
  <div class="${a}-about">
    ...
    <div>github：<a href="${we}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者：</div>
...
class Kt extends E {
  constructor(t) {
    ...
    this.container = H("div", { class: `${a}-contextmenu-wrap` }), v(Ss(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
...
te.pluginName = "side";
const Ds = [Ct], Hs = [Gt, te, Yt, Jt, Qt, Kt], qs = [
  Zt,
  Dt,
  Ht,
  qt,
...
class ue extends E {
  constructor(t, e) {
    super(t), this.$el = H("div", { class: `${a}-videostatus` }), v(zs, this.$el), this.$paused = this.$el.querySelector(`.${a}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${a}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
ue.pluginName = "videoStatus";
const Os = u`
...
class pe extends E {
  constructor(t, e) {
    var s, n;
    super(t), this.$el = H("div", { class: `${a}-loadingmask` }), v(Os, this.$el), this.$info = this.$el.querySelector(`.${a}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${a}-loadingmask-tips`), this.getTips = (s = e.loadingMask) == null ? void 0 : s.getTips, this.delay = ((n = e.loadingMask) == null ? void 0 : n.delay) || 0, this.player.$main.appendChild(this.$el);
  }
  created() {
