...
const Fe = (i, t) => {
  ...
  return s;
}, Tt = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), At = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, Ie = () => {
  let i = 100;
  return function(t) {
  ...
  throttle: Fe,
  timeToSecond: ht
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Ve = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", Oe = [
 ...
 */
var lt;
const et = window, j = et.trustedTypes, $t = j ? j.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ct = "$lit$", N = `lit$${(Math.random() + "").slice(9)}$`, Pt = "?" + N, je = `<${Pt}>`, O = document, Q = () => O.createComment(""), Z = (i) => i === null || typeof i != "object" && typeof i != "function", Ft = Array.isArray, Xe = (i) => Ft(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", rt = `[ 	
\f\r]`, Y = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, vt = /-->/g, gt = />/g, I = RegExp(`>|${rt}(?:([^\\s"'>=/]+)(${rt}*=${rt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ft = /'/g, yt = /"/g, Dt = /^(?:script|style|textarea|title)$/i, Ye = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), u = Ye(1), G = Symbol.for("lit-noChange"), F = Symbol.for("lit-nothing"), bt = /* @__PURE__ */ new WeakMap(), R = O.createTreeWalker(O, 129, null, !1);
function Ht(i, t) {
...
const Ke = (i, t) => {
  ...
  for (let o = 0; o < e; o++) {
    ...
    for (; y < h.length && (r.lastIndex = y, p = r.exec(h), p !== null); )
      y = r.lastIndex, r === Y ? p[1] === "!--" ? r = vt : p[1] !== void 0 ? r = gt : p[2] !== void 0 ? (Dt.test(p[2]) && (n = RegExp("</" + p[2], "g")), r = I) : p[3] !== void 0 && (r = I) : r === I ? p[0] === ">" ? (r = n ?? Y, g = -1) : p[1] === void 0 ? g = -2 : (g = r.lastIndex - p[2].length, c = p[1], r = p[3] === void 0 ? I : p[3] === '"' ? yt : ft) : r === yt || r === ft ? r = I : r === vt || r === gt ? r = Y : (r = I, n = void 0);
    const E = r === I && i[o + 1].startsWith("/>") ? " " : "";
    l += r === Y ? h + je : g >= 0 ? (s.push(c), h.slice(0, g) + ct + h.slice(g) + N + E) : h + N + (g === -2 ? (s.push(void 0), o) : E);
  }
...
class J {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const o = t.length - 1, h = this.parts, [c, p] = Ke(t, e);
    if (this.el = J.createElement(c, s), R.currentNode = this.el.content, e === 2) {
      const g = this.el.content, y = g.firstChild;
      y.remove(), g.append(...y.childNodes);
    }
    for (; (n = R.nextNode()) !== null && h.length < o; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const y of n.getAttributeNames())
            if (y.endsWith(ct) || y.startsWith(N)) {
              const E = p[r++];
              if (g.push(y), E !== void 0) {
                const _ = n.getAttribute(E.toLowerCase() + ct).split(N), m = /([.?@])?(.*)/.exec(E);
                h.push({ type: 1, index: l, name: m[2], strings: _, ctor: m[1] === "." ? Ze : m[1] === "?" ? Je : m[1] === "@" ? Ce : st });
              } else
        ...
        if (Dt.test(n.tagName)) {
          const g = n.textContent.split(N), y = g.length - 1;
          if (y > 0) {
            n.textContent = j ? j.emptyScript : "";
            for (let E = 0; E < y; E++)
              n.append(g[E], Q()), R.nextNode(), h.push({ type: 2, index: ++l });
            n.append(g[y], Q());
          }
        }
        ...
        if (n.data === Pt)
          ...
          let g = -1;
          for (; (g = n.data.indexOf(N, g + 1)) !== -1; )
            h.push({ type: 7, index: l }), g += N.length - 1;
        }
      l++;
    }
  }
...
class Qe {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (o === c.index) {
        let p;
        c.type === 2 ? p = new C(r, r.nextSibling, this, t) : c.type === 1 ? p = new c.ctor(r, c.name, c.strings, this, t) : c.type === 6 && (p = new ts(r, this, t)), this._$AV.push(p), c = n[++h];
      }
...
class C {
  ...
  _$AI(t, e = this) {
    t = X(this, t, e), Z(t) ? t === F || t == null || t === "" ? (this._$AH !== F && this._$AR(), this._$AH = F) : t !== this._$AH && t !== G && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Xe(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    ...
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      ...
      const r = new Qe(l, this), o = r.u(this.options);
...
const Ge = j ? j.emptyScript : "";
class Je extends st {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== F ? this.element.setAttribute(this.name, Ge) : this.element.removeAttribute(this.name);
  }
}
class Ce extends st {
  constructor(t, e, s, n, l) {
  ...
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.divider = l ? typeof l == "boolean" ? this.step : l : 0, this.value = isNaN(r) ? r : Number(r), this.onChange = o, this.onDragStart = h, this.onDragEnd = c, this.onDrag = p, $(es({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (g) => {
      ...
      const k = (S) => {
        ...
        var b, T;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", A), (T = this.onDragEnd) == null || T.call(this, L);
      };
...
class U {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    $(is({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
...
class Mt {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    $(ns({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(".mpui-picker"), this.$items = this.$el.querySelectorAll(".mpui-picker-item"), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
const as = ({ label: i }) => u` <div class="mpui-switch">${i}</div> `;
class ls {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, $(as({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-switch"), this.$el.addEventListener("click", () => {
...
class z {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, $(rs({ label: this.label }), this.container), this.$el = this.container.querySelector(".mpui-checkbox"), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
...
class M {
  constructor(t) {
    this.event = new Ae(), this.hook = new Ue(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = P("div", { class: `${a} mpui` }), this.$main = this.$el.appendChild(P("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(P("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      P("div", { class: `${a}-content` })
    ), this.pluginManager = new Te(this), this.video = new ze(this, t), this.state = new We(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.emit("mounted"), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
...
console.log(
  `
 %c mfunsPlayer v3.0.0-dev 44ebc4d %c https://github.com/Mfuns-cn 
...
class ps {
  ...
  init(t) {
    ...
    this.pickerFontsize = new U({
      ...
      value: 25,
      list: (((e = t.danmakuBar) == null ? void 0 : e.fontSizeList) || ms).map(([n, l]) => ({
        value: n,
        label: l
      })),
      onChange: (n) => {
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || $s).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
...
class It extends x {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.plugin.controller, this.danmaku = this.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      ...
      n.keyCode == B.Enter && this.send();
    }), this.$send.onclick = () => {
      this.send();
    }, this.setPlaceHolder(((s = e.danmakuBar) == null ? void 0 : s.placeholder) || fs);
  }
  moveToWrap() {
...
class bs {
  ...
  draw(t) {
    ...
    const r = (m) => {
    ...
    }, h = (m) => this.baseSpeed * (1 + this.deltaSpeed * m) * this.speed, c = (m, v) => [
      ...
      t:
        for (let f = 0; this.overlap || f < l; f++) {
          const L = c(v, f);
          let k = this.danmakuTracks[v][f];
          if (this.danmakuTracks[v][f] = L, k && k.length) {
            if (v === "roll") {
              const A = s / h(d);
              k.length !== L.length && (k = L);
              for (const w of k) {
                const S = r(w) - 10;
                if (this.trackHeights[v][f] = parseInt(w.style.fontSize) + this.trackPadding, S <= s - A * h(w.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (v === "reverse") {
              const A = s / h(d);
              ...
              continue t;
            return this.danmakuTracks[v][f].push(m), m.addEventListener("animationend", () => {
              var w, S;
              const A = (w = this.danmakuTracks[v][f]) == null ? void 0 : w.indexOf(m);
              A && ((S = this.danmakuTracks[v][f]) == null || S.splice(A, 1));
            }), f;
          } else
            return Array.isArray(this.danmakuTracks[v][f]) ? this.danmakuTracks[v][f].push(m) : this.danmakuTracks[v][f] = [m], m.addEventListener("animationend", () => {
              var w, S;
              const A = (w = this.danmakuTracks[v][f]) == null ? void 0 : w.indexOf(m);
              A && ((S = this.danmakuTracks[v][f]) == null || S.splice(A, 1));
            }), f;
...
`)}`, typeof v.color == "number" ? d.style.color = At(v.color) : d.style.color = v.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +v.size * this.fontScale + "px", d.addEventListener("animationend", () => {
      ...
      switch (L) {
        ...
        case "reverse":
          if (A = p(d, L, f), k = A % l, k >= 0) {
            const w = this.trackHeights[L].slice(0, l).reduce((T, q) => T + q, 0), S = this.trackHeights[L].slice(0, k).reduce((T, q) => T + q, 0) % w;
            ...
            d.dataset.track = A.toString(), d.style.width = f + 1 + "px", d.style.top = S + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${b / D}s`), d.style.setProperty("--offset", `${s + this.startDistance}px`), d.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = p(d, L, 0) % l, k >= 0) {
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const o of r)
      if (o.innerHTML) {
        const h = o.getBoundingClientRect(), c = this.container.getBoundingClientRect(), p = h.left - c.left, g = h.right - c.left, y = h.top - c.top, E = h.bottom - c.top;
        if (t >= p - s && t <= g + s && e >= y - s && e <= E + s && (l.push(o), n))
          return l;
      }
    return l;
  }
      ...
      "bilibili-xml": (e) => ((n) => {
        const l = [], o = new DOMParser().parseFromString(n, "text/xml").childNodes, h = (c) => {
          ...
          for (let g = 0; g < c.length; g++) {
            const y = c[g];
            if ((p = y == null ? void 0 : y.attributes) != null && p.length && g > 0) {
...
class Bt extends x {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.format = ((s = e.danmaku) == null ? void 0 : s.format) || "mfuns", this.parser = new ws({ defaultParser: this.format }), this.operate = new Ss(this.player), this.api = e.danmakuApi || {}, this.allowNewDanmaku = !1, this.$el = P("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      P("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new bs(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
...
const Bs = () => u`
  <div class="${a}-about">
    ...
    <div>github：<a href="${Ve}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者：</div>
...
class se extends x {
  constructor(t) {
    ...
    this.container = P("div", { class: `${a}-contextmenu-wrap` }), $(Vs(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
  ...
  showDanmaku(t) {
    ...
    t != null && t.length ? this.$danmaku.style.display = "" : this.$danmaku.style.display = "none", $(
      Os(
        t,
        (r) => {
...
const Ks = [oe, ce, de], Qs = [ae, he, ie, re, ne, se], Zs = [
  le,
  Vt,
  Ot,
  zt,
...
ye.pluginName = "buttonDanmakuList";
class be extends x {
  constructor(t, e) {
    super(t), this.value = "";
  }
...
class we extends x {
  constructor(t, e) {
    super(t), this.$el = P("div", { class: `${a}-videostatus` }), $(si, this.$el), this.$paused = this.$el.querySelector(`.${a}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${a}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${a}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
we.pluginName = "videoStatus";
const ii = u`
...
class Se extends x {
  constructor(t, e) {
    var s, n;
    super(t), this.$el = P("div", { class: `${a}-loadingmask` }), $(ii, this.$el), this.$info = this.$el.querySelector(`.${a}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${a}-loadingmask-tips`), this.getTips = (s = e.loadingMask) == null ? void 0 : s.getTips, this.delay = ((n = e.loadingMask) == null ? void 0 : n.delay) || 0, this.player.$main.appendChild(this.$el);
  }
  created() {
  ...
  created() {
    this.$el.addEventListener("click", () => {
      ...
      const r = e - n, o = s - l, h = (p) => {
        this._dragging = !0;
        const { clientX: g, clientY: y } = p;
        this.$el.style.left = `${g - r}px`, this.$el.style.top = `${y - o}px`;
      }, c = () => {
