...
const j = (i, t) => Array.from({ length: i }, () => t), $e = () => document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement || null, ve = document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled || !1, ge = document.pictureInPictureEnabled, ct = (i) => {
...
}, fe = (i) => (i[0] === "#" && (i = i.substr(1)), i.length === 3 && (i = `${i[0]}${i[0]}${i[1]}${i[1]}${i[2]}${i[2]}`), parseInt(i, 16) + 0 & 16777215), ye = (i) => `#${`00000${i.toString(16)}`.slice(-6)}`, nt = {
...
), a = "mfuns-player", be = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", ke = [
...
class we {
  constructor(t, e) {
    ...
    ), this.loader = new me(this), this.setRatio(e.aspectRatio || null), this.attachEvent(this.$video), this.initKeepRatio();
  }
  /** 加载视频 */
  load(t) {
...
class _e {
  constructor(t, e) {
    this.player = t, this.webfull = new Le(this.player), this.fullscreen = new xe(this.player), this.pip = new Se(this.player), this.init();
  }
  init() {
...
class R {
  constructor(t) {
    this.event = new pe(), this.hook = new Te(), this.plugin = {}, this.videoInfo = {}, this.container = t.container, this.$el = H("div", { class: a }), this.$main = this.$el.appendChild(H("div", { class: `${a}-main` })), this.$area = this.$main.appendChild(H("div", { class: `${a}-area` })), this.$content = this.$area.appendChild(
      H("div", { class: `${a}-content` })
    ), this.pluginManager = new ue(this), this.video = new we(this, t), this.sizing = new _e(this, t), this.state = new Ee(this, t), this.pluginManager.pluginsRegister(t), this.pluginManager.pluginsReady(t), this.container.appendChild(this.$el), this.pluginManager.playerMounted(t), this.setVideo(t.video, t.autoPlay, t.time);
  }
  get $video() {
  ...
  setVideo(t, e, s) {
    this.videoInfo = t, this.hook.call("setVideo", t).then((n) => {
      if (n)
        if (this.emit("video_change", t), t.url)
          this.loadVideo({ url: t.url, type: t.type, play: e, time: s });
        else
          throw "缺少视频播放信息";
    });
  }
...
console.log(
  `
 %c mfunsPlayer v3.0.0-dev 31da531 %c https://github.com/Mfuns-cn 
 ...
 */
var at;
const tt = window, O = tt.trustedTypes, ut = O ? O.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ot = "$lit$", M = `lit$${(Math.random() + "").slice(9)}$`, St = "?" + M, Ae = `<${St}>`, V = document, K = () => V.createComment(""), Y = (i) => i === null || typeof i != "object" && typeof i != "function", Lt = Array.isArray, Pe = (i) => Lt(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", lt = `[ 	
\f\r]`, U = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, pt = /-->/g, mt = />/g, N = RegExp(`>|${lt}(?:([^\\s"'>=/]+)(${lt}*=${lt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), $t = /'/g, vt = /"/g, _t = /^(?:script|style|textarea|title)$/i, Fe = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), p = Fe(1), Q = Symbol.for("lit-noChange"), P = Symbol.for("lit-nothing"), gt = /* @__PURE__ */ new WeakMap(), B = V.createTreeWalker(V, 129, null, !1);
function Et(i, t) {
...
const De = (i, t) => {
  ...
  for (let h = 0; h < e; h++) {
    ...
    for (; y < o.length && (r.lastIndex = y, u = r.exec(o), u !== null); )
      y = r.lastIndex, r === U ? u[1] === "!--" ? r = pt : u[1] !== void 0 ? r = mt : u[2] !== void 0 ? (_t.test(u[2]) && (n = RegExp("</" + u[2], "g")), r = N) : u[3] !== void 0 && (r = N) : r === N ? u[0] === ">" ? (r = n ?? U, f = -1) : u[1] === void 0 ? f = -2 : (f = r.lastIndex - u[2].length, d = u[1], r = u[3] === void 0 ? N : u[3] === '"' ? vt : $t) : r === vt || r === $t ? r = N : r === pt || r === mt ? r = U : (r = N, n = void 0);
    const _ = r === N && i[h + 1].startsWith("/>") ? " " : "";
    l += r === U ? o + Ae : f >= 0 ? (s.push(d), o.slice(0, f) + ot + o.slice(f) + M + _) : o + M + (f === -2 ? (s.push(void 0), h) : _);
  }
  return [Et(i, l + (i[e] || "<?>") + (t === 2 ? "</svg>" : "")), s];
};
class Z {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let l = 0, r = 0;
    const h = t.length - 1, o = this.parts, [d, u] = De(t, e);
    if (this.el = Z.createElement(d, s), B.currentNode = this.el.content, e === 2) {
      const f = this.el.content, y = f.firstChild;
      y.remove(), f.append(...y.childNodes);
    }
    for (; (n = B.nextNode()) !== null && o.length < h; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          const f = [];
          for (const y of n.getAttributeNames())
            if (y.endsWith(ot) || y.startsWith(M)) {
              const _ = u[r++];
              if (f.push(y), _ !== void 0) {
                const L = n.getAttribute(_.toLowerCase() + ot).split(M), m = /([.?@])?(.*)/.exec(_);
                o.push({ type: 1, index: l, name: m[2], strings: L, ctor: m[1] === "." ? qe : m[1] === "?" ? Ne : m[1] === "@" ? Ie : et });
              } else
        ...
        if (_t.test(n.tagName)) {
          ...
          if (y > 0) {
            ...
            for (let _ = 0; _ < y; _++)
              n.append(f[_], K()), B.nextNode(), o.push({ type: 2, index: ++l });
            n.append(f[y], K());
          }
        }
...
function W(i, t, e = i, s) {
  ...
  const d = Y(t) ? void 0 : t._$litDirective$;
  return (o == null ? void 0 : o.constructor) !== d && ((l = o == null ? void 0 : o._$AO) === null || l === void 0 || l.call(o, !1), d === void 0 ? o = void 0 : (o = new d(i), o._$AT(i, e, s)), s !== void 0 ? ((r = (h = e)._$Co) !== null && r !== void 0 ? r : h._$Co = [])[s] = o : e._$Cl = o), o !== void 0 && (t = W(i, o._$AS(i, t.values), o, s)), t;
}
class He {
  constructor(t, e) {
  ...
  u(t) {
    ...
    B.currentNode = l;
    let r = B.nextNode(), h = 0, o = 0, d = n[0];
    for (; d !== void 0; ) {
      if (h === d.index) {
        let u;
        d.type === 2 ? u = new G(r, r.nextSibling, this, t) : d.type === 1 ? u = new d.ctor(r, d.name, d.strings, this, t) : d.type === 6 && (u = new Be(r, this, t)), this._$AV.push(u), d = n[++o];
      }
      h !== (d == null ? void 0 : d.index) && (r = B.nextNode(), h++);
    }
...
class G {
  constructor(t, e, s, n) {
    var l;
    this.type = 2, this._$AH = P, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cp = (l = n == null ? void 0 : n.isConnected) === null || l === void 0 || l;
  }
  get _$AU() {
    var t, e;
  ...
  _$AI(t, e = this) {
    t = W(this, t, e), Y(t) ? t === P || t == null || t === "" ? (this._$AH !== P && this._$AR(), this._$AH = P) : t !== this._$AH && t !== Q && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Pe(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  _(t) {
    this._$AH !== P && Y(this._$AH) ? this._$AA.nextSibling.data = t : this.$(V.createTextNode(t)), this._$AH = t;
  }
  g(t) {
    var e;
    const { values: s, _$litType$: n } = t, l = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = Z.createElement(Et(n.h, n.h[0]), this.options)), n);
    if (((e = this._$AH) === null || e === void 0 ? void 0 : e._$AD) === l)
      this._$AH.v(s);
    else {
      const r = new He(l, this), h = r.u(this.options);
  ...
  T(t) {
    ...
    let s, n = 0;
    for (const l of t)
      n === e.length ? e.push(s = new G(this.k(K()), this.k(K()), this, this.options)) : s = e[n], s._$AI(l), n++;
...
class et {
  constructor(t, e, s, n, l) {
    this.type = 1, this._$AH = P, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = l, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = P;
  }
  get tagName() {
  ...
  _$AI(t, e = this, s, n) {
    ...
    if (l === void 0)
      ...
      for (t = l[0], o = 0; o < l.length - 1; o++)
        d = W(this, h[s + o], e, o), d === Q && (d = this._$AH[o]), r || (r = !Y(d) || d !== this._$AH[o]), d === P ? t = P : t !== P && (t += (d ?? "") + l[o + 1]), this._$AH[o] = d;
    }
    r && !n && this.j(t);
  }
  j(t) {
...
const Me = O ? O.emptyScript : "";
class Ne extends et {
  constructor() {
    super(...arguments), this.type = 4;
  }
  j(t) {
    t && t !== P ? this.element.setAttribute(this.name, Me) : this.element.removeAttribute(this.name);
  }
}
class Ie extends et {
  constructor(t, e, s, n, l) {
  ...
  _$AI(t, e = this) {
    var s;
    if ((t = (s = W(this, t, e, 0)) !== null && s !== void 0 ? s : P) === Q)
      return;
    const n = this._$AH, l = t === P && n !== P || t.capture !== n.capture || t.once !== n.once || t.passive !== n.passive, r = t !== P && (n === P || l);
...
ft == null || ft(Z, G), ((at = tt.litHtmlVersions) !== null && at !== void 0 ? at : tt.litHtmlVersions = []).push("2.8.0");
const g = (i, t, e) => {
  var s, n;
  ...
  if (r === void 0) {
    ...
    l._$litPart$ = r = new G(t.insertBefore(K(), h), h, void 0, e ?? {});
  }
  return r._$AI(i), r;
};
class Re {
...
class D extends A {
  constructor(t, e, {
    ...
    this.container = (d = (h == null ? void 0 : h.container) || n.container) == null ? void 0 : d(t), this.order = (h == null ? void 0 : h.order) || n.order, this.$el = l, this.$el.style.order = (this.order || "").toString(), !r && ((u = this.container) == null || u.append(this.$el));
  }
  $(t) {
...
class st extends A {
  constructor(t, e, {
    ...
    r != null && r.mount ? (o = r == null ? void 0 : r.mount(t)) == null || o.mount(this) : (this.container = (d = r == null ? void 0 : r.container) == null ? void 0 : d.call(r, t), this.onToggle = r == null ? void 0 : r.onToggle, this.onUnmount = r == null ? void 0 : r.onUnmount);
  }
  mount(t, e, s) {
...
`, ze = (i, t, {
  ...
  const o = p`
    ...
    >
      ...
      <div class="list-cell col-date">
        ${i.date ? xt(new Date(i.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
  ...
  return g(o, d), d.firstElementChild;
};
class Tt extends st {
  constructor(t, e) {
  ...
  created() {
    const t = this.danmaku.api, e = this.danmaku.operate;
    this.list = new Re({
      el: this.$container,
      getData: () => this.data,
      itemHeight: 24,
      createItem: (n, l) => ze(n, l, {
        operation: (r) => {
        ...
        onClick: (r, h) => {
          this.clickSelect(h, r.shiftKey, r.ctrlKey);
        },
        onDblclick: (r, h) => {
          this.player.seek(h.time);
        },
        selected: (r) => this.selected.includes(r),
        focused: (r) => this.focused == r,
        title: (r) => `${r.content}
${n.date ? xt(new Date(n.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${z(n.time, !1)}`
      }),
      overflow: 5
    });
    const s = wt(() => {
    ...
    this.list.$el.addEventListener("wheel", () => {
      ...
      this.clear();
    }), this.player.on("danmaku:load_end", (n) => {
      this.fill(n), this.autoScroll && this.sort("time");
    }), this.player.on("danmaku:load_addition_end", (n, l) => {
...
class Ue {
  constructor({
    ...
    this.container = t, this.min = e, this.max = s, this.step = n || 0, this.value = isNaN(l) ? l : Number(l), this.onChange = r, this.onDragStart = h, this.onDragEnd = o, this.onDrag = d, g(We(), t), this.$el = this.container.querySelector(`.${a}-slider`), this.$track = this.$el.querySelector(`.${a}-slider-track`), this.$bar = this.$track.querySelector(`.${a}-slider-bar`), this.$thumbTrack = this.$track.querySelector(`.${a}-slider-thumb-track`), this.$thumb = this.$track.querySelector(`.${a}-slider-thumb`), this.$el.addEventListener("mousedown", (u) => {
      ...
      let c = L - (y - $ - m);
      c = c >= L ? L : c <= 0 ? 0 : c;
      const v = this.step ? Math.round(c / L * (this.max - this.min) / this.step) * this.step + this.min : c / L * (this.max - this.min) + this.min;
      (T = this.onDragStart) == null || T.call(this, v), this.value != v && this.drag(v);
      const S = (w) => {
        var q;
        const x = w, { clientY: F } = x;
        ...
        var F, b;
        w.stopPropagation(), (F = window.getSelection()) == null || F.removeAllRanges(), document.removeEventListener("mousemove", S), document.removeEventListener("mouseup", k), (b = this.onDragEnd) == null || b.call(this, v);
      };
...
class X {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(je({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
...
class Ke {
  ...
  /** 重载，一般用于列表项更改 */
  reload(t) {
    g(Xe({ list: this.list, template: this.template }), this.container), this.$el = this.container.querySelector(`.${a}-picker`), this.$items = this.$el.querySelectorAll(`.${a}-picker-item`), this.$items.forEach((e) => {
      e.addEventListener("click", () => {
...
class it {
  constructor({ container: t, value: e = !1, onChange: s, onToggle: n, label: l }) {
    this.container = t, this.value = e, this.onChange = s, this.onToggle = n, this.label = l, g(Ye({ label: this.label }), this.container), this.$el = this.container.querySelector(`.${a}-checkbox`), this.$el.addEventListener("click", () => {
      this.toggle();
    }), this.setValue(this.value);
  }
  /** 设置开关状态 */
  ...
  init(t) {
    ...
    this.pickerFontsize = new X({
      ...
      list: [
        ...
        (n) => {
          var l;
          return (((l = t.danmakuBar) == null ? void 0 : l.modeList) || Je).indexOf(n.value) > -1;
        }
      ),
      onChange: (n) => {
      ...
      value: "#FFFFFF",
      list: (((s = t.danmakuBar) == null ? void 0 : s.colorList) || Ce).map((n) => ({ value: n })),
      onPick: (n) => {
        this.danmakuBar.danmakuColor = fe(n);
      },
      onChange: (n) => {
...
class At extends A {
  constructor(t, e) {
    ...
    super(t), this.danmakuColor = 16777215, this.danmakuMode = 1, this.danmakuFontSize = 25, this.coolDownTimer = 0, this.controller = this.player.plugin.controller, this.danmaku = this.player.plugin.danmaku, this.$wrap = this.player.$el.appendChild(
      ...
      this.send();
    }, this.setPlaceHolder(((s = e.danmakuBar) == null ? void 0 : s.placeholder) || es);
  }
  moveToWrap() {
...
class is {
  ...
  draw(t) {
    ...
    const r = (m) => {
      const $ = this.container.getBoundingClientRect().right, c = m.getBoundingClientRect().right;
      return $ - c;
    }, h = (m) => {
      const $ = this.container.getBoundingClientRect().left;
      return m.getBoundingClientRect().left - $;
    }, o = (m) => this.baseSpeed * (1 + this.deltaSpeed * m) * this.speed, d = (m, $) => [
      ...this.container.querySelectorAll(`.${this.classPrefix}-danmaku-${m}`)
    ].filter((c) => c.dataset.track === `${$}`), u = (m, $, c) => {
      t:
        for (let v = 0; this.overlap || v < l; v++) {
          const S = d($, v);
          let k = this.danmakuTracks[$][v];
          if (this.danmakuTracks[$][v] = S, k && k.length) {
            if ($ === "roll") {
              const T = s / o(c);
              k.length !== S.length && (k = S);
              for (const w of k) {
                const x = r(w) - 10;
                if (this.trackHeights[$][v] = parseInt(w.style.fontSize) + this.trackPadding, x <= s - T * o(w.getBoundingClientRect().width) || x <= 0)
                  continue t;
              }
            } else if ($ === "reverse") {
              const T = s / o(c);
            ...
            return this.danmakuTracks[$][v].push(m), m.addEventListener("animationend", () => {
              var w, x;
              const T = (w = this.danmakuTracks[$][v]) == null ? void 0 : w.indexOf(m);
    ...
    for (let m = 0; m < t.length; m++) {
      ...
      c.classList.add(`${this.classPrefix}-danmaku-item`), c.classList.add(`${this.classPrefix}-danmaku-${C[$.mode]}`), c.innerHTML = `${$.content.replace(/(\\n)/g, `
`)}`, typeof $.color == "number" ? c.style.color = ye($.color) : c.style.color = $.color, c.style.opacity = this.opacity.toString(), c.style.fontSize = +$.size * this.fontScale + "px", c.addEventListener("animationend", () => {
        [...this.container.children].indexOf(c) > -1 && this.container.removeChild(c);
      });
      const v = this.measureTextWidth(
        $.content,
      ...
      switch (S) {
        case "roll":
        case "reverse":
          if (T = u(c, S, v), k = T % l, k >= 0) {
            const w = this.trackHeights[S].slice(0, l).reduce((E, q) => E + q, 0), x = this.trackHeights[S].slice(0, k).reduce((E, q) => E + q, 0) % w;
            if (x + parseInt(c.style.fontSize) + this.trackPadding > n) {
              (y = this.danmakuTracks[S][m]) == null || y.pop();
              return;
            }
            const F = o(v), b = v + s + this.startDistance * 2;
            c.dataset.track = T.toString(), c.style.width = v + 1 + "px", c.style.top = x + "px", c.style.fontFamily = this.fontFamily, c.style.fontWeight = this.fontWeight, c.style.setProperty("--duration", `${b / F}s`), c.style.setProperty("--offset", `${s + this.startDistance}px`), c.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = u(c, S, 0) % l, k >= 0) {
            ...
            for (const b of x)
              w.push(...b);
            const F = w.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, E) => b + E, 0);
            if (F + parseInt(c.style.fontSize) + this.trackPadding > n) {
              (_ = this.danmakuTracks[S][m]) == null || _.pop();
              return;
            }
            c.dataset.track = k.toString(), c.style.width = v + 1 + "px", c.style.marginLeft = `-${(v + 1) * 0.5}px`, c.style.top = F + "px", c.style.fontFamily = this.fontFamily, c.style.fontWeight = this.fontWeight, c.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (S = "bottom", k = u(c, S, 0) % l, k >= 0) {
            ...
            c.dataset.track = k.toString(), c.style.width = v + 1 + "px", c.style.marginLeft = `-${(v + 1) * 0.5}px`, c.style.bottom = F + "px", c.style.fontFamily = this.fontFamily, c.style.fontWeight = this.fontWeight, c.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
          k = -1, console.error(`无法处理的弹幕模式: ${$.mode}`);
      }
      k >= 0 && (c.dataset.id = $.id.toString(), c.dataset.user = $.user.toString(), this.container.appendChild(c));
    }
    return f;
  }
  /** 测量字体宽度 */
  ...
  captureDanmakuDOM(t, e, s, n = !1) {
    ...
    for (const h of r)
      if (h.innerHTML) {
        const o = h.getBoundingClientRect(), d = this.container.getBoundingClientRect(), u = o.left - d.left, f = o.right - d.left, y = o.top - d.top, _ = o.bottom - d.top;
...
function ns() {
  const i = [], t = bt.length;
  for (let e = 0; e < 8; e++)
    i.push(bt[Math.floor(Math.random() * t)]);
  return yt++, i.join("") + `${yt}`;
}
class as {
  constructor({ defaultParser: t }) {
    this.defaultParser = t || "bilibili-xml", this.list = {
      ...
      "bilibili-xml": (e) => ((n) => {
        const l = [], h = new DOMParser().parseFromString(n, "text/xml").childNodes, o = (d) => {
          var u;
...
class Pt extends A {
  constructor(t, e) {
    var s;
    super(t), this.lastDanmakuId = 0, this.list = [], this.handler = {}, this.parser = new as({ defaultParser: "mfuns" }), this.operate = new ls(this.player), this.api = (s = e.danmaku) == null ? void 0 : s.api, this.allowNewDanmaku = !1, this.$el = H("div", { class: `${a}-danmaku-wrap` }), this.$rowContainer = this.$el.appendChild(
      H("div", { class: `${a}-row-danmaku-container` })
    ), this.player.$content.after(this.$el), this.engine = new is(this.$rowContainer, {
      fontScale: 1,
      fontFamily: "SimHei",
      fontWeight: "bold",
      speed: 1,
  ...
  loadAddition({ url: t, type: e, data: s }) {
    fetch(t).then((n) => /-xml$/.test(e) ? n.text() : n.json()).then((n) => {
      ...
      if (r)
        r && this.add(r), this.player.emit("danmaku:load_addition_end", t, r);
      else
        throw "无法正确解析弹幕格式";
    }).catch((n) => {
      this.player.emit("danmaku:load_addition_end", t, [], n), console.error(n);
    });
  }
  /** 加载弹幕 */
  load(t) {
    const e = this.api;
    e == null || e.get({ id: t }).then((s) => {
      const n = this.parser.parse({ data: s, type: e.type });
      if (n)
        this.add(n), this.lastDanmakuId = n[n.length - 1].id, this.player.emit("danmaku:load_end", n);
      else
        throw "无法正确解析弹幕格式";
    }).catch((s) => {
      this.player.emit("danmaku:load_end", [], s);
    });
  }
  /** 加载实时新增弹幕 */
  loadNew(t) {
    const e = this.lastDanmakuId;
    this.player.emit("danmaku:load_new_start", e);
    const s = this.api;
    s == null || s.get({ id: t, offset: this.lastDanmakuId }).then((n) => {
      const l = this.parser.parse({ data: n, type: s.type });
      if (l)
        this.add(l), this.lastDanmakuId = l[l.length - 1].id, this.player.emit("danmaku:load_new_end", e, l);
      else
        throw "无法正确解析弹幕格式";
    }).catch((n) => {
      this.player.emit("danmaku:load_new_end", e, [], n);
    });
  }
  /** 重载弹幕 */
  async reload(t, e) {
    this.player.emit("danmaku:load_start"), this.engine.reset(), t && this.load(t), e == null || e.forEach((s) => {
      this.loadAddition(s);
    });
  }
  /**
...
Pt.pluginName = "danmaku";
class Ft extends A {
  constructor(t, e) {
    super(t), e.wide && this.enter(), this.handler = e.wideHandler;
  }
  enter() {
    var t;
    this.player.$el.classList.add("state-wide"), (t = this.handler) == null || t.call(this, !0), this.player.emit("wide_enter");
  }
  exit() {
    var t;
    this.player.$el.classList.remove("state-wide"), (t = this.handler) == null || t.call(this, !1), this.player.emit("wide_exit");
  }
  get status() {
...
class Mt extends D {
  ...
  created() {
    this.player.on("timeupdate", (t) => {
      ...
      t != this.valueBeforeEdited && (this.player.seek(ct(t)), this.player.play()), this.exitInput();
    }), this.$input.addEventListener("keydown", (t) => {
      const e = t || window.event;
      e.keyCode == 13 && (this.player.seek(ct(this.$input.value)), this.player.play(), this.exitInput()), e.keyCode == 27 && this.exitInput();
    });
  }
  /** 退出输入模式 */
  exitInput() {
...
Ot.pluginName = "buttonFullscreen";
const fs = p`
...
Wt.pluginName = "buttonDanmakuToggle";
const ys = p`
...
Ut.pluginName = "buttonDanmakuSettings";
const bs = () => p`
  <div class="${a}-about">
    <div class="${a}-about-logo"></div>
    <div class="${a}-about-version">version ${R.version}-${R.gitHash}</div>
    <div>github: <a href="${be}" target="_blank">mfuns-cn/mfunsPlayer</a></div>
    <div>开发者</div>
...
class Kt extends A {
  constructor(t) {
    ...
    const e = [
      ...
      {
        name: `Mfuns Player v${R.version}-${R.gitHash}`,
        onClick: () => {
          var s;
    ...
    this.container = H("div", { class: `${a}-contextmenu-wrap` }), g(ws(e), this.container), this.$el = this.container.querySelector(`.${a}-contextmenu`), this.$danmaku = this.$el.querySelector(`.${a}-contextmenu-danmaku`), this.$menu = this.$el.querySelector(`.${a}-contextmenu-menu`), this.player.$main.appendChild(this.container);
  }
  created() {
...
te.pluginName = "side";
const Ps = [Ct], Fs = [Zt, te, Yt, Jt, Qt, Kt], Ds = [
  Gt,
  Dt,
  Ht,
  qt,
...
function Hs(i) {
  return {
    ...i,
    plugins: [...Ps, ...Fs, ...Ds, ...i.plugins || []]
  };
}
const qs = p`
  <div class="${a}-controls-button ${a}-button_wide">
    <div class="${a}-controls-button-icon">
...
class ee extends D {
  ...
  created() {
    this.player.on("wide_enter", () => {
      ...
      var t, e, s;
      (t = this.player.plugin.wide) != null && t.status ? (e = this.player.plugin.wide) == null || e.exit() : (s = this.player.plugin.wide) == null || s.enter();
    });
  }
}
ee.pluginName = "buttonWide";
class se extends A {
  constructor(t, e) {
...
he.pluginName = "buttonDanmakuList";
class ce extends A {
  constructor(t, e) {
    super(t), this.value = "";
  }
