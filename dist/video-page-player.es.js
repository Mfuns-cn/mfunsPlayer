...
const qt = class $e {
  constructor(t) {
    this.hook = new Ks(), this.plugin = {}, this._eventEmitter = new ei(), this.Player = $e, this.container = t.container, this.$el = F("div", { class: `${r} mpui` }), this.$main = this.$el.appendChild(F("div", { class: `${r}-main` })), this.$area = this.$main.appendChild(F("div", { class: `${r}-area` })), this.$content = this.$area.appendChild(
 ...
 */
var At;
const Lt = window, Z = Lt.trustedTypes, Ct = Z ? Z.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Bt = "$lit$", B = `lit$${(Math.random() + "").slice(9)}$`, fe = "?" + B, si = `<${fe}>`, X = document, ct = () => X.createComment(""), dt = (s) => s === null || typeof s != "object" && typeof s != "function", ye = Array.isArray, ii = (s) => ye(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", Dt = `[ 	
\f\r]`, st = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ut = /-->/g, Xt = />/g, I = RegExp(`>|${Dt}(?:([^\\s"'>=/]+)(${Dt}*=${Dt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), jt = /'/g, Yt = /"/g, be = /^(?:script|style|textarea|title)$/i, ni = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), p = ni(1), ut = Symbol.for("lit-noChange"), H = Symbol.for("lit-nothing"), Gt = /* @__PURE__ */ new WeakMap(), W = X.createTreeWalker(X, 129, null, !1);
function we(s, t) {
...
const ri = (s, t) => {
  ...
  for (let o = 0; o < e; o++) {
    ...
    for (; w < h.length && (l.lastIndex = w, u = l.exec(h), u !== null); )
      w = l.lastIndex, l === st ? u[1] === "!--" ? l = Ut : u[1] !== void 0 ? l = Xt : u[2] !== void 0 ? (be.test(u[2]) && (n = RegExp("</" + u[2], "g")), l = I) : u[3] !== void 0 && (l = I) : l === I ? u[0] === ">" ? (l = n ?? st, $ = -1) : u[1] === void 0 ? $ = -2 : ($ = l.lastIndex - u[2].length, c = u[1], l = u[3] === void 0 ? I : u[3] === '"' ? Yt : jt) : l === Yt || l === jt ? l = I : l === Ut || l === Xt ? l = st : (l = I, n = void 0);
    const _ = l === I && s[o + 1].startsWith("/>") ? " " : "";
    a += l === st ? h + si : $ >= 0 ? (i.push(c), h.slice(0, $) + Bt + h.slice($) + B + _) : h + B + ($ === -2 ? (i.push(void 0), o) : _);
  }
  return [we(s, a + (s[e] || "<?>") + (t === 2 ? "</svg>" : "")), i];
};
class pt {
      ...
      if (n.nodeType === 1) {
        if (n.hasAttributes()) {
          ...
          for (const w of n.getAttributeNames())
            if (w.endsWith(Bt) || w.startsWith(B)) {
              const _ = u[l++];
              if ($.push(w), _ !== void 0) {
                const L = n.getAttribute(_.toLowerCase() + Bt).split(B), v = /([.?@])?(.*)/.exec(_);
                h.push({ type: 1, index: a, name: v[2], strings: L, ctor: v[1] === "." ? li : v[1] === "?" ? hi : v[1] === "@" ? ci : _t });
              } else
        ...
        if (be.test(n.tagName)) {
          ...
          if (w > 0) {
            ...
            for (let _ = 0; _ < w; _++)
              n.append($[_], ct()), W.nextNode(), h.push({ type: 2, index: ++a });
            n.append($[w], ct());
          }
        }
...
class vt {
  ...
  g(t) {
    var e;
    const { values: i, _$litType$: n } = t, a = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = pt.createElement(we(n.h, n.h[0]), this.options)), n);
  ...
  _$AC(t) {
    ...
    return e === void 0 && Gt.set(t.strings, e = new pt(t)), e;
  }
  T(t) {
...
const Kt = Lt.litHtmlPolyfillSupport;
Kt == null || Kt(pt, vt), ((At = Lt.litHtmlVersions) !== null && At !== void 0 ? At : Lt.litHtmlVersions = []).push("2.8.0");
const f = (s, t, e) => {
  var i, n;
  ...
  const h = p`
    ...
    >
      ...
      <div class="list-cell col-date">
        ${s.date ? ge(new Date(s.date * 1e3), "yy-MM-dd HH:mm") : "-"}
      </div>
  ...
  init() {
    ...
    this.list = new ui({
      ...
      createItem: (a, l) => mi(a, l, {
        ...
        title: (o) => `${o.content}
${a.date ? ge(new Date(a.date * 1e3), "yyyy-MM-dd HH:mm:ss") : "-"} @ ${V(a.time, !1)}`
      }),
      overflow: 5
    });
    const i = ve(() => {
...
class $t {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.divider = a ? typeof a == "boolean" ? this.step : a : 0, this.value = isNaN(l) ? l : Number(l), this.onChange = o, this.onDragStart = h, this.onDragEnd = c, this.onDrag = u, f(vi({ divider: this.divider }), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", ($) => {
      var x;
      const w = $, { clientX: _ } = w, L = this.$track.offsetWidth;
      ...
      const k = (S) => {
        ...
        var b, D;
        S.stopPropagation(), (b = window.getSelection()) == null || b.removeAllRanges(), document.removeEventListener("mousemove", k), document.removeEventListener("mouseup", T), (D = this.onDragEnd) == null || D.call(this, E);
      };
...
class $i {
  constructor({
    ...
    this.container = t, this.min = e, this.max = i, this.step = n || 0, this.value = isNaN(a) ? a : Number(a), this.onChange = l, this.onDragStart = o, this.onDragEnd = h, this.onDrag = c, f(gi(), t), this.$el = this.container.querySelector(".mpui-slider"), this.$track = this.$el.querySelector(".mpui-slider-track"), this.$bar = this.$track.querySelector(".mpui-slider-bar"), this.$thumbTrack = this.$track.querySelector(".mpui-slider-thumb-track"), this.$thumb = this.$track.querySelector(".mpui-slider-thumb"), this.$el.addEventListener("mousedown", (u) => {
      var T;
      const $ = u, { clientY: w } = $, _ = this.$track.offsetHeight;
      ...
      const E = (x) => {
        var M;
        const S = x, { clientY: A } = S;
        S.preventDefault(), S.stopPropagation();
        let b = L - (A - m - v);
        b = b >= L ? L : b <= 0 ? 0 : b;
        const D = this.step ? Math.round(b / L * (this.max - this.min) / this.step) * this.step + this.min : b / L * (this.max - this.min) + this.min;
        this.value != D && this.drag(D), (M = window.getSelection()) == null || M.removeAllRanges();
      }, k = (x) => {
        var A, b;
        x.stopPropagation(), (A = window.getSelection()) == null || A.removeAllRanges(), document.removeEventListener("mousemove", E), document.removeEventListener("mouseup", k), (b = this.onDragEnd) == null || b.call(this, g);
      };
...
class Oe extends y {
  constructor(t) {
    super(t), this.list = [], this.isShow = !1, this.player = t, this.container = F("div", { class: `${r}-contextmenu-wrap` }), f(Ri(), this.container), this.$el = this.container.querySelector(`.${r}-contextmenu`), this.$list = this.$el.querySelector(`.${r}-contextmenu-list`), this.player.$main.appendChild(this.container);
  }
  apply(t, e) {
    var i;
...
}, Zt = (s, t, e, i) => (We(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), rt;
const Oi = () => p`
...
class Ce extends y {
  ...
  apply(t, e) {
    var i;
    Zt(this, rt, ((i = e.modal) == null ? void 0 : i.panels) || []);
  }
  ready() {
...
var je = (s, t, e) => {
  ...
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, Jt = (s, t, e, i) => (je(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), at;
const Ui = () => p`
...
class Ye extends y {
  ...
  apply(t, e) {
    var i;
    Jt(this, at, ((i = e.side) == null ? void 0 : i.panels) || []);
  }
  ready() {
...
var Qe = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, te = (s, t, e) => (Qe(s, t, "read from private field"), e ? e.call(s) : t.get(s)), ee = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
...
class Ze extends y {
  constructor() {
    super(...arguments), ee(this, lt, 0), ee(this, xt, 0);
  }
  init() {
    this.player.define("userId", { get: () => te(this, lt) }), this.player.define("authorId", { get: () => te(this, xt) }), this.player.define("login", () => this.login()), this.player.on("videoChange", ({ author: t }) => {
...
var Je = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, ft = (s, t, e) => (Je(s, t, "read from private field"), e ? e.call(s) : t.get(s)), se = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
...
class ts extends y {
  constructor(t) {
    super(t), se(this, q, !1), se(this, G, !1), this.activeDuration = 3e3, this.player.define("isActive", {
      get: () => ft(this, q)
    });
    const e = ve(() => {
...
}, ie = "ResizeObserver loop completed with undelivered notifications.", Yi = function() {
  var s;
  typeof ErrorEvent == "function" ? s = new ErrorEvent("error", {
    message: ie
  }) : (s = document.createEvent("Event"), s.initEvent("error", !1, !1), s.message = ie), window.dispatchEvent(s);
}, mt;
(function(s) {
...
var U = function(s) {
  ...
  return !1;
}, ht = typeof window < "u" ? window : {}, yt = /* @__PURE__ */ new WeakMap(), re = /auto|scroll/, Qi = /^tb|vertical/, Zi = /msie|trident/i.test(ht.navigator && ht.navigator.userAgent), N = function(s) {
  ...
  if (t === void 0 && (t = !1), yt.has(s) && !t)
    return yt.get(s);
  if (is(s))
    return yt.set(s, ae), ae;
  var e = getComputedStyle(s), i = Ot(s) && s.ownerSVGElement && s.getBBox(), n = !Zi && e.boxSizing === "border-box", a = Qi.test(e.writingMode || ""), l = !i && re.test(e.overflowY || ""), o = !i && re.test(e.overflowX || ""), h = i ? 0 : N(e.paddingTop), c = i ? 0 : N(e.paddingRight), u = i ? 0 : N(e.paddingBottom), $ = i ? 0 : N(e.paddingLeft), w = i ? 0 : N(e.borderTopWidth), _ = i ? 0 : N(e.borderRightWidth), L = i ? 0 : N(e.borderBottomWidth), v = i ? 0 : N(e.borderLeftWidth), m = $ + c, d = h + u, g = v + _, E = w + L, k = o ? s.offsetHeight - E - s.clientHeight : 0, T = l ? s.offsetWidth - g - s.clientWidth : 0, x = n ? m + g : 0, S = n ? d + E : 0, A = i ? i.width : N(e.width) - x - T, b = i ? i.height : N(e.height) - S - k, D = A + m + T + g, M = b + d + k + E, et = U({
    devicePixelContentBoxSize: Q(Math.round(A * devicePixelRatio), Math.round(b * devicePixelRatio), a),
    borderBoxSize: Q(D, M, a),
    contentBoxSize: Q(A, b, a),
    contentRect: new ss($, h, A, b)
  });
  ...
  return !!St;
}, ln = 250, on = { attributes: !0, characterData: !0, childList: !0, subtree: !0 }, oe = [
  "resize",
  "load",
  "transitionend",
  "animationend",
  ...
  return s.prototype.run = function(t) {
    ...
    var t = this;
    this.stopped && (this.stopped = !1, this.observer = new MutationObserver(this.listener), this.observe(), oe.forEach(function(e) {
      return ht.addEventListener(e, t.listener, !0);
    }));
  }, s.prototype.stop = function() {
    var t = this;
    this.stopped || (this.observer && this.observer.disconnect(), oe.forEach(function(e) {
      return ht.removeEventListener(e, t.listener, !0);
    }), this.stopped = !0);
  }, s;
}(), It = new hn(), ce = function(s) {
  !St && s > 0 && It.start(), St += s, !St && It.stop();
}, cn = function(s) {
  return !Ot(s) && !Ki(s) && getComputedStyle(s).display === "inline";
}, dn = function() {
  function s(t, e) {
  ...
  return s;
}(), bt = /* @__PURE__ */ new WeakMap(), de = function(s, t) {
  ...
  return s.connect = function(t, e) {
    ...
    de(n.observationTargets, e) < 0 && (a && C.push(n), n.observationTargets.push(new dn(e, i && i.box)), ce(1), It.schedule());
  }, s.unobserve = function(t, e) {
    var i = bt.get(t), n = de(i.observationTargets, e), a = i.observationTargets.length === 1;
    n >= 0 && (a && C.splice(C.indexOf(i), 1), i.observationTargets.splice(n, 1), ce(-1));
...
class $s extends gt {
  constructor(t) {
    const e = new DocumentFragment();
    f($n, e), super(t, e.querySelector(`.${r}-partlist`)), this.name = "partList", this.title = "分P列表", this._part = 0, this._list = [], this.$list = this.$(`.${r}-partlist-list`);
  }
  init() {
    this.player.on("videoChange", (t) => {
...
class fs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(yn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuList", this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.$icon.addEventListener("click", () => {
      var t;
...
class bs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(bn, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "quality", this._itemMap = /* @__PURE__ */ new Map(), this.$icon = this.$(`.${r}-controls-button-icon`), this.$text = this.$(`.${r}-controls-button-text`), this.$panel = this.$(`.${r}-controls-panel`), this.$list = this.$(`.${r}-button-quality-list`);
  }
  init() {
...
class ws extends y {
  constructor(t) {
    super(t), this.$el = F("div", { class: `${r}-videostatus` }), f(wn, this.$el), this.$paused = this.$el.querySelector(`.${r}-videostatus-paused`), this.$loading = this.$el.querySelector(`.${r}-videostatus-loading`), this.$volume = this.$el.querySelector(`.${r}-videostatus-volume`), this.player.$area.appendChild(this.$el);
  }
}
...
class ks extends y {
  constructor(t) {
    super(t), this.delay = 0, this.$el = F("div", { class: `${r}-loadingmask` }), f(kn, this.$el), this.$info = this.$el.querySelector(`.${r}-loadingmask-info`), this.$tips = this.$el.querySelector(`.${r}-loadingmask-tips`), this.player.$main.appendChild(this.$el);
  }
  apply(t, e) {
    var i, n;
...
class Ls extends y {
  constructor(t) {
    var e;
    if (super(t), Nt(this, O, !1), Nt(this, ot, !1), Nt(this, K, !1), this.$el = F("div", { class: `${r}-mini` }), this.player.$el.appendChild(this.$el), this.player.on("intersection", (i) => {
...
class _s extends y {
  constructor(t) {
    var e;
    if (super(t), this.status = !1, this.$mask = F("div", { class: `${r}-lightoff-mask` }), t.plugin.buttonSettings) {
      const i = document.createElement("div");
      this.checkbox = new tt({
        container: i,
        value: this.status,
        ...
        for (let g = 0; this.overlap || g < a; g++) {
          ...
          if (this.danmakuTracks[m][g] = E, k && k.length) {
            if (m === "roll") {
              ...
              for (const x of k) {
                const S = l(x) - 10;
                if (this.trackHeights[m][g] = parseInt(x.style.fontSize) + this.trackPadding, S <= i - T * h(x.getBoundingClientRect().width) || S <= 0)
                  continue t;
              }
            } else if (m === "reverse") {
              const T = i / h(d);
            ...
            return this.danmakuTracks[m][g].push(v), v.addEventListener("animationend", () => {
              var x, S;
              const T = (x = this.danmakuTracks[m][g]) == null ? void 0 : x.indexOf(v);
...
`)}`, typeof m.color == "number" ? d.style.color = Us(m.color) : d.style.color = m.color, d.style.opacity = this.opacity.toString(), d.style.fontSize = +m.size * this.fontScale + "px", m.fromHere && (d.style.border = "2px solid white"), d.addEventListener("animationend", () => {
      ...
      switch (E) {
        case "roll":
        case "reverse":
          if (T = u(d, E, g), k = T % a, k >= 0) {
            const x = this.trackHeights[E].slice(0, a).reduce((D, M) => D + M, 0), S = this.trackHeights[E].slice(0, k).reduce((D, M) => D + M, 0) % x;
            if (S + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (w = this.danmakuTracks[E][v]) == null || w.pop();
              return;
            }
            const A = h(g), b = g + i + this.startDistance * 2;
            d.dataset.track = T.toString(), d.style.width = g + 1 + "px", d.style.top = S + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${b / A}s`), d.style.setProperty("--offset", `${i + this.startDistance}px`), d.style.setProperty("--translateX", `${-b}px`);
          }
          break;
        case "top":
          if (k = u(d, E, 0) % a, k >= 0) {
            ...
            for (const b of S)
              x.push(...b);
            const A = x.map((b) => parseInt(b.style.fontSize) + this.trackPadding).slice(0, k).reduce((b, D) => b + D, 0);
            if (A + parseInt(d.style.fontSize) + this.trackPadding > n) {
              (_ = this.danmakuTracks[E][v]) == null || _.pop();
              return;
            }
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.top = A + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        case "bottom":
          if (E = "bottom", k = u(d, E, 0) % a, k >= 0) {
            ...
            d.dataset.track = k.toString(), d.style.width = g + 1 + "px", d.style.marginLeft = `-${(g + 1) * 0.5}px`, d.style.bottom = A + "px", d.style.fontFamily = this.fontFamily, d.style.fontWeight = this.fontWeight, d.style.setProperty("--duration", `${this.baseDuration / this.speed}s`);
          }
          break;
        default:
  ...
  captureDanmakuDOM(t, e, i, n = !1) {
    ...
    for (const o of l)
      if (o.innerHTML) {
        const h = o.getBoundingClientRect(), c = this.container.getBoundingClientRect(), u = h.left - c.left, $ = h.right - c.left, w = h.top - c.top, _ = h.bottom - c.top;
        if (t >= u - i && t <= $ + i && e >= w - i && e <= _ + i && (a.push(o), n))
          return a;
      }
    return a;
  }
...
function En() {
  const s = [], t = pe.length;
  for (let e = 0; e < 8; e++)
    s.push(pe[Math.floor(Math.random() * t)]);
  return ue++, s.join("") + `${ue}`;
}
class Fs extends y {
  constructor() {
    super(...arguments), this.type = "", this.parser = Ln;
  }
  get danmaku() {
...
class Hs extends P {
  constructor(t) {
    const e = new DocumentFragment();
    f(_n, e), super(t, e.querySelector(`.${r}-controls-button`)), this.name = "danmakuToggle", this.$icon = this.$(`.${r}-controls-button-icon`), this.$tooltip = this.$(".mpui-tooltip");
  }
  init() {
    this.player.on("danmaku:on", () => {
      this._change(!0);
...
class Ms extends P {
  ...
  apply(t, e) {
    var i, n;
    (i = e.danmakuBar) != null && i.loginRequired && this.setLoginRequired(!0), this.setPlaceHolder(((n = e.danmakuBar) == null ? void 0 : n.placeholder) || An);
  }
  setPlaceHolder(t) {
...
`, Pn = (s) => navigator.clipboard.writeText(s);
class Rs extends y {
  constructor(t) {
...
var Os = (s, t, e) => {
  if (!t.has(s))
    throw TypeError("Cannot " + e);
}, kt = (s, t, e) => (Os(s, t, "read from private field"), e ? e.call(s) : t.get(s)), Bn = (s, t, e) => {
  if (t.has(s))
    throw TypeError("Cannot add the same private member more than once");
  t instanceof WeakSet ? t.add(s) : t.set(s, e);
}, me = (s, t, e, i) => (Os(s, t, "write to private field"), i ? i.call(s, e) : t.set(s, e), e), R;
class zs extends y {
  constructor(t) {
    super(t), Bn(this, R, null);
    const e = window.ResizeObserver || os;
    e && (this.observer = new e(([i]) => {
      const { width: n, height: a } = i.contentRect;
      this._keepRatio(n, a);
  ...
  apply(t, e) {
    me(this, R, this._parse(e.aspectRatio || ""));
  }
  init() {
  ...
  set(t) {
    ...
    me(this, R, e), this._setRatio(e), this.player.emit("aspectRatioChange", this._stringify(e));
  }
  /** 设置视频比例 */
  _setRatio(t) {
...
const In = [
  ...
  Ls,
  _s
], qn = [Ie, qe, $s], On = [Re, Ne, fs, bs, xs], zn = [qs, Bs, Is];
class Vn extends Rt {
  constructor(t) {
    super({
      autoPart: !0,
